...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/edgecombe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/edgecombe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_edgecombe_audio", "counties.nc.edgecombe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_edgecombe_data", "counties.nc.edgecombe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_edgecombe_graphics", "counties.nc.edgecombe.graphics.spectrum", sb.toString());
        }
    }
}