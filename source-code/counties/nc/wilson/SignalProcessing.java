...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/wilson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/wilson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilson_audio", "counties.nc.wilson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilson_data", "counties.nc.wilson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilson_graphics", "counties.nc.wilson.graphics.spectrum", sb.toString());
        }
    }
}