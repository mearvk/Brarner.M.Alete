...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/onslow/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/onslow";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_onslow_audio", "counties.nc.onslow.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_onslow_data", "counties.nc.onslow.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_onslow_graphics", "counties.nc.onslow.graphics.spectrum", sb.toString());
        }
    }
}