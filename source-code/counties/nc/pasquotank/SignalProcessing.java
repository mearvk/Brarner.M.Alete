package counties.nc.pasquotank;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/pasquotank/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/pasquotank";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_pasquotank_audio", "counties.nc.pasquotank.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_pasquotank_data", "counties.nc.pasquotank.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_pasquotank_graphics", "counties.nc.pasquotank.graphics.spectrum", sb.toString());
        }
    }
}