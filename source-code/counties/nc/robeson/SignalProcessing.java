...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/robeson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/robeson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_robeson_audio", "counties.nc.robeson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_robeson_data", "counties.nc.robeson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_robeson_graphics", "counties.nc.robeson.graphics.spectrum", sb.toString());
        }
    }
}