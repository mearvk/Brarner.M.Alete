...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/columbus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/columbus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_columbus_audio", "counties.nc.columbus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_columbus_data", "counties.nc.columbus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_columbus_graphics", "counties.nc.columbus.graphics.spectrum", sb.toString());
        }
    }
}