package counties.nc.rockingham;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/rockingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/rockingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_rockingham_audio", "counties.nc.rockingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_rockingham_data", "counties.nc.rockingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_rockingham_graphics", "counties.nc.rockingham.graphics.spectrum", sb.toString());
        }
    }
}