...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/haywood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/haywood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_haywood_audio", "counties.nc.haywood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_haywood_data", "counties.nc.haywood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_haywood_graphics", "counties.nc.haywood.graphics.spectrum", sb.toString());
        }
    }
}