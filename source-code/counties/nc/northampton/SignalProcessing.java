package counties.nc.northampton;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/northampton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/northampton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_northampton_audio", "counties.nc.northampton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_northampton_data", "counties.nc.northampton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_northampton_graphics", "counties.nc.northampton.graphics.spectrum", sb.toString());
        }
    }
}