...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/mcdowell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/mcdowell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_mcdowell_audio", "counties.nc.mcdowell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_mcdowell_data", "counties.nc.mcdowell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_mcdowell_graphics", "counties.nc.mcdowell.graphics.spectrum", sb.toString());
        }
    }
}