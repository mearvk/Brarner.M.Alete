...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/bladen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/bladen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_bladen_audio", "counties.nc.bladen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_bladen_data", "counties.nc.bladen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_bladen_graphics", "counties.nc.bladen.graphics.spectrum", sb.toString());
        }
    }
}