...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/scotland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/scotland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_scotland_audio", "counties.nc.scotland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_scotland_data", "counties.nc.scotland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_scotland_graphics", "counties.nc.scotland.graphics.spectrum", sb.toString());
        }
    }
}