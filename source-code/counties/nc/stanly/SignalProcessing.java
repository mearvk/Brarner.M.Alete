...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/stanly/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/stanly";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_stanly_audio", "counties.nc.stanly.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_stanly_data", "counties.nc.stanly.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_stanly_graphics", "counties.nc.stanly.graphics.spectrum", sb.toString());
        }
    }
}