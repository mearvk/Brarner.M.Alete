...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/alamance/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/alamance";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_alamance_audio", "counties.nc.alamance.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_alamance_data", "counties.nc.alamance.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_alamance_graphics", "counties.nc.alamance.graphics.spectrum", sb.toString());
        }
    }
}