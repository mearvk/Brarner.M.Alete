...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/catawba/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/catawba";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_catawba_audio", "counties.nc.catawba.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_catawba_data", "counties.nc.catawba.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_catawba_graphics", "counties.nc.catawba.graphics.spectrum", sb.toString());
        }
    }
}