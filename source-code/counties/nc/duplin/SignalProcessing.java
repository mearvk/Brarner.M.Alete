...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/duplin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/duplin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_duplin_audio", "counties.nc.duplin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_duplin_data", "counties.nc.duplin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_duplin_graphics", "counties.nc.duplin.graphics.spectrum", sb.toString());
        }
    }
}