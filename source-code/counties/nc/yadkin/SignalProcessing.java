...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/yadkin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/yadkin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_yadkin_audio", "counties.nc.yadkin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_yadkin_data", "counties.nc.yadkin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_yadkin_graphics", "counties.nc.yadkin.graphics.spectrum", sb.toString());
        }
    }
}