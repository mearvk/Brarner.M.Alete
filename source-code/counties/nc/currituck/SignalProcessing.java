...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/currituck/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/currituck";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_currituck_audio", "counties.nc.currituck.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_currituck_data", "counties.nc.currituck.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_currituck_graphics", "counties.nc.currituck.graphics.spectrum", sb.toString());
        }
    }
}