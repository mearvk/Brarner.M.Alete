...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/ashe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/ashe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_ashe_audio", "counties.nc.ashe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_ashe_data", "counties.nc.ashe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_ashe_graphics", "counties.nc.ashe.graphics.spectrum", sb.toString());
        }
    }
}