...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/sampson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/sampson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_sampson_audio", "counties.nc.sampson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_sampson_data", "counties.nc.sampson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_sampson_graphics", "counties.nc.sampson.graphics.spectrum", sb.toString());
        }
    }
}