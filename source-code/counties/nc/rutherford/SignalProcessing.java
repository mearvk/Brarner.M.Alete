package counties.nc.rutherford;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/rutherford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/rutherford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_rutherford_audio", "counties.nc.rutherford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_rutherford_data", "counties.nc.rutherford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_rutherford_graphics", "counties.nc.rutherford.graphics.spectrum", sb.toString());
        }
    }
}