...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/chowan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/chowan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_chowan_audio", "counties.nc.chowan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_chowan_data", "counties.nc.chowan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_chowan_graphics", "counties.nc.chowan.graphics.spectrum", sb.toString());
        }
    }
}