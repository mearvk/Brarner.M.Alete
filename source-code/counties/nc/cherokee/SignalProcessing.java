...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/cherokee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/cherokee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_cherokee_audio", "counties.nc.cherokee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_cherokee_data", "counties.nc.cherokee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_cherokee_graphics", "counties.nc.cherokee.graphics.spectrum", sb.toString());
        }
    }
}