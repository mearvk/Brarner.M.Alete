...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/alexander/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/alexander";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_alexander_audio", "counties.nc.alexander.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_alexander_data", "counties.nc.alexander.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_alexander_graphics", "counties.nc.alexander.graphics.spectrum", sb.toString());
        }
    }
}