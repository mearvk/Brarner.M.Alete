...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/guilford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/guilford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_guilford_audio", "counties.nc.guilford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_guilford_data", "counties.nc.guilford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_guilford_graphics", "counties.nc.guilford.graphics.spectrum", sb.toString());
        }
    }
}