...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/gaston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/gaston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_gaston_audio", "counties.nc.gaston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_gaston_data", "counties.nc.gaston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_gaston_graphics", "counties.nc.gaston.graphics.spectrum", sb.toString());
        }
    }
}