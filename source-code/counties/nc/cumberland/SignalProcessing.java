package counties.nc.cumberland;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/cumberland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/cumberland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_cumberland_audio", "counties.nc.cumberland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_cumberland_data", "counties.nc.cumberland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_cumberland_graphics", "counties.nc.cumberland.graphics.spectrum", sb.toString());
        }
    }
}