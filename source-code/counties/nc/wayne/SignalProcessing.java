...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/wayne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/wayne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_wayne_audio", "counties.nc.wayne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_wayne_data", "counties.nc.wayne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_wayne_graphics", "counties.nc.wayne.graphics.spectrum", sb.toString());
        }
    }
}