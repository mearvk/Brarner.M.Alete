...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/caldwell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/caldwell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_caldwell_audio", "counties.nc.caldwell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_caldwell_data", "counties.nc.caldwell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_caldwell_graphics", "counties.nc.caldwell.graphics.spectrum", sb.toString());
        }
    }
}