...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/caswell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/caswell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_caswell_audio", "counties.nc.caswell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_caswell_data", "counties.nc.caswell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_caswell_graphics", "counties.nc.caswell.graphics.spectrum", sb.toString());
        }
    }
}