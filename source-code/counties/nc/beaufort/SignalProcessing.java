...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/beaufort/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/beaufort";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_beaufort_audio", "counties.nc.beaufort.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_beaufort_data", "counties.nc.beaufort.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_beaufort_graphics", "counties.nc.beaufort.graphics.spectrum", sb.toString());
        }
    }
}