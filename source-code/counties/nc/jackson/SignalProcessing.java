...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_jackson_audio", "counties.nc.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_jackson_data", "counties.nc.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_jackson_graphics", "counties.nc.jackson.graphics.spectrum", sb.toString());
        }
    }
}