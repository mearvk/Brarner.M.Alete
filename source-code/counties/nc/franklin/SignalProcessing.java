...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/franklin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/franklin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_franklin_audio", "counties.nc.franklin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_franklin_data", "counties.nc.franklin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_franklin_graphics", "counties.nc.franklin.graphics.spectrum", sb.toString());
        }
    }
}