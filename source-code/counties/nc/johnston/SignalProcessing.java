...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/johnston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/johnston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_johnston_audio", "counties.nc.johnston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_johnston_data", "counties.nc.johnston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_johnston_graphics", "counties.nc.johnston.graphics.spectrum", sb.toString());
        }
    }
}