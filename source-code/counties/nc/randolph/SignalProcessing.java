...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/randolph/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/randolph";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_randolph_audio", "counties.nc.randolph.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_randolph_data", "counties.nc.randolph.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_randolph_graphics", "counties.nc.randolph.graphics.spectrum", sb.toString());
        }
    }
}