...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/henderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/henderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_henderson_audio", "counties.nc.henderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_henderson_data", "counties.nc.henderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_henderson_graphics", "counties.nc.henderson.graphics.spectrum", sb.toString());
        }
    }
}