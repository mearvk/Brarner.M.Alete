...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/hyde/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/hyde";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_hyde_audio", "counties.nc.hyde.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_hyde_data", "counties.nc.hyde.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_hyde_graphics", "counties.nc.hyde.graphics.spectrum", sb.toString());
        }
    }
}