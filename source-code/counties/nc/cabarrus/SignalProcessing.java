...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/cabarrus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/cabarrus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_cabarrus_audio", "counties.nc.cabarrus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_cabarrus_data", "counties.nc.cabarrus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_cabarrus_graphics", "counties.nc.cabarrus.graphics.spectrum", sb.toString());
        }
    }
}