package counties.nc.montgomery;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/montgomery/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/montgomery";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_montgomery_audio", "counties.nc.montgomery.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_montgomery_data", "counties.nc.montgomery.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_montgomery_graphics", "counties.nc.montgomery.graphics.spectrum", sb.toString());
        }
    }
}