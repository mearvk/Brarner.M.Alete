...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/carteret/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/carteret";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_carteret_audio", "counties.nc.carteret.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_carteret_data", "counties.nc.carteret.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_carteret_graphics", "counties.nc.carteret.graphics.spectrum", sb.toString());
        }
    }
}