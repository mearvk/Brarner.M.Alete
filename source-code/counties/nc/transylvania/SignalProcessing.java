package counties.nc.transylvania;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/transylvania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9100; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/transylvania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_transylvania_audio", "counties.nc.transylvania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_transylvania_data", "counties.nc.transylvania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_transylvania_graphics", "counties.nc.transylvania.graphics.spectrum", sb.toString());
        }
    }
}