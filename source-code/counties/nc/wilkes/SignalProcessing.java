...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/wilkes/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/wilkes";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilkes_audio", "counties.nc.wilkes.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilkes_data", "counties.nc.wilkes.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_wilkes_graphics", "counties.nc.wilkes.graphics.spectrum", sb.toString());
        }
    }
}