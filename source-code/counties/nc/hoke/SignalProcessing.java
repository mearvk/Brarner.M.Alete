...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/hoke/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/hoke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_hoke_audio", "counties.nc.hoke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_hoke_data", "counties.nc.hoke.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_hoke_graphics", "counties.nc.hoke.graphics.spectrum", sb.toString());
        }
    }
}