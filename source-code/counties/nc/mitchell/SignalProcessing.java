...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/mitchell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/mitchell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_mitchell_audio", "counties.nc.mitchell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_mitchell_data", "counties.nc.mitchell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_mitchell_graphics", "counties.nc.mitchell.graphics.spectrum", sb.toString());
        }
    }
}