...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/buncombe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/buncombe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_buncombe_audio", "counties.nc.buncombe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_buncombe_data", "counties.nc.buncombe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_buncombe_graphics", "counties.nc.buncombe.graphics.spectrum", sb.toString());
        }
    }
}