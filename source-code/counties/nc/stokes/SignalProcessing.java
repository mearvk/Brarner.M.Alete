...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/stokes/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/stokes";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_stokes_audio", "counties.nc.stokes.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_stokes_data", "counties.nc.stokes.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_stokes_graphics", "counties.nc.stokes.graphics.spectrum", sb.toString());
        }
    }
}