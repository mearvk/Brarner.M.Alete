...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/davidson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/davidson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_davidson_audio", "counties.nc.davidson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_davidson_data", "counties.nc.davidson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_davidson_graphics", "counties.nc.davidson.graphics.spectrum", sb.toString());
        }
    }
}