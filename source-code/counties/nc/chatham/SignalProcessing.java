...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/chatham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/chatham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_chatham_audio", "counties.nc.chatham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_chatham_data", "counties.nc.chatham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_chatham_graphics", "counties.nc.chatham.graphics.spectrum", sb.toString());
        }
    }
}