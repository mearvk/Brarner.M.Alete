...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/brunswick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/brunswick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_brunswick_audio", "counties.nc.brunswick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_brunswick_data", "counties.nc.brunswick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_brunswick_graphics", "counties.nc.brunswick.graphics.spectrum", sb.toString());
        }
    }
}