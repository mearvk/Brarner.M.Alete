...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/harnett/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/harnett";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_harnett_audio", "counties.nc.harnett.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_harnett_data", "counties.nc.harnett.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_harnett_graphics", "counties.nc.harnett.graphics.spectrum", sb.toString());
        }
    }
}