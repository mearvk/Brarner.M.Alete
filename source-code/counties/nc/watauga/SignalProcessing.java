...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/watauga/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/watauga";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_watauga_audio", "counties.nc.watauga.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_watauga_data", "counties.nc.watauga.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_watauga_graphics", "counties.nc.watauga.graphics.spectrum", sb.toString());
        }
    }
}