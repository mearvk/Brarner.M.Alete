package counties.nc.newhanover;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/newhanover/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/newhanover";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_newhanover_audio", "counties.nc.newhanover.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_newhanover_data", "counties.nc.newhanover.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_newhanover_graphics", "counties.nc.newhanover.graphics.spectrum", sb.toString());
        }
    }
}