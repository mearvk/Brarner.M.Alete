...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/bertie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/bertie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_bertie_audio", "counties.nc.bertie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_bertie_data", "counties.nc.bertie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_bertie_graphics", "counties.nc.bertie.graphics.spectrum", sb.toString());
        }
    }
}