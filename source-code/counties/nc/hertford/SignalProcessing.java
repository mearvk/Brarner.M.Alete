...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/hertford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/hertford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_hertford_audio", "counties.nc.hertford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_hertford_data", "counties.nc.hertford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_hertford_graphics", "counties.nc.hertford.graphics.spectrum", sb.toString());
        }
    }
}