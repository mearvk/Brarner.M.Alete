...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/yancey/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/yancey";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_yancey_audio", "counties.nc.yancey.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_yancey_data", "counties.nc.yancey.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_yancey_graphics", "counties.nc.yancey.graphics.spectrum", sb.toString());
        }
    }
}