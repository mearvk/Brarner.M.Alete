...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/alleghany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/alleghany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_alleghany_audio", "counties.nc.alleghany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_alleghany_data", "counties.nc.alleghany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_alleghany_graphics", "counties.nc.alleghany.graphics.spectrum", sb.toString());
        }
    }
}