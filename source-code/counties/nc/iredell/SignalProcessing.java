...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/iredell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/iredell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_iredell_audio", "counties.nc.iredell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_iredell_data", "counties.nc.iredell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_iredell_graphics", "counties.nc.iredell.graphics.spectrum", sb.toString());
        }
    }
}