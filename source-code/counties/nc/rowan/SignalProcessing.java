...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/rowan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/rowan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_rowan_audio", "counties.nc.rowan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_rowan_data", "counties.nc.rowan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_rowan_graphics", "counties.nc.rowan.graphics.spectrum", sb.toString());
        }
    }
}