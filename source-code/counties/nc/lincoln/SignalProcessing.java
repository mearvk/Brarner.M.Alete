...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/lincoln/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/lincoln";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_lincoln_audio", "counties.nc.lincoln.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_lincoln_data", "counties.nc.lincoln.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_lincoln_graphics", "counties.nc.lincoln.graphics.spectrum", sb.toString());
        }
    }
}