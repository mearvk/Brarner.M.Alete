...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/pamlico/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/pamlico";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_pamlico_audio", "counties.nc.pamlico.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_pamlico_data", "counties.nc.pamlico.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_pamlico_graphics", "counties.nc.pamlico.graphics.spectrum", sb.toString());
        }
    }
}