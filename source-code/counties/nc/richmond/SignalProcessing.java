...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/richmond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/richmond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_richmond_audio", "counties.nc.richmond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_richmond_data", "counties.nc.richmond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_richmond_graphics", "counties.nc.richmond.graphics.spectrum", sb.toString());
        }
    }
}