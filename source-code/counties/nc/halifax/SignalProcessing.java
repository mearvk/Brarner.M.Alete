...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/halifax/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/halifax";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_halifax_audio", "counties.nc.halifax.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_halifax_data", "counties.nc.halifax.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_halifax_graphics", "counties.nc.halifax.graphics.spectrum", sb.toString());
        }
    }
}