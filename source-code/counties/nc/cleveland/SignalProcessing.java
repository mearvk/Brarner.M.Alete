...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/cleveland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/cleveland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_cleveland_audio", "counties.nc.cleveland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_cleveland_data", "counties.nc.cleveland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_cleveland_graphics", "counties.nc.cleveland.graphics.spectrum", sb.toString());
        }
    }
}