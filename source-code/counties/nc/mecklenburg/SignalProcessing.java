package counties.nc.mecklenburg;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/mecklenburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/mecklenburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_mecklenburg_audio", "counties.nc.mecklenburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_mecklenburg_data", "counties.nc.mecklenburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_mecklenburg_graphics", "counties.nc.mecklenburg.graphics.spectrum", sb.toString());
        }
    }
}