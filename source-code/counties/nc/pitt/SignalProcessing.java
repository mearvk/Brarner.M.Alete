...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/pitt/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/pitt";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_pitt_audio", "counties.nc.pitt.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_pitt_data", "counties.nc.pitt.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_pitt_graphics", "counties.nc.pitt.graphics.spectrum", sb.toString());
        }
    }
}