...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/tyrrell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/tyrrell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_tyrrell_audio", "counties.nc.tyrrell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_tyrrell_data", "counties.nc.tyrrell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_tyrrell_graphics", "counties.nc.tyrrell.graphics.spectrum", sb.toString());
        }
    }
}