...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/forsyth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/forsyth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_forsyth_audio", "counties.nc.forsyth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_forsyth_data", "counties.nc.forsyth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_forsyth_graphics", "counties.nc.forsyth.graphics.spectrum", sb.toString());
        }
    }
}