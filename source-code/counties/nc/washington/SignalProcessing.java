package counties.nc.washington;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/washington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/washington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_washington_audio", "counties.nc.washington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_washington_data", "counties.nc.washington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_washington_graphics", "counties.nc.washington.graphics.spectrum", sb.toString());
        }
    }
}