package counties.nc.perquimans;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/counties/nc/perquimans/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/counties/nc/perquimans";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("counties_nc_perquimans_audio", "counties.nc.perquimans.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("counties_nc_perquimans_data", "counties.nc.perquimans.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("counties_nc_perquimans_graphics", "counties.nc.perquimans.graphics.spectrum", sb.toString());
        }
    }
}