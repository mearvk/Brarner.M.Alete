...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.wingate/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.wingate";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("wingate_audio", "universities.wingate.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("wingate_data", "universities.wingate.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("wingate_graphics", "universities.wingate.graphics.spectrum", sb.toString());
        }
    }
}
