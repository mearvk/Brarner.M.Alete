package universities.warrenwilson;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.warrenwilson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.warrenwilson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("warrenwilson_audio", "universities.warrenwilson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("warrenwilson_data", "universities.warrenwilson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("warrenwilson_graphics", "universities.warrenwilson.graphics.spectrum", sb.toString());
        }
    }
}
