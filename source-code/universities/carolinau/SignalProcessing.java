package universities.carolinau;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.carolinau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.carolinau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("carolinau_audio", "universities.carolinau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("carolinau_data", "universities.carolinau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("carolinau_graphics", "universities.carolinau.graphics.spectrum", sb.toString());
        }
    }
}
