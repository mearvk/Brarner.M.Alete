...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/universities.mearvk/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9001; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.mearvk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mearvk_audio", "universities.mearvk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mearvk_data", "universities.mearvk.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mearvk_graphics", "universities.mearvk.graphics.spectrum", sb.toString());
        }
    }
}
