...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/universities.uncw/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9005; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.uncw";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncw_audio", "universities.uncw.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncw_data", "universities.uncw.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncw_graphics", "universities.uncw.graphics.spectrum", sb.toString());
        }
    }
}
