...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.shaw/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.shaw";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("shaw_audio", "universities.shaw.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("shaw_data", "universities.shaw.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("shaw_graphics", "universities.shaw.graphics.spectrum", sb.toString());
        }
    }
}
