package universities.ncwesleyan;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.ncwesleyan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.ncwesleyan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ncwesleyan_audio", "universities.ncwesleyan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ncwesleyan_data", "universities.ncwesleyan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ncwesleyan_graphics", "universities.ncwesleyan.graphics.spectrum", sb.toString());
        }
    }
}
