package universities.uncgreensboro;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.uncgreensboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.uncgreensboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncgreensboro_audio", "universities.uncgreensboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncgreensboro_data", "universities.uncgreensboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncgreensboro_graphics", "universities.uncgreensboro.graphics.spectrum", sb.toString());
        }
    }
}
