...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.guilford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.guilford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("guilford_audio", "universities.guilford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("guilford_data", "universities.guilford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("guilford_graphics", "universities.guilford.graphics.spectrum", sb.toString());
        }
    }
}
