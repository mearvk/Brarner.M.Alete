...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.salem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.salem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("salem_audio", "universities.salem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("salem_data", "universities.salem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("salem_graphics", "universities.salem.graphics.spectrum", sb.toString());
        }
    }
}
