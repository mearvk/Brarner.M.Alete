package universities.wakeforest;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.wakeforest/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.wakeforest";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("wakeforest_audio", "universities.wakeforest.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("wakeforest_data", "universities.wakeforest.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("wakeforest_graphics", "universities.wakeforest.graphics.spectrum", sb.toString());
        }
    }
}
