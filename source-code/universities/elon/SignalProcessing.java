...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.elon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.elon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("elon_audio", "universities.elon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("elon_data", "universities.elon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("elon_graphics", "universities.elon.graphics.spectrum", sb.toString());
        }
    }
}
