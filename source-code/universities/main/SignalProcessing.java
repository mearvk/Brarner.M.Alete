...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/universities.main/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9004; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.main";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("main_audio", "universities.main.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("main_data", "universities.main.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("main_graphics", "universities.main.graphics.spectrum", sb.toString());
        }
    }
}
