...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.ecsu/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.ecsu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ecsu_audio", "universities.ecsu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ecsu_data", "universities.ecsu.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ecsu_graphics", "universities.ecsu.graphics.spectrum", sb.toString());
        }
    }
}
