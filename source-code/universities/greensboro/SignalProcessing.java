package universities.greensboro;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.greensboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.greensboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("greensboro_audio", "universities.greensboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("greensboro_data", "universities.greensboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("greensboro_graphics", "universities.greensboro.graphics.spectrum", sb.toString());
        }
    }
}
