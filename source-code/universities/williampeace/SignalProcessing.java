package universities.williampeace;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.williampeace/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.williampeace";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("williampeace_audio", "universities.williampeace.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("williampeace_data", "universities.williampeace.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("williampeace_graphics", "universities.williampeace.graphics.spectrum", sb.toString());
        }
    }
}
