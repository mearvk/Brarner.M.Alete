...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.lenoirrhyne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.lenoirrhyne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lenoirrhyne_audio", "universities.lenoirrhyne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lenoirrhyne_data", "universities.lenoirrhyne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lenoirrhyne_graphics", "universities.lenoirrhyne.graphics.spectrum", sb.toString());
        }
    }
}
