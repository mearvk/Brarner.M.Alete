package universities.appalachian;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.appalachian/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.appalachian";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("appalachian_audio", "universities.appalachian.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("appalachian_data", "universities.appalachian.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("appalachian_graphics", "universities.appalachian.graphics.spectrum", sb.toString());
        }
    }
}
