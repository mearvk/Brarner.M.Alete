...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.marshill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.marshill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("marshill_audio", "universities.marshill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("marshill_data", "universities.marshill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("marshill_graphics", "universities.marshill.graphics.spectrum", sb.toString());
        }
    }
}
