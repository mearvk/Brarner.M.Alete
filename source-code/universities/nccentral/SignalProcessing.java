...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.nccentral/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.nccentral";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nccentral_audio", "universities.nccentral.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nccentral_data", "universities.nccentral.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nccentral_graphics", "universities.nccentral.graphics.spectrum", sb.toString());
        }
    }
}
