package universities.uncpembroke;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.uncpembroke/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.uncpembroke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncpembroke_audio", "universities.uncpembroke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncpembroke_data", "universities.uncpembroke.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncpembroke_graphics", "universities.uncpembroke.graphics.spectrum", sb.toString());
        }
    }
}
