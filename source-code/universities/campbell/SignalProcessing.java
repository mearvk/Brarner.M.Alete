...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.campbell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.campbell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("campbell_audio", "universities.campbell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("campbell_data", "universities.campbell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("campbell_graphics", "universities.campbell.graphics.spectrum", sb.toString());
        }
    }
}
