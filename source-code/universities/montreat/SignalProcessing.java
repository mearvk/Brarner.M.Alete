...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.montreat/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.montreat";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("montreat_audio", "universities.montreat.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("montreat_data", "universities.montreat.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("montreat_graphics", "universities.montreat.graphics.spectrum", sb.toString());
        }
    }
}
