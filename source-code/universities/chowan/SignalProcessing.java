...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.chowan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.chowan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chowan_audio", "universities.chowan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chowan_data", "universities.chowan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chowan_graphics", "universities.chowan.graphics.spectrum", sb.toString());
        }
    }
}
