...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.davidson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.davidson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("davidson_audio", "universities.davidson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("davidson_data", "universities.davidson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("davidson_graphics", "universities.davidson.graphics.spectrum", sb.toString());
        }
    }
}
