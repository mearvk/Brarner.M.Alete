...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.uncsa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.uncsa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncsa_audio", "universities.uncsa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncsa_data", "universities.uncsa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncsa_graphics", "universities.uncsa.graphics.spectrum", sb.toString());
        }
    }
}
