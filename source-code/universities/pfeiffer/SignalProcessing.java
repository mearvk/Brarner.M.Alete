...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.pfeiffer/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.pfeiffer";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pfeiffer_audio", "universities.pfeiffer.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pfeiffer_data", "universities.pfeiffer.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pfeiffer_graphics", "universities.pfeiffer.graphics.spectrum", sb.toString());
        }
    }
}
