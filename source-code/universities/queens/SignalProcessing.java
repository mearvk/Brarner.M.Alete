...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.queens/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.queens";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("queens_audio", "universities.queens.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("queens_data", "universities.queens.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("queens_graphics", "universities.queens.graphics.spectrum", sb.toString());
        }
    }
}
