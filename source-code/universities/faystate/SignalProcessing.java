...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.faystate/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.faystate";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("faystate_audio", "universities.faystate.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("faystate_data", "universities.faystate.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("faystate_graphics", "universities.faystate.graphics.spectrum", sb.toString());
        }
    }
}
