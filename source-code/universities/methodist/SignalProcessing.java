...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.methodist/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.methodist";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("methodist_audio", "universities.methodist.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("methodist_data", "universities.methodist.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("methodist_graphics", "universities.methodist.graphics.spectrum", sb.toString());
        }
    }
}
