...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.brevard/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.brevard";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brevard_audio", "universities.brevard.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brevard_data", "universities.brevard.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brevard_graphics", "universities.brevard.graphics.spectrum", sb.toString());
        }
    }
}
