...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.ncat/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.ncat";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ncat_audio", "universities.ncat.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ncat_data", "universities.ncat.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ncat_graphics", "universities.ncat.graphics.spectrum", sb.toString());
        }
    }
}
