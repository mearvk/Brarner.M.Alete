...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.uncasheville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.uncasheville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncasheville_audio", "universities.uncasheville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncasheville_data", "universities.uncasheville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncasheville_graphics", "universities.uncasheville.graphics.spectrum", sb.toString());
        }
    }
}
