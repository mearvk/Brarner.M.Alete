package universities.leesmcrae;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.leesmcrae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.leesmcrae";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leesmcrae_audio", "universities.leesmcrae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leesmcrae_data", "universities.leesmcrae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leesmcrae_graphics", "universities.leesmcrae.graphics.spectrum", sb.toString());
        }
    }
}
