package universities.belmontabbey;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.belmontabbey/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.belmontabbey";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("belmontabbey_audio", "universities.belmontabbey.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("belmontabbey_data", "universities.belmontabbey.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("belmontabbey_graphics", "universities.belmontabbey.graphics.spectrum", sb.toString());
        }
    }
}
