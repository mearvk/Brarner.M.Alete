package universities.wssuniversity;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.wssuniversity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.wssuniversity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("wssuniversity_audio", "universities.wssuniversity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("wssuniversity_data", "universities.wssuniversity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("wssuniversity_graphics", "universities.wssuniversity.graphics.spectrum", sb.toString());
        }
    }
}
