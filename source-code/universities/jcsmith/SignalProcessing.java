...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.jcsmith/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.jcsmith";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("jcsmith_audio", "universities.jcsmith.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("jcsmith_data", "universities.jcsmith.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("jcsmith_graphics", "universities.jcsmith.graphics.spectrum", sb.toString());
        }
    }
}
