package universities.mountolive;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.mountolive/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.mountolive";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mountolive_audio", "universities.mountolive.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mountolive_data", "universities.mountolive.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mountolive_graphics", "universities.mountolive.graphics.spectrum", sb.toString());
        }
    }
}
