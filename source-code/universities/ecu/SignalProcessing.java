...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.ecu/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9008; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.ecu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ecu_audio", "universities.ecu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ecu_data", "universities.ecu.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ecu_graphics", "universities.ecu.graphics.spectrum", sb.toString());
        }
    }
}
