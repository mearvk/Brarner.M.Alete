...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.bennett/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.bennett";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bennett_audio", "universities.bennett.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bennett_data", "universities.bennett.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bennett_graphics", "universities.bennett.graphics.spectrum", sb.toString());
        }
    }
}
