...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/universities.ncsu/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.ncsu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ncsu_audio", "universities.ncsu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ncsu_data", "universities.ncsu.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ncsu_graphics", "universities.ncsu.graphics.spectrum", sb.toString());
        }
    }
}
