package universities.saintaugustines;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.saintaugustines/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9000; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.saintaugustines";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("saintaugustines_audio", "universities.saintaugustines.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("saintaugustines_data", "universities.saintaugustines.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("saintaugustines_graphics", "universities.saintaugustines.graphics.spectrum", sb.toString());
        }
    }
}
