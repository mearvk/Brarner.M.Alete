...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.cabarrus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.cabarrus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cabarrus_audio", "universities.cabarrus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cabarrus_data", "universities.cabarrus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cabarrus_graphics", "universities.cabarrus.graphics.spectrum", sb.toString());
        }
    }
}
