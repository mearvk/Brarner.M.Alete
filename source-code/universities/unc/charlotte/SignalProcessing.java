package universities.unc.charlotte;
...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/uncc/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/uncc";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("uncc_audio", "uncc.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("uncc_data", "uncc.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("uncc_graphics", "uncc.graphics.spectrum", sb.toString());
        }
    }
}
