...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/universities.unc/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9003; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.unc";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("unc_audio", "universities.unc.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("unc_data", "universities.unc.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("unc_graphics", "universities.unc.graphics.spectrum", sb.toString());
        }
    }
}
