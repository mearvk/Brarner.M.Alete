...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.westerncarolina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.westerncarolina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("westerncarolina_audio", "universities.westerncarolina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("westerncarolina_data", "universities.westerncarolina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("westerncarolina_graphics", "universities.westerncarolina.graphics.spectrum", sb.toString());
        }
    }
}
