package universities.gardnerwebb;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.gardnerwebb/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.gardnerwebb";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gardnerwebb_audio", "universities.gardnerwebb.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gardnerwebb_data", "universities.gardnerwebb.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gardnerwebb_graphics", "universities.gardnerwebb.graphics.spectrum", sb.toString());
        }
    }
}
