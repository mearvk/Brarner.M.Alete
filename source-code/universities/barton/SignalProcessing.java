...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.barton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.barton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("barton_audio", "universities.barton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("barton_data", "universities.barton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("barton_graphics", "universities.barton.graphics.spectrum", sb.toString());
        }
    }
}
