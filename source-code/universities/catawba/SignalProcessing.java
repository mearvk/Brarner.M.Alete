...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.catawba/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.catawba";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("catawba_audio", "universities.catawba.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("catawba_data", "universities.catawba.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("catawba_graphics", "universities.catawba.graphics.spectrum", sb.toString());
        }
    }
}
