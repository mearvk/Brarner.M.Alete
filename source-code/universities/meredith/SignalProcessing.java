...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.meredith/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9007; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.meredith";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("meredith_audio", "universities.meredith.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("meredith_data", "universities.meredith.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("meredith_graphics", "universities.meredith.graphics.spectrum", sb.toString());
        }
    }
}
