package universities.livingstone;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.livingstone/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.livingstone";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("livingstone_audio", "universities.livingstone.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("livingstone_data", "universities.livingstone.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("livingstone_graphics", "universities.livingstone.graphics.spectrum", sb.toString());
        }
    }
}
