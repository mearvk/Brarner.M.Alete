package universities.highpoint;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.highpoint/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9006; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.highpoint";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("highpoint_audio", "universities.highpoint.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("highpoint_data", "universities.highpoint.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("highpoint_graphics", "universities.highpoint.graphics.spectrum", sb.toString());
        }
    }
}
