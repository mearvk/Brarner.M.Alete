...
{
    private static String dataSource;   // "local" or "socket"
    private static String dataOutput;   // "file", "database", or "both"
    ...
    static {
        loadConfig("source-code/universities.duke/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.duke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("duke_audio", "universities.duke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("duke_data", "universities.duke.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("duke_graphics", "universities.duke.graphics.spectrum", sb.toString());
        }
    }
}
