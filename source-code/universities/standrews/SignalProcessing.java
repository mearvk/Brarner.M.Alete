package universities.standrews;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/universities.standrews/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/universities.standrews";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("standrews_audio", "universities.standrews.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("standrews_data", "universities.standrews.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("standrews_graphics", "universities.standrews.graphics.spectrum", sb.toString());
        }
    }
}
