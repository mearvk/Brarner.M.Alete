...
/**
 * Signal Processing for SSA Office: BRIDGEPORT CT
 * <p>Office Code: 81</p>
 * <p>Address: 35 COURTLAND ST, BRIDGEPORT, CT 6604</p>
 * <p>Phone: (866) 331-6399 | Fax: (833) 950-2356</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/bridgeport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9553; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/bridgeport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/bridgeport_audio", "ssa.ct.bridgeport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/bridgeport_data", "ssa.ct.bridgeport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/bridgeport_graphics", "ssa.ct.bridgeport.graphics.spectrum", sb.toString());
        }
    }
}