...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/charlotte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/charlotte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_charlotte_audio", "postal.charlotte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_charlotte_data", "postal.charlotte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_charlotte_graphics", "postal.charlotte.graphics.spectrum", sb.toString());
        }
    }
}
