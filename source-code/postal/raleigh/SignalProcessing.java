...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/raleigh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/raleigh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_raleigh_audio", "postal.raleigh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_raleigh_data", "postal.raleigh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_raleigh_graphics", "postal.raleigh.graphics.spectrum", sb.toString());
        }
    }
}
