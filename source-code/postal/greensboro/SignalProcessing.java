...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/greensboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/greensboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_greensboro_audio", "postal.greensboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_greensboro_data", "postal.greensboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_greensboro_graphics", "postal.greensboro.graphics.spectrum", sb.toString());
        }
    }
}
