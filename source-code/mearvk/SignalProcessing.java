...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/mearvk/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/mearvk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mearvk_audio", "mearvk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mearvk_data", "mearvk.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mearvk_graphics", "mearvk.graphics.spectrum", sb.toString());
        }
    }
}
