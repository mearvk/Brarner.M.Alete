...
/**
 * Signal Processing instance for Uzbekistan (UZ)
 * Continent: Asia | Capital: Tashkent
 * Population: 36500000 | Area: 447400 sq km
 * Port: 11187
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/uzbekistan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11187; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/uzbekistan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_uzbekistan_audio", "countries.uzbekistan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_uzbekistan_data", "countries.uzbekistan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_uzbekistan_graphics", "countries.uzbekistan.graphics.spectrum", sb.toString());
        }
    }
}
