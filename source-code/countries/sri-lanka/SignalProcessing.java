...
/**
 * Signal Processing instance for Sri Lanka (LK)
 * Continent: Asia | Capital: Sri Jayawardenepura Kotte
 * Population: 22000000 | Area: 65610 sq km
 * Port: 11164
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/sri-lanka/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11164; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/sri-lanka";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_sri_lanka_audio", "countries.sri_lanka.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_sri_lanka_data", "countries.sri_lanka.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_sri_lanka_graphics", "countries.sri_lanka.graphics.spectrum", sb.toString());
        }
    }
}
