...
/**
 * Signal Processing instance for Zimbabwe (ZW)
 * Continent: Africa | Capital: Harare
 * Population: 17000000 | Area: 390757 sq km
 * Port: 11194
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/zimbabwe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11194; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/zimbabwe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_zimbabwe_audio", "countries.zimbabwe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_zimbabwe_data", "countries.zimbabwe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_zimbabwe_graphics", "countries.zimbabwe.graphics.spectrum", sb.toString());
        }
    }
}
