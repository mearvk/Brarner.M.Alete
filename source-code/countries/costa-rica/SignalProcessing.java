...
/**
 * Signal Processing instance for Costa Rica (CR)
 * Continent: North America | Capital: San Jose
 * Population: 5200000 | Area: 51100 sq km
 * Port: 11040
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/costa-rica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11040; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/costa-rica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_costa_rica_audio", "countries.costa_rica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_costa_rica_data", "countries.costa_rica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_costa_rica_graphics", "countries.costa_rica.graphics.spectrum", sb.toString());
        }
    }
}
