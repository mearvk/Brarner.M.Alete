...
/**
 * Signal Processing instance for Ukraine (UA)
 * Continent: Europe | Capital: Kyiv
 * Population: 37000000 | Area: 603550 sq km
 * Port: 11182
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ukraine/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11182; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ukraine";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ukraine_audio", "countries.ukraine.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ukraine_data", "countries.ukraine.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ukraine_graphics", "countries.ukraine.graphics.spectrum", sb.toString());
        }
    }
}
