...
/**
 * Signal Processing instance for Serbia (RS)
 * Continent: Europe | Capital: Belgrade
 * Population: 6600000 | Area: 88361 sq km
 * Port: 11152
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/serbia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11152; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/serbia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_serbia_audio", "countries.serbia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_serbia_data", "countries.serbia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_serbia_graphics", "countries.serbia.graphics.spectrum", sb.toString());
        }
    }
}
