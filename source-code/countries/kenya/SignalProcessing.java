...
/**
 * Signal Processing instance for Kenya (KE)
 * Continent: Africa | Capital: Nairobi
 * Population: 56000000 | Area: 580367 sq km
 * Port: 11087
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/kenya/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11087; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/kenya";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_kenya_audio", "countries.kenya.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_kenya_data", "countries.kenya.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_kenya_graphics", "countries.kenya.graphics.spectrum", sb.toString());
        }
    }
}
