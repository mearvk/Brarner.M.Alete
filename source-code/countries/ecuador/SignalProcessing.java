...
/**
 * Signal Processing instance for Ecuador (EC)
 * Continent: South America | Capital: Quito
 * Population: 18300000 | Area: 256369 sq km
 * Port: 11049
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ecuador/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11049; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ecuador";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ecuador_audio", "countries.ecuador.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ecuador_data", "countries.ecuador.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ecuador_graphics", "countries.ecuador.graphics.spectrum", sb.toString());
        }
    }
}
