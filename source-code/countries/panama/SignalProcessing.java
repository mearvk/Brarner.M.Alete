...
/**
 * Signal Processing instance for Panama (PA)
 * Continent: North America | Capital: Panama City
 * Population: 4500000 | Area: 75420 sq km
 * Port: 11133
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/panama/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11133; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/panama";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_panama_audio", "countries.panama.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_panama_data", "countries.panama.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_panama_graphics", "countries.panama.graphics.spectrum", sb.toString());
        }
    }
}
