...
/**
 * Signal Processing instance for Brazil (BR)
 * Continent: South America | Capital: Brasilia
 * Population: 217000000 | Area: 8515767 sq km
 * Port: 11023
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/brazil/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11023; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/brazil";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_brazil_audio", "countries.brazil.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_brazil_data", "countries.brazil.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_brazil_graphics", "countries.brazil.graphics.spectrum", sb.toString());
        }
    }
}
