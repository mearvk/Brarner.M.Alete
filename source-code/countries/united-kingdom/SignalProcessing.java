package countries.united_kingdom;
...
/**
 * Signal Processing instance for United Kingdom (GB)
 * Continent: Europe | Capital: London
 * Population: 68000000 | Area: 243610 sq km
 * Port: 11184
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/united-kingdom/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11184; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/united-kingdom";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_united_kingdom_audio", "countries.united_kingdom.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_united_kingdom_data", "countries.united_kingdom.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_united_kingdom_graphics", "countries.united_kingdom.graphics.spectrum", sb.toString());
        }
    }
}
