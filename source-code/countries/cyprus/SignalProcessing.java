...
/**
 * Signal Processing instance for Cyprus (CY)
 * Continent: Asia | Capital: Nicosia
 * Population: 1300000 | Area: 9251 sq km
 * Port: 11043
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/cyprus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11043; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/cyprus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_cyprus_audio", "countries.cyprus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_cyprus_data", "countries.cyprus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_cyprus_graphics", "countries.cyprus.graphics.spectrum", sb.toString());
        }
    }
}
