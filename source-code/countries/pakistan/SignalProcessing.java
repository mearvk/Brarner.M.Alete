...
/**
 * Signal Processing instance for Pakistan (PK)
 * Continent: Asia | Capital: Islamabad
 * Population: 245000000 | Area: 796095 sq km
 * Port: 11130
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/pakistan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11130; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/pakistan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_pakistan_audio", "countries.pakistan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_pakistan_data", "countries.pakistan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_pakistan_graphics", "countries.pakistan.graphics.spectrum", sb.toString());
        }
    }
}
