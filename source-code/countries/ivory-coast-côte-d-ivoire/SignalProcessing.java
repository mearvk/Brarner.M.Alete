package countries.ivory_coast_côte_d_ivoire;
...
/**
 * Signal Processing instance for Ivory Coast (Côte d'Ivoire) (CI)
 * Continent: Africa | Capital: Yamoussoukro
 * Population: 29400000 | Area: 322463 sq km
 * Port: 11082
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ivory-coast-côte-d-ivoire/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11082; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ivory-coast-côte-d-ivoire";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ivory_coast_côte_d_ivoire_audio", "countries.ivory_coast_côte_d_ivoire.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ivory_coast_côte_d_ivoire_data", "countries.ivory_coast_côte_d_ivoire.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ivory_coast_côte_d_ivoire_graphics", "countries.ivory_coast_côte_d_ivoire.graphics.spectrum", sb.toString());
        }
    }
}
