package countries.united_arab_emirates;
...
/**
 * Signal Processing instance for United Arab Emirates (AE)
 * Continent: Asia | Capital: Abu Dhabi
 * Population: 9500000 | Area: 83600 sq km
 * Port: 11183
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/united-arab-emirates/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11183; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/united-arab-emirates";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_united_arab_emirates_audio", "countries.united_arab_emirates.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_united_arab_emirates_data", "countries.united_arab_emirates.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_united_arab_emirates_graphics", "countries.united_arab_emirates.graphics.spectrum", sb.toString());
        }
    }
}
