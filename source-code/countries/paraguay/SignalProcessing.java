...
/**
 * Signal Processing instance for Paraguay (PY)
 * Continent: South America | Capital: Asuncion
 * Population: 6900000 | Area: 406752 sq km
 * Port: 11135
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/paraguay/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11135; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/paraguay";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_paraguay_audio", "countries.paraguay.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_paraguay_data", "countries.paraguay.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_paraguay_graphics", "countries.paraguay.graphics.spectrum", sb.toString());
        }
    }
}
