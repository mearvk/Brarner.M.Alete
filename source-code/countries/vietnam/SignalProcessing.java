...
/**
 * Signal Processing instance for Vietnam (VN)
 * Continent: Asia | Capital: Hanoi
 * Population: 99500000 | Area: 331210 sq km
 * Port: 11191
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/vietnam/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11191; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/vietnam";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_vietnam_audio", "countries.vietnam.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_vietnam_data", "countries.vietnam.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_vietnam_graphics", "countries.vietnam.graphics.spectrum", sb.toString());
        }
    }
}
