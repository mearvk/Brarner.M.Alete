...
/**
 * Signal Processing instance for Ethiopia (ET)
 * Continent: Africa | Capital: Addis Ababa
 * Population: 129000000 | Area: 1104300 sq km
 * Port: 11056
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ethiopia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11056; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ethiopia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ethiopia_audio", "countries.ethiopia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ethiopia_data", "countries.ethiopia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ethiopia_graphics", "countries.ethiopia.graphics.spectrum", sb.toString());
        }
    }
}
