...
/**
 * Signal Processing instance for Slovakia (SK)
 * Continent: Europe | Capital: Bratislava
 * Population: 5400000 | Area: 49035 sq km
 * Port: 11156
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/slovakia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11156; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/slovakia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_slovakia_audio", "countries.slovakia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_slovakia_data", "countries.slovakia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_slovakia_graphics", "countries.slovakia.graphics.spectrum", sb.toString());
        }
    }
}
