...
/**
 * Signal Processing instance for New Zealand (NZ)
 * Continent: Oceania | Capital: Wellington
 * Population: 5300000 | Area: 268021 sq km
 * Port: 11122
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/new-zealand/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11122; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/new-zealand";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_new_zealand_audio", "countries.new_zealand.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_new_zealand_data", "countries.new_zealand.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_new_zealand_graphics", "countries.new_zealand.graphics.spectrum", sb.toString());
        }
    }
}
