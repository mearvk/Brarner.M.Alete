...
/**
 * Signal Processing instance for Iran (IR)
 * Continent: Asia | Capital: Tehran
 * Population: 89500000 | Area: 1648195 sq km
 * Port: 11077
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/iran/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11077; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/iran";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_iran_audio", "countries.iran.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_iran_data", "countries.iran.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_iran_graphics", "countries.iran.graphics.spectrum", sb.toString());
        }
    }
}
