...
/**
 * Signal Processing instance for North Korea (KP)
 * Continent: Asia | Capital: Pyongyang
 * Population: 26200000 | Area: 120538 sq km
 * Port: 11126
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/north-korea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11126; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/north-korea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_north_korea_audio", "countries.north_korea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_north_korea_data", "countries.north_korea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_north_korea_graphics", "countries.north_korea.graphics.spectrum", sb.toString());
        }
    }
}
