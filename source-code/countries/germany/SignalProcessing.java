...
/**
 * Signal Processing instance for Germany (DE)
 * Continent: Europe | Capital: Berlin
 * Population: 84500000 | Area: 357022 sq km
 * Port: 11063
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/germany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11063; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/germany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_germany_audio", "countries.germany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_germany_data", "countries.germany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_germany_graphics", "countries.germany.graphics.spectrum", sb.toString());
        }
    }
}
