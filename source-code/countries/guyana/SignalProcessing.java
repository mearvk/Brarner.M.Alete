...
/**
 * Signal Processing instance for Guyana (GY)
 * Continent: South America | Capital: Georgetown
 * Population: 815000 | Area: 214969 sq km
 * Port: 11070
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/guyana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11070; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/guyana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_guyana_audio", "countries.guyana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_guyana_data", "countries.guyana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_guyana_graphics", "countries.guyana.graphics.spectrum", sb.toString());
        }
    }
}
