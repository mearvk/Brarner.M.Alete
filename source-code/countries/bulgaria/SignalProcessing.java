...
/**
 * Signal Processing instance for Bulgaria (BG)
 * Continent: Europe | Capital: Sofia
 * Population: 6400000 | Area: 110879 sq km
 * Port: 11025
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bulgaria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11025; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bulgaria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bulgaria_audio", "countries.bulgaria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bulgaria_data", "countries.bulgaria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bulgaria_graphics", "countries.bulgaria.graphics.spectrum", sb.toString());
        }
    }
}
