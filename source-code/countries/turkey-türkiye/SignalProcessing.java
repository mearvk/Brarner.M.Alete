package countries.turkey_türkiye;
...
/**
 * Signal Processing instance for Turkey (Türkiye) (TR)
 * Continent: Asia/Europe | Capital: Ankara
 * Population: 86000000 | Area: 783562 sq km
 * Port: 11178
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/turkey-türkiye/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11178; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/turkey-türkiye";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_turkey_türkiye_audio", "countries.turkey_türkiye.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_turkey_türkiye_data", "countries.turkey_türkiye.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_turkey_türkiye_graphics", "countries.turkey_türkiye.graphics.spectrum", sb.toString());
        }
    }
}
