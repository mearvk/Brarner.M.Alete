...
/**
 * Signal Processing instance for South Korea (KR)
 * Continent: Asia | Capital: Seoul
 * Population: 51700000 | Area: 100210 sq km
 * Port: 11161
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/south-korea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11161; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/south-korea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_south_korea_audio", "countries.south_korea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_south_korea_data", "countries.south_korea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_south_korea_graphics", "countries.south_korea.graphics.spectrum", sb.toString());
        }
    }
}
