...
/**
 * Signal Processing instance for Angola (AO)
 * Continent: Africa | Capital: Luanda
 * Population: 37800000 | Area: 1246700 sq km
 * Port: 11004
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/angola/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11004; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/angola";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_angola_audio", "countries.angola.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_angola_data", "countries.angola.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_angola_graphics", "countries.angola.graphics.spectrum", sb.toString());
        }
    }
}
