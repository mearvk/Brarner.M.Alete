...
/**
 * Signal Processing instance for Djibouti (DJ)
 * Continent: Africa | Capital: Djibouti
 * Population: 1100000 | Area: 23200 sq km
 * Port: 11046
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/djibouti/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11046; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/djibouti";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_djibouti_audio", "countries.djibouti.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_djibouti_data", "countries.djibouti.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_djibouti_graphics", "countries.djibouti.graphics.spectrum", sb.toString());
        }
    }
}
