package countries.central_african_republic;
...
/**
 * Signal Processing instance for Central African Republic (CF)
 * Continent: Africa | Capital: Bangui
 * Population: 5800000 | Area: 622984 sq km
 * Port: 11032
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/central-african-republic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11032; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/central-african-republic";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_central_african_republic_audio", "countries.central_african_republic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_central_african_republic_data", "countries.central_african_republic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_central_african_republic_graphics", "countries.central_african_republic.graphics.spectrum", sb.toString());
        }
    }
}
