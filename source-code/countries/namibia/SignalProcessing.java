...
/**
 * Signal Processing instance for Namibia (NA)
 * Continent: Africa | Capital: Windhoek
 * Population: 2600000 | Area: 824292 sq km
 * Port: 11118
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/namibia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11118; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/namibia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_namibia_audio", "countries.namibia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_namibia_data", "countries.namibia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_namibia_graphics", "countries.namibia.graphics.spectrum", sb.toString());
        }
    }
}
