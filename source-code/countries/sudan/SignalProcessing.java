...
/**
 * Signal Processing instance for Sudan (SD)
 * Continent: Africa | Capital: Khartoum
 * Population: 49000000 | Area: 1861484 sq km
 * Port: 11165
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/sudan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11165; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/sudan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_sudan_audio", "countries.sudan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_sudan_data", "countries.sudan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_sudan_graphics", "countries.sudan.graphics.spectrum", sb.toString());
        }
    }
}
