...
/**
 * Signal Processing instance for Russia (RU)
 * Continent: Europe/Asia | Capital: Moscow
 * Population: 144000000 | Area: 17098242 sq km
 * Port: 11142
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/russia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11142; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/russia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_russia_audio", "countries.russia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_russia_data", "countries.russia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_russia_graphics", "countries.russia.graphics.spectrum", sb.toString());
        }
    }
}
