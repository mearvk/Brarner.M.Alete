...
/**
 * Signal Processing instance for Bolivia (BO)
 * Continent: South America | Capital: Sucre
 * Population: 12500000 | Area: 1098581 sq km
 * Port: 11020
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bolivia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11020; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bolivia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bolivia_audio", "countries.bolivia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bolivia_data", "countries.bolivia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bolivia_graphics", "countries.bolivia.graphics.spectrum", sb.toString());
        }
    }
}
