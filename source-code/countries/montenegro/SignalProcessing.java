...
/**
 * Signal Processing instance for Montenegro (ME)
 * Continent: Europe | Capital: Podgorica
 * Population: 620000 | Area: 13812 sq km
 * Port: 11114
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/montenegro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11114; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/montenegro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_montenegro_audio", "countries.montenegro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_montenegro_data", "countries.montenegro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_montenegro_graphics", "countries.montenegro.graphics.spectrum", sb.toString());
        }
    }
}
