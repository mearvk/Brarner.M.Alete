...
/**
 * Signal Processing instance for Finland (FI)
 * Continent: Europe | Capital: Helsinki
 * Population: 5600000 | Area: 338424 sq km
 * Port: 11058
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/finland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11058; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/finland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_finland_audio", "countries.finland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_finland_data", "countries.finland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_finland_graphics", "countries.finland.graphics.spectrum", sb.toString());
        }
    }
}
