...
/**
 * Signal Processing instance for Singapore (SG)
 * Continent: Asia | Capital: Singapore
 * Population: 6000000 | Area: 728 sq km
 * Port: 11155
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/singapore/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11155; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/singapore";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_singapore_audio", "countries.singapore.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_singapore_data", "countries.singapore.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_singapore_graphics", "countries.singapore.graphics.spectrum", sb.toString());
        }
    }
}
