...
/**
 * Signal Processing instance for Timor-Leste (TL)
 * Continent: Asia | Capital: Dili
 * Population: 1370000 | Area: 14874 sq km
 * Port: 11173
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/timor-leste/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11173; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/timor-leste";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_timor_leste_audio", "countries.timor_leste.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_timor_leste_data", "countries.timor_leste.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_timor_leste_graphics", "countries.timor_leste.graphics.spectrum", sb.toString());
        }
    }
}
