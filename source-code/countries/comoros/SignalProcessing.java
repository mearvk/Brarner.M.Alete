...
/**
 * Signal Processing instance for Comoros (KM)
 * Continent: Africa | Capital: Moroni
 * Population: 860000 | Area: 2235 sq km
 * Port: 11037
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/comoros/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11037; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/comoros";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_comoros_audio", "countries.comoros.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_comoros_data", "countries.comoros.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_comoros_graphics", "countries.comoros.graphics.spectrum", sb.toString());
        }
    }
}
