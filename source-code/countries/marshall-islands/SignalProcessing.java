package countries.marshall_islands;
...
/**
 * Signal Processing instance for Marshall Islands (MH)
 * Continent: Oceania | Capital: Majuro
 * Population: 420000 | Area: 181 sq km
 * Port: 11106
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/marshall-islands/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11106; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/marshall-islands";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_marshall_islands_audio", "countries.marshall_islands.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_marshall_islands_data", "countries.marshall_islands.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_marshall_islands_graphics", "countries.marshall_islands.graphics.spectrum", sb.toString());
        }
    }
}
