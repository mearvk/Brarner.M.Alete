...
/**
 * Signal Processing instance for Indonesia (ID)
 * Continent: Asia | Capital: Jakarta
 * Population: 279000000 | Area: 1904569 sq km
 * Port: 11076
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/indonesia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11076; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/indonesia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_indonesia_audio", "countries.indonesia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_indonesia_data", "countries.indonesia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_indonesia_graphics", "countries.indonesia.graphics.spectrum", sb.toString());
        }
    }
}
