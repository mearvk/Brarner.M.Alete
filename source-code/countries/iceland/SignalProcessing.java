...
/**
 * Signal Processing instance for Iceland (IS)
 * Continent: Europe | Capital: Reykjavik
 * Population: 3900000 | Area: 103000 sq km
 * Port: 11074
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/iceland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11074; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/iceland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_iceland_audio", "countries.iceland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_iceland_data", "countries.iceland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_iceland_graphics", "countries.iceland.graphics.spectrum", sb.toString());
        }
    }
}
