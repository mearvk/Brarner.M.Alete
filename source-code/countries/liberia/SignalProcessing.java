...
/**
 * Signal Processing instance for Liberia (LR)
 * Continent: Africa | Capital: Monrovia
 * Population: 5500000 | Area: 111369 sq km
 * Port: 11095
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/liberia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11095; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/liberia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_liberia_audio", "countries.liberia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_liberia_data", "countries.liberia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_liberia_graphics", "countries.liberia.graphics.spectrum", sb.toString());
        }
    }
}
