...
/**
 * Signal Processing instance for Benin (BJ)
 * Continent: Africa | Capital: Porto-Novo
 * Population: 14200000 | Area: 112622 sq km
 * Port: 11018
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/benin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11018; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/benin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_benin_audio", "countries.benin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_benin_data", "countries.benin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_benin_graphics", "countries.benin.graphics.spectrum", sb.toString());
        }
    }
}
