...
/**
 * Signal Processing instance for Niger (NE)
 * Continent: Africa | Capital: Niamey
 * Population: 27000000 | Area: 1267000 sq km
 * Port: 11124
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/niger/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11124; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/niger";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_niger_audio", "countries.niger.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_niger_data", "countries.niger.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_niger_graphics", "countries.niger.graphics.spectrum", sb.toString());
        }
    }
}
