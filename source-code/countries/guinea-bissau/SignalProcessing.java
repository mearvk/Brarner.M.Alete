package countries.guinea_bissau;
...
/**
 * Signal Processing instance for Guinea-Bissau (GW)
 * Continent: Africa | Capital: Bissau
 * Population: 2200000 | Area: 36125 sq km
 * Port: 11069
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/guinea-bissau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11069; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/guinea-bissau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_guinea_bissau_audio", "countries.guinea_bissau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_guinea_bissau_data", "countries.guinea_bissau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_guinea_bissau_graphics", "countries.guinea_bissau.graphics.spectrum", sb.toString());
        }
    }
}
