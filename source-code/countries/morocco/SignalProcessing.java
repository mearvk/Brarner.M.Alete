...
/**
 * Signal Processing instance for Morocco (MA)
 * Continent: Africa | Capital: Rabat
 * Population: 38000000 | Area: 446550 sq km
 * Port: 11115
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/morocco/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11115; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/morocco";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_morocco_audio", "countries.morocco.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_morocco_data", "countries.morocco.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_morocco_graphics", "countries.morocco.graphics.spectrum", sb.toString());
        }
    }
}
