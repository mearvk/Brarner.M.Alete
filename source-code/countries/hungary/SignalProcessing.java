...
/**
 * Signal Processing instance for Hungary (HU)
 * Continent: Europe | Capital: Budapest
 * Population: 9600000 | Area: 93028 sq km
 * Port: 11073
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/hungary/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11073; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/hungary";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_hungary_audio", "countries.hungary.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_hungary_data", "countries.hungary.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_hungary_graphics", "countries.hungary.graphics.spectrum", sb.toString());
        }
    }
}
