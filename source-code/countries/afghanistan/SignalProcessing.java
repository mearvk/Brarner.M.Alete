...
/**
 * Signal Processing instance for Afghanistan (AF)
 * Continent: Asia | Capital: Kabul
 * Population: 43300000 | Area: 652230 sq km
 * Port: 11000
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/afghanistan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11000; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/afghanistan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_afghanistan_audio", "countries.afghanistan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_afghanistan_data", "countries.afghanistan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_afghanistan_graphics", "countries.afghanistan.graphics.spectrum", sb.toString());
        }
    }
}
