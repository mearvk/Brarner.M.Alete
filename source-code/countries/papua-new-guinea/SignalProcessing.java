package countries.papua_new_guinea;
...
/**
 * Signal Processing instance for Papua New Guinea (PG)
 * Continent: Oceania | Capital: Port Moresby
 * Population: 10500000 | Area: 462840 sq km
 * Port: 11134
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/papua-new-guinea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11134; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/papua-new-guinea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_papua_new_guinea_audio", "countries.papua_new_guinea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_papua_new_guinea_data", "countries.papua_new_guinea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_papua_new_guinea_graphics", "countries.papua_new_guinea.graphics.spectrum", sb.toString());
        }
    }
}
