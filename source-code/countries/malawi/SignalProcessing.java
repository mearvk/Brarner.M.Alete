...
/**
 * Signal Processing instance for Malawi (MW)
 * Continent: Africa | Capital: Lilongwe
 * Population: 21400000 | Area: 118484 sq km
 * Port: 11101
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/malawi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11101; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/malawi";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_malawi_audio", "countries.malawi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_malawi_data", "countries.malawi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_malawi_graphics", "countries.malawi.graphics.spectrum", sb.toString());
        }
    }
}
