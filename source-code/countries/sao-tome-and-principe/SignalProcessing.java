package countries.sao_tome_and_principe;
...
/**
 * Signal Processing instance for Sao Tome and Principe (ST)
 * Continent: Africa | Capital: Sao Tome
 * Population: 235000 | Area: 964 sq km
 * Port: 11149
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/sao-tome-and-principe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11149; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/sao-tome-and-principe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_sao_tome_and_principe_audio", "countries.sao_tome_and_principe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_sao_tome_and_principe_data", "countries.sao_tome_and_principe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_sao_tome_and_principe_graphics", "countries.sao_tome_and_principe.graphics.spectrum", sb.toString());
        }
    }
}
