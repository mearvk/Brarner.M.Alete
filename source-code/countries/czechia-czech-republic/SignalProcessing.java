package countries.czechia_czech_republic;
...
/**
 * Signal Processing instance for Czechia (Czech Republic) (CZ)
 * Continent: Europe | Capital: Prague
 * Population: 10900000 | Area: 78867 sq km
 * Port: 11044
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/czechia-czech-republic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11044; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/czechia-czech-republic";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_czechia_czech_republic_audio", "countries.czechia_czech_republic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_czechia_czech_republic_data", "countries.czechia_czech_republic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_czechia_czech_republic_graphics", "countries.czechia_czech_republic.graphics.spectrum", sb.toString());
        }
    }
}
