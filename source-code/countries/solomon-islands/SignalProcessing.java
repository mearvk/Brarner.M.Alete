package countries.solomon_islands;
...
/**
 * Signal Processing instance for Solomon Islands (SB)
 * Continent: Oceania | Capital: Honiara
 * Population: 740000 | Area: 28896 sq km
 * Port: 11158
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/solomon-islands/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11158; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/solomon-islands";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_solomon_islands_audio", "countries.solomon_islands.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_solomon_islands_data", "countries.solomon_islands.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_solomon_islands_graphics", "countries.solomon_islands.graphics.spectrum", sb.toString());
        }
    }
}
