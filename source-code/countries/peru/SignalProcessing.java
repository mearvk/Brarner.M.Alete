...
/**
 * Signal Processing instance for Peru (PE)
 * Continent: South America | Capital: Lima
 * Population: 34400000 | Area: 1285216 sq km
 * Port: 11136
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/peru/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11136; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/peru";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_peru_audio", "countries.peru.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_peru_data", "countries.peru.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_peru_graphics", "countries.peru.graphics.spectrum", sb.toString());
        }
    }
}
