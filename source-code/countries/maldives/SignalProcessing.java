...
/**
 * Signal Processing instance for Maldives (MV)
 * Continent: Asia | Capital: Male
 * Population: 520000 | Area: 298 sq km
 * Port: 11103
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/maldives/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11103; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/maldives";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_maldives_audio", "countries.maldives.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_maldives_data", "countries.maldives.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_maldives_graphics", "countries.maldives.graphics.spectrum", sb.toString());
        }
    }
}
