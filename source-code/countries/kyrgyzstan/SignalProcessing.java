...
/**
 * Signal Processing instance for Kyrgyzstan (KG)
 * Continent: Asia | Capital: Bishkek
 * Population: 7100000 | Area: 199951 sq km
 * Port: 11090
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/kyrgyzstan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11090; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/kyrgyzstan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_kyrgyzstan_audio", "countries.kyrgyzstan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_kyrgyzstan_data", "countries.kyrgyzstan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_kyrgyzstan_graphics", "countries.kyrgyzstan.graphics.spectrum", sb.toString());
        }
    }
}
