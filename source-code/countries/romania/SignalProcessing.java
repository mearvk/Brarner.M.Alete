...
/**
 * Signal Processing instance for Romania (RO)
 * Continent: Europe | Capital: Bucharest
 * Population: 19000000 | Area: 238391 sq km
 * Port: 11141
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/romania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11141; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/romania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_romania_audio", "countries.romania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_romania_data", "countries.romania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_romania_graphics", "countries.romania.graphics.spectrum", sb.toString());
        }
    }
}
