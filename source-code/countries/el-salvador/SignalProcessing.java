...
/**
 * Signal Processing instance for El Salvador (SV)
 * Continent: North America | Capital: San Salvador
 * Population: 6400000 | Area: 21041 sq km
 * Port: 11051
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/el-salvador/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11051; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/el-salvador";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_el_salvador_audio", "countries.el_salvador.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_el_salvador_data", "countries.el_salvador.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_el_salvador_graphics", "countries.el_salvador.graphics.spectrum", sb.toString());
        }
    }
}
