...
/**
 * Signal Processing instance for Malta (MT)
 * Continent: Europe | Capital: Valletta
 * Population: 535000 | Area: 316 sq km
 * Port: 11105
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/malta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11105; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/malta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_malta_audio", "countries.malta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_malta_data", "countries.malta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_malta_graphics", "countries.malta.graphics.spectrum", sb.toString());
        }
    }
}
