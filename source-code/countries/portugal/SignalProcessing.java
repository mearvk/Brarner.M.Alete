...
/**
 * Signal Processing instance for Portugal (PT)
 * Continent: Europe | Capital: Lisbon
 * Population: 10400000 | Area: 92090 sq km
 * Port: 11139
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/portugal/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11139; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/portugal";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_portugal_audio", "countries.portugal.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_portugal_data", "countries.portugal.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_portugal_graphics", "countries.portugal.graphics.spectrum", sb.toString());
        }
    }
}
