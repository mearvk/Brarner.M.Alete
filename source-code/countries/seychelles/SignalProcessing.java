...
/**
 * Signal Processing instance for Seychelles (SC)
 * Continent: Africa | Capital: Victoria
 * Population: 100000 | Area: 455 sq km
 * Port: 11153
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/seychelles/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11153; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/seychelles";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_seychelles_audio", "countries.seychelles.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_seychelles_data", "countries.seychelles.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_seychelles_graphics", "countries.seychelles.graphics.spectrum", sb.toString());
        }
    }
}
