...
/**
 * Signal Processing instance for Estonia (EE)
 * Continent: Europe | Capital: Tallinn
 * Population: 1400000 | Area: 45228 sq km
 * Port: 11054
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/estonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11054; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/estonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_estonia_audio", "countries.estonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_estonia_data", "countries.estonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_estonia_graphics", "countries.estonia.graphics.spectrum", sb.toString());
        }
    }
}
