package countries.saint_kitts_and_nevis;
...
/**
 * Signal Processing instance for Saint Kitts and Nevis (KN)
 * Continent: North America | Capital: Basseterre
 * Population: 48000 | Area: 261 sq km
 * Port: 11144
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/saint-kitts-and-nevis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11144; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/saint-kitts-and-nevis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_saint_kitts_and_nevis_audio", "countries.saint_kitts_and_nevis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_saint_kitts_and_nevis_data", "countries.saint_kitts_and_nevis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_saint_kitts_and_nevis_graphics", "countries.saint_kitts_and_nevis.graphics.spectrum", sb.toString());
        }
    }
}
