...
/**
 * Signal Processing instance for Grenada (GD)
 * Continent: North America | Capital: St. George's
 * Population: 126000 | Area: 344 sq km
 * Port: 11066
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/grenada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11066; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/grenada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_grenada_audio", "countries.grenada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_grenada_data", "countries.grenada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_grenada_graphics", "countries.grenada.graphics.spectrum", sb.toString());
        }
    }
}
