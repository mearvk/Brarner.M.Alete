...
/**
 * Signal Processing instance for Uruguay (UY)
 * Continent: South America | Capital: Montevideo
 * Population: 3400000 | Area: 176215 sq km
 * Port: 11186
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/uruguay/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11186; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/uruguay";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_uruguay_audio", "countries.uruguay.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_uruguay_data", "countries.uruguay.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_uruguay_graphics", "countries.uruguay.graphics.spectrum", sb.toString());
        }
    }
}
