...
/**
 * Signal Processing instance for Poland (PL)
 * Continent: Europe | Capital: Warsaw
 * Population: 36700000 | Area: 312696 sq km
 * Port: 11138
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/poland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11138; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/poland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_poland_audio", "countries.poland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_poland_data", "countries.poland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_poland_graphics", "countries.poland.graphics.spectrum", sb.toString());
        }
    }
}
