...
/**
 * Signal Processing instance for Brunei (BN)
 * Continent: Asia | Capital: Bandar Seri Begawan
 * Population: 450000 | Area: 5765 sq km
 * Port: 11024
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/brunei/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11024; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/brunei";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_brunei_audio", "countries.brunei.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_brunei_data", "countries.brunei.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_brunei_graphics", "countries.brunei.graphics.spectrum", sb.toString());
        }
    }
}
