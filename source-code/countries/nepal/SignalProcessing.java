...
/**
 * Signal Processing instance for Nepal (NP)
 * Continent: Asia | Capital: Kathmandu
 * Population: 31000000 | Area: 147181 sq km
 * Port: 11120
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/nepal/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11120; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/nepal";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_nepal_audio", "countries.nepal.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_nepal_data", "countries.nepal.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_nepal_graphics", "countries.nepal.graphics.spectrum", sb.toString());
        }
    }
}
