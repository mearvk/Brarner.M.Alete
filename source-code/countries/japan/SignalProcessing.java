...
/**
 * Signal Processing instance for Japan (JP)
 * Continent: Asia | Capital: Tokyo
 * Population: 123500000 | Area: 377975 sq km
 * Port: 11084
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/japan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11084; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/japan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_japan_audio", "countries.japan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_japan_data", "countries.japan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_japan_graphics", "countries.japan.graphics.spectrum", sb.toString());
        }
    }
}
