...
/**
 * Signal Processing instance for Laos (LA)
 * Continent: Asia | Capital: Vientiane
 * Population: 7700000 | Area: 236800 sq km
 * Port: 11091
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/laos/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11091; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/laos";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_laos_audio", "countries.laos.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_laos_data", "countries.laos.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_laos_graphics", "countries.laos.graphics.spectrum", sb.toString());
        }
    }
}
