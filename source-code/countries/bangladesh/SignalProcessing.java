...
/**
 * Signal Processing instance for Bangladesh (BD)
 * Continent: Asia | Capital: Dhaka
 * Population: 174000000 | Area: 148460 sq km
 * Port: 11013
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bangladesh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11013; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bangladesh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bangladesh_audio", "countries.bangladesh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bangladesh_data", "countries.bangladesh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bangladesh_graphics", "countries.bangladesh.graphics.spectrum", sb.toString());
        }
    }
}
