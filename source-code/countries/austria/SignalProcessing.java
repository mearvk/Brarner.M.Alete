...
/**
 * Signal Processing instance for Austria (AT)
 * Continent: Europe | Capital: Vienna
 * Population: 9100000 | Area: 83871 sq km
 * Port: 11009
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/austria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11009; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/austria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_austria_audio", "countries.austria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_austria_data", "countries.austria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_austria_graphics", "countries.austria.graphics.spectrum", sb.toString());
        }
    }
}
