...
/**
 * Signal Processing instance for Andorra (AD)
 * Continent: Europe | Capital: Andorra la Vella
 * Population: 85000 | Area: 468 sq km
 * Port: 11003
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/andorra/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11003; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/andorra";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_andorra_audio", "countries.andorra.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_andorra_data", "countries.andorra.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_andorra_graphics", "countries.andorra.graphics.spectrum", sb.toString());
        }
    }
}
