...
/**
 * Signal Processing instance for Bahrain (BH)
 * Continent: Asia | Capital: Manama
 * Population: 1600000 | Area: 765 sq km
 * Port: 11012
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bahrain/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11012; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bahrain";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bahrain_audio", "countries.bahrain.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bahrain_data", "countries.bahrain.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bahrain_graphics", "countries.bahrain.graphics.spectrum", sb.toString());
        }
    }
}
