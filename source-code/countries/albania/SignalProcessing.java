...
/**
 * Signal Processing instance for Albania (AL)
 * Continent: Europe | Capital: Tirana
 * Population: 2800000 | Area: 28748 sq km
 * Port: 11001
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/albania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11001; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/albania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_albania_audio", "countries.albania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_albania_data", "countries.albania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_albania_graphics", "countries.albania.graphics.spectrum", sb.toString());
        }
    }
}
