...
/**
 * Signal Processing instance for France (FR)
 * Continent: Europe | Capital: Paris
 * Population: 66500000 | Area: 551695 sq km
 * Port: 11059
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/france/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11059; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/france";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_france_audio", "countries.france.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_france_data", "countries.france.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_france_graphics", "countries.france.graphics.spectrum", sb.toString());
        }
    }
}
