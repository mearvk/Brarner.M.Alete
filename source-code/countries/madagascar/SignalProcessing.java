...
/**
 * Signal Processing instance for Madagascar (MG)
 * Continent: Africa | Capital: Antananarivo
 * Population: 31000000 | Area: 587041 sq km
 * Port: 11100
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/madagascar/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11100; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/madagascar";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_madagascar_audio", "countries.madagascar.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_madagascar_data", "countries.madagascar.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_madagascar_graphics", "countries.madagascar.graphics.spectrum", sb.toString());
        }
    }
}
