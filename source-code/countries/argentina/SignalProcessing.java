...
/**
 * Signal Processing instance for Argentina (AR)
 * Continent: South America | Capital: Buenos Aires
 * Population: 46000000 | Area: 2780400 sq km
 * Port: 11006
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/argentina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11006; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/argentina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_argentina_audio", "countries.argentina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_argentina_data", "countries.argentina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_argentina_graphics", "countries.argentina.graphics.spectrum", sb.toString());
        }
    }
}
