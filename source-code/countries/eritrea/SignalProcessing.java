...
/**
 * Signal Processing instance for Eritrea (ER)
 * Continent: Africa | Capital: Asmara
 * Population: 3800000 | Area: 117600 sq km
 * Port: 11053
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/eritrea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11053; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/eritrea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_eritrea_audio", "countries.eritrea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_eritrea_data", "countries.eritrea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_eritrea_graphics", "countries.eritrea.graphics.spectrum", sb.toString());
        }
    }
}
