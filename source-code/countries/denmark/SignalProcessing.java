...
/**
 * Signal Processing instance for Denmark (DK)
 * Continent: Europe | Capital: Copenhagen
 * Population: 5900000 | Area: 43094 sq km
 * Port: 11045
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/denmark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/denmark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_denmark_audio", "countries.denmark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_denmark_data", "countries.denmark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_denmark_graphics", "countries.denmark.graphics.spectrum", sb.toString());
        }
    }
}
