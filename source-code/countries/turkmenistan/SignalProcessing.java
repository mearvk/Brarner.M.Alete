package countries.turkmenistan;
...
/**
 * Signal Processing instance for Turkmenistan (TM)
 * Continent: Asia | Capital: Ashgabat
 * Population: 6600000 | Area: 488100 sq km
 * Port: 11179
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/turkmenistan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11179; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/turkmenistan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_turkmenistan_audio", "countries.turkmenistan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_turkmenistan_data", "countries.turkmenistan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_turkmenistan_graphics", "countries.turkmenistan.graphics.spectrum", sb.toString());
        }
    }
}
