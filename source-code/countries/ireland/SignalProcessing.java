...
/**
 * Signal Processing instance for Ireland (IE)
 * Continent: Europe | Capital: Dublin
 * Population: 5300000 | Area: 70273 sq km
 * Port: 11079
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ireland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11079; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ireland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ireland_audio", "countries.ireland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ireland_data", "countries.ireland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ireland_graphics", "countries.ireland.graphics.spectrum", sb.toString());
        }
    }
}
