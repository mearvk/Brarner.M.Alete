...
/**
 * Signal Processing instance for Moldova (MD)
 * Continent: Europe | Capital: Chisinau
 * Population: 2500000 | Area: 33851 sq km
 * Port: 11111
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/moldova/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11111; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/moldova";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_moldova_audio", "countries.moldova.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_moldova_data", "countries.moldova.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_moldova_graphics", "countries.moldova.graphics.spectrum", sb.toString());
        }
    }
}
