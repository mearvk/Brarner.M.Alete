package countries.trinidad_and_tobago;
...
/**
 * Signal Processing instance for Trinidad and Tobago (TT)
 * Continent: North America | Capital: Port of Spain
 * Population: 1500000 | Area: 5130 sq km
 * Port: 11176
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/trinidad-and-tobago/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11176; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/trinidad-and-tobago";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_trinidad_and_tobago_audio", "countries.trinidad_and_tobago.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_trinidad_and_tobago_data", "countries.trinidad_and_tobago.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_trinidad_and_tobago_graphics", "countries.trinidad_and_tobago.graphics.spectrum", sb.toString());
        }
    }
}
