...
/**
 * Signal Processing instance for Tunisia (TN)
 * Continent: Africa | Capital: Tunis
 * Population: 12500000 | Area: 163610 sq km
 * Port: 11177
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/tunisia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11177; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/tunisia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_tunisia_audio", "countries.tunisia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_tunisia_data", "countries.tunisia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_tunisia_graphics", "countries.tunisia.graphics.spectrum", sb.toString());
        }
    }
}
