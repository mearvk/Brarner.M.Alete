...
/**
 * Signal Processing instance for Venezuela (VE)
 * Continent: South America | Capital: Caracas
 * Population: 29000000 | Area: 912050 sq km
 * Port: 11190
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/venezuela/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11190; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/venezuela";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_venezuela_audio", "countries.venezuela.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_venezuela_data", "countries.venezuela.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_venezuela_graphics", "countries.venezuela.graphics.spectrum", sb.toString());
        }
    }
}
