...
/**
 * Signal Processing instance for Belarus (BY)
 * Continent: Europe | Capital: Minsk
 * Population: 9200000 | Area: 207600 sq km
 * Port: 11015
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/belarus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11015; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/belarus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_belarus_audio", "countries.belarus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_belarus_data", "countries.belarus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_belarus_graphics", "countries.belarus.graphics.spectrum", sb.toString());
        }
    }
}
