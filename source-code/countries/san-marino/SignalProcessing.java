...
/**
 * Signal Processing instance for San Marino (SM)
 * Continent: Europe | Capital: San Marino
 * Population: 34000 | Area: 61 sq km
 * Port: 11148
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/san-marino/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11148; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/san-marino";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_san_marino_audio", "countries.san_marino.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_san_marino_data", "countries.san_marino.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_san_marino_graphics", "countries.san_marino.graphics.spectrum", sb.toString());
        }
    }
}
