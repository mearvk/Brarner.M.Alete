...
/**
 * Signal Processing instance for Lithuania (LT)
 * Continent: Europe | Capital: Vilnius
 * Population: 2900000 | Area: 65300 sq km
 * Port: 11098
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/lithuania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11098; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/lithuania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_lithuania_audio", "countries.lithuania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_lithuania_data", "countries.lithuania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_lithuania_graphics", "countries.lithuania.graphics.spectrum", sb.toString());
        }
    }
}
