...
/**
 * Signal Processing instance for Rwanda (RW)
 * Continent: Africa | Capital: Kigali
 * Population: 14300000 | Area: 26338 sq km
 * Port: 11143
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/rwanda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11143; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/rwanda";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_rwanda_audio", "countries.rwanda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_rwanda_data", "countries.rwanda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_rwanda_graphics", "countries.rwanda.graphics.spectrum", sb.toString());
        }
    }
}
