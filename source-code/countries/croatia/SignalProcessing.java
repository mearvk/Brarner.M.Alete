...
/**
 * Signal Processing instance for Croatia (HR)
 * Continent: Europe | Capital: Zagreb
 * Population: 3800000 | Area: 56594 sq km
 * Port: 11041
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/croatia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11041; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/croatia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_croatia_audio", "countries.croatia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_croatia_data", "countries.croatia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_croatia_graphics", "countries.croatia.graphics.spectrum", sb.toString());
        }
    }
}
