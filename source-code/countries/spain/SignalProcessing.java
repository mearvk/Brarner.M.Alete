...
/**
 * Signal Processing instance for Spain (ES)
 * Continent: Europe | Capital: Madrid
 * Population: 48500000 | Area: 505992 sq km
 * Port: 11163
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/spain/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11163; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/spain";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_spain_audio", "countries.spain.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_spain_data", "countries.spain.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_spain_graphics", "countries.spain.graphics.spectrum", sb.toString());
        }
    }
}
