...
/**
 * Signal Processing instance for Mexico (MX)
 * Continent: North America | Capital: Mexico City
 * Population: 129000000 | Area: 1964375 sq km
 * Port: 11109
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mexico/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11109; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mexico";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mexico_audio", "countries.mexico.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mexico_data", "countries.mexico.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mexico_graphics", "countries.mexico.graphics.spectrum", sb.toString());
        }
    }
}
