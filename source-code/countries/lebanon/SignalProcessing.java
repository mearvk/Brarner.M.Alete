...
/**
 * Signal Processing instance for Lebanon (LB)
 * Continent: Asia | Capital: Beirut
 * Population: 5300000 | Area: 10400 sq km
 * Port: 11093
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/lebanon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11093; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/lebanon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_lebanon_audio", "countries.lebanon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_lebanon_data", "countries.lebanon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_lebanon_graphics", "countries.lebanon.graphics.spectrum", sb.toString());
        }
    }
}
