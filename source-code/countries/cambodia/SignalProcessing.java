...
/**
 * Signal Processing instance for Cambodia (KH)
 * Continent: Asia | Capital: Phnom Penh
 * Population: 17000000 | Area: 181035 sq km
 * Port: 11029
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/cambodia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11029; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/cambodia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_cambodia_audio", "countries.cambodia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_cambodia_data", "countries.cambodia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_cambodia_graphics", "countries.cambodia.graphics.spectrum", sb.toString());
        }
    }
}
