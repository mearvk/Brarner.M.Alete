...
/**
 * Signal Processing instance for Thailand (TH)
 * Continent: Asia | Capital: Bangkok
 * Population: 71800000 | Area: 513120 sq km
 * Port: 11172
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/thailand/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11172; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/thailand";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_thailand_audio", "countries.thailand.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_thailand_data", "countries.thailand.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_thailand_graphics", "countries.thailand.graphics.spectrum", sb.toString());
        }
    }
}
