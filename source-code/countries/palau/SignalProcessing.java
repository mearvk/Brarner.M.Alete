...
/**
 * Signal Processing instance for Palau (PW)
 * Continent: Oceania | Capital: Ngerulmud
 * Population: 18000 | Area: 459 sq km
 * Port: 11131
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/palau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11131; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/palau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_palau_audio", "countries.palau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_palau_data", "countries.palau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_palau_graphics", "countries.palau.graphics.spectrum", sb.toString());
        }
    }
}
