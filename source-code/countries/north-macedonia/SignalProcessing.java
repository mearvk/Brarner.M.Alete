package countries.north_macedonia;
...
/**
 * Signal Processing instance for North Macedonia (MK)
 * Continent: Europe | Capital: Skopje
 * Population: 2100000 | Area: 25713 sq km
 * Port: 11127
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/north-macedonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11127; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/north-macedonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_north_macedonia_audio", "countries.north_macedonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_north_macedonia_data", "countries.north_macedonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_north_macedonia_graphics", "countries.north_macedonia.graphics.spectrum", sb.toString());
        }
    }
}
