...
/**
 * Signal Processing instance for Honduras (HN)
 * Continent: North America | Capital: Tegucigalpa
 * Population: 10600000 | Area: 112492 sq km
 * Port: 11072
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/honduras/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11072; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/honduras";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_honduras_audio", "countries.honduras.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_honduras_data", "countries.honduras.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_honduras_graphics", "countries.honduras.graphics.spectrum", sb.toString());
        }
    }
}
