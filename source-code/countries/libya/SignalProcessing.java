...
/**
 * Signal Processing instance for Libya (LY)
 * Continent: Africa | Capital: Tripoli
 * Population: 7000000 | Area: 1759540 sq km
 * Port: 11096
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/libya/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11096; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/libya";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_libya_audio", "countries.libya.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_libya_data", "countries.libya.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_libya_graphics", "countries.libya.graphics.spectrum", sb.toString());
        }
    }
}
