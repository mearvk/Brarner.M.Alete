...
/**
 * Signal Processing instance for Cuba (CU)
 * Continent: North America | Capital: Havana
 * Population: 11000000 | Area: 109886 sq km
 * Port: 11042
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/cuba/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11042; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/cuba";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_cuba_audio", "countries.cuba.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_cuba_data", "countries.cuba.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_cuba_graphics", "countries.cuba.graphics.spectrum", sb.toString());
        }
    }
}
