package countries.bosnia_and_herzegovina;
...
/**
 * Signal Processing instance for Bosnia and Herzegovina (BA)
 * Continent: Europe | Capital: Sarajevo
 * Population: 3200000 | Area: 51197 sq km
 * Port: 11021
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bosnia-and-herzegovina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11021; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bosnia-and-herzegovina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bosnia_and_herzegovina_audio", "countries.bosnia_and_herzegovina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bosnia_and_herzegovina_data", "countries.bosnia_and_herzegovina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bosnia_and_herzegovina_graphics", "countries.bosnia_and_herzegovina.graphics.spectrum", sb.toString());
        }
    }
}
