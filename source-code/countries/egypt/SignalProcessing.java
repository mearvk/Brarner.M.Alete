...
/**
 * Signal Processing instance for Egypt (EG)
 * Continent: Africa | Capital: Cairo
 * Population: 114000000 | Area: 1001450 sq km
 * Port: 11050
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/egypt/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11050; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/egypt";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_egypt_audio", "countries.egypt.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_egypt_data", "countries.egypt.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_egypt_graphics", "countries.egypt.graphics.spectrum", sb.toString());
        }
    }
}
