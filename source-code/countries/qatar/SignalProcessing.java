...
/**
 * Signal Processing instance for Qatar (QA)
 * Continent: Asia | Capital: Doha
 * Population: 2700000 | Area: 11586 sq km
 * Port: 11140
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/qatar/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11140; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/qatar";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_qatar_audio", "countries.qatar.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_qatar_data", "countries.qatar.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_qatar_graphics", "countries.qatar.graphics.spectrum", sb.toString());
        }
    }
}
