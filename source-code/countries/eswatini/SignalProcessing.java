...
/**
 * Signal Processing instance for Eswatini (SZ)
 * Continent: Africa | Capital: Mbabane
 * Population: 1200000 | Area: 17364 sq km
 * Port: 11055
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/eswatini/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11055; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/eswatini";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_eswatini_audio", "countries.eswatini.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_eswatini_data", "countries.eswatini.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_eswatini_graphics", "countries.eswatini.graphics.spectrum", sb.toString());
        }
    }
}
