...
/**
 * Signal Processing instance for Kuwait (KW)
 * Continent: Asia | Capital: Kuwait City
 * Population: 4300000 | Area: 17818 sq km
 * Port: 11089
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/kuwait/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11089; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/kuwait";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_kuwait_audio", "countries.kuwait.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_kuwait_data", "countries.kuwait.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_kuwait_graphics", "countries.kuwait.graphics.spectrum", sb.toString());
        }
    }
}
