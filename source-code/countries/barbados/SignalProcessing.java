...
/**
 * Signal Processing instance for Barbados (BB)
 * Continent: North America | Capital: Bridgetown
 * Population: 282000 | Area: 430 sq km
 * Port: 11014
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/barbados/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11014; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/barbados";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_barbados_audio", "countries.barbados.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_barbados_data", "countries.barbados.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_barbados_graphics", "countries.barbados.graphics.spectrum", sb.toString());
        }
    }
}
