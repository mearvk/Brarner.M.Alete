...
/**
 * Signal Processing instance for Slovenia (SI)
 * Continent: Europe | Capital: Ljubljana
 * Population: 2100000 | Area: 20273 sq km
 * Port: 11157
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/slovenia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11157; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/slovenia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_slovenia_audio", "countries.slovenia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_slovenia_data", "countries.slovenia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_slovenia_graphics", "countries.slovenia.graphics.spectrum", sb.toString());
        }
    }
}
