...
/**
 * Signal Processing instance for Kazakhstan (KZ)
 * Continent: Asia | Capital: Astana
 * Population: 20000000 | Area: 2724900 sq km
 * Port: 11086
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/kazakhstan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11086; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/kazakhstan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_kazakhstan_audio", "countries.kazakhstan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_kazakhstan_data", "countries.kazakhstan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_kazakhstan_graphics", "countries.kazakhstan.graphics.spectrum", sb.toString());
        }
    }
}
