...
/**
 * Signal Processing instance for Botswana (BW)
 * Continent: Africa | Capital: Gaborone
 * Population: 2700000 | Area: 581730 sq km
 * Port: 11022
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/botswana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11022; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/botswana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_botswana_audio", "countries.botswana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_botswana_data", "countries.botswana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_botswana_graphics", "countries.botswana.graphics.spectrum", sb.toString());
        }
    }
}
