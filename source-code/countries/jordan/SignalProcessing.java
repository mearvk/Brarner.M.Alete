...
/**
 * Signal Processing instance for Jordan (JO)
 * Continent: Asia | Capital: Amman
 * Population: 11300000 | Area: 89342 sq km
 * Port: 11085
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/jordan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11085; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/jordan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_jordan_audio", "countries.jordan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_jordan_data", "countries.jordan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_jordan_graphics", "countries.jordan.graphics.spectrum", sb.toString());
        }
    }
}
