package countries.equatorial_guinea;
...
/**
 * Signal Processing instance for Equatorial Guinea (GQ)
 * Continent: Africa | Capital: Malabo
 * Population: 1700000 | Area: 28051 sq km
 * Port: 11052
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/equatorial-guinea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11052; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/equatorial-guinea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_equatorial_guinea_audio", "countries.equatorial_guinea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_equatorial_guinea_data", "countries.equatorial_guinea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_equatorial_guinea_graphics", "countries.equatorial_guinea.graphics.spectrum", sb.toString());
        }
    }
}
