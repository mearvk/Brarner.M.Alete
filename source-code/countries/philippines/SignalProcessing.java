...
/**
 * Signal Processing instance for Philippines (PH)
 * Continent: Asia | Capital: Manila
 * Population: 119000000 | Area: 300000 sq km
 * Port: 11137
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/philippines/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11137; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/philippines";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_philippines_audio", "countries.philippines.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_philippines_data", "countries.philippines.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_philippines_graphics", "countries.philippines.graphics.spectrum", sb.toString());
        }
    }
}
