...
/**
 * Signal Processing instance for Gabon (GA)
 * Continent: Africa | Capital: Libreville
 * Population: 2500000 | Area: 267668 sq km
 * Port: 11060
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/gabon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11060; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/gabon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_gabon_audio", "countries.gabon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_gabon_data", "countries.gabon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_gabon_graphics", "countries.gabon.graphics.spectrum", sb.toString());
        }
    }
}
