package countries.vatican_city_holy_see;
...
/**
 * Signal Processing instance for Vatican City (Holy See) (VA)
 * Continent: Europe | Capital: Vatican City
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/vatican-city-holy-see/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11189; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/vatican-city-holy-see";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_vatican_city_holy_see_audio", "countries.vatican_city_holy_see.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_vatican_city_holy_see_data", "countries.vatican_city_holy_see.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_vatican_city_holy_see_graphics", "countries.vatican_city_holy_see.graphics.spectrum", sb.toString());
        }
    }
}
