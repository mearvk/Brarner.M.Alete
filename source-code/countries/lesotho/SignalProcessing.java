...
/**
 * Signal Processing instance for Lesotho (LS)
 * Continent: Africa | Capital: Maseru
 * Population: 2300000 | Area: 30355 sq km
 * Port: 11094
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/lesotho/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11094; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/lesotho";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_lesotho_audio", "countries.lesotho.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_lesotho_data", "countries.lesotho.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_lesotho_graphics", "countries.lesotho.graphics.spectrum", sb.toString());
        }
    }
}
