...
/**
 * Signal Processing instance for Palestine (PS)
 * Continent: Asia | Capital: Jerusalem
 * Population: 5500000 | Area: 6220 sq km
 * Port: 11132
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/palestine/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11132; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/palestine";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_palestine_audio", "countries.palestine.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_palestine_data", "countries.palestine.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_palestine_graphics", "countries.palestine.graphics.spectrum", sb.toString());
        }
    }
}
