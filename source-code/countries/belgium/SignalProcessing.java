...
/**
 * Signal Processing instance for Belgium (BE)
 * Continent: Europe | Capital: Brussels
 * Population: 11800000 | Area: 30528 sq km
 * Port: 11016
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/belgium/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11016; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/belgium";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_belgium_audio", "countries.belgium.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_belgium_data", "countries.belgium.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_belgium_graphics", "countries.belgium.graphics.spectrum", sb.toString());
        }
    }
}
