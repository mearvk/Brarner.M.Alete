...
/**
 * Signal Processing instance for Jamaica (JM)
 * Continent: North America | Capital: Kingston
 * Population: 2800000 | Area: 10991 sq km
 * Port: 11083
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/jamaica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11083; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/jamaica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_jamaica_audio", "countries.jamaica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_jamaica_data", "countries.jamaica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_jamaica_graphics", "countries.jamaica.graphics.spectrum", sb.toString());
        }
    }
}
