package countries.antigua_and_barbuda;
...
/**
 * Signal Processing instance for Antigua and Barbuda (AG)
 * Continent: North America | Capital: St. John's
 * Population: 94000 | Area: 442 sq km
 * Port: 11005
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/antigua-and-barbuda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11005; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/antigua-and-barbuda";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_antigua_and_barbuda_audio", "countries.antigua_and_barbuda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_antigua_and_barbuda_data", "countries.antigua_and_barbuda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_antigua_and_barbuda_graphics", "countries.antigua_and_barbuda.graphics.spectrum", sb.toString());
        }
    }
}
