...
/**
 * Signal Processing instance for Malaysia (MY)
 * Continent: Asia | Capital: Kuala Lumpur
 * Population: 34500000 | Area: 329847 sq km
 * Port: 11102
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/malaysia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11102; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/malaysia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_malaysia_audio", "countries.malaysia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_malaysia_data", "countries.malaysia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_malaysia_graphics", "countries.malaysia.graphics.spectrum", sb.toString());
        }
    }
}
