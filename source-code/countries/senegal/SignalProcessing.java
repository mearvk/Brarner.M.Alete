...
/**
 * Signal Processing instance for Senegal (SN)
 * Continent: Africa | Capital: Dakar
 * Population: 17900000 | Area: 196722 sq km
 * Port: 11151
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/senegal/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11151; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/senegal";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_senegal_audio", "countries.senegal.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_senegal_data", "countries.senegal.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_senegal_graphics", "countries.senegal.graphics.spectrum", sb.toString());
        }
    }
}
