package countries.burkina_faso;
...
/**
 * Signal Processing instance for Burkina Faso (BF)
 * Continent: Africa | Capital: Ouagadougou
 * Population: 23800000 | Area: 274200 sq km
 * Port: 11026
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/burkina-faso/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11026; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/burkina-faso";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_burkina_faso_audio", "countries.burkina_faso.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_burkina_faso_data", "countries.burkina_faso.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_burkina_faso_graphics", "countries.burkina_faso.graphics.spectrum", sb.toString());
        }
    }
}
