...
/**
 * Signal Processing instance for Iraq (IQ)
 * Continent: Asia | Capital: Baghdad
 * Population: 46000000 | Area: 438317 sq km
 * Port: 11078
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/iraq/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11078; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/iraq";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_iraq_audio", "countries.iraq.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_iraq_data", "countries.iraq.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_iraq_graphics", "countries.iraq.graphics.spectrum", sb.toString());
        }
    }
}
