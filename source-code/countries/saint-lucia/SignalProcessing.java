...
/**
 * Signal Processing instance for Saint Lucia (LC)
 * Continent: North America | Capital: Castries
 * Population: 180000 | Area: 616 sq km
 * Port: 11145
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/saint-lucia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11145; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/saint-lucia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_saint_lucia_audio", "countries.saint_lucia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_saint_lucia_data", "countries.saint_lucia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_saint_lucia_graphics", "countries.saint_lucia.graphics.spectrum", sb.toString());
        }
    }
}
