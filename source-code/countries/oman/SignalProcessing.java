...
/**
 * Signal Processing instance for Oman (OM)
 * Continent: Asia | Capital: Muscat
 * Population: 4700000 | Area: 309500 sq km
 * Port: 11129
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/oman/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11129; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/oman";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_oman_audio", "countries.oman.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_oman_data", "countries.oman.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_oman_graphics", "countries.oman.graphics.spectrum", sb.toString());
        }
    }
}
