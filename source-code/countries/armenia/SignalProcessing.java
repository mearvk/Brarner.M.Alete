...
/**
 * Signal Processing instance for Armenia (AM)
 * Continent: Asia | Capital: Yerevan
 * Population: 2800000 | Area: 29743 sq km
 * Port: 11007
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/armenia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11007; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/armenia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_armenia_audio", "countries.armenia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_armenia_data", "countries.armenia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_armenia_graphics", "countries.armenia.graphics.spectrum", sb.toString());
        }
    }
}
