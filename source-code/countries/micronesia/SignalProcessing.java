...
/**
 * Signal Processing instance for Micronesia (FM)
 * Continent: Oceania | Capital: Palikir
 * Population: 115000 | Area: 702 sq km
 * Port: 11110
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/micronesia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11110; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/micronesia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_micronesia_audio", "countries.micronesia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_micronesia_data", "countries.micronesia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_micronesia_graphics", "countries.micronesia.graphics.spectrum", sb.toString());
        }
    }
}
