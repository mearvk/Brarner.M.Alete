...
/**
 * Signal Processing instance for South Sudan (SS)
 * Continent: Africa | Capital: Juba
 * Population: 11100000 | Area: 644329 sq km
 * Port: 11162
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/south-sudan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11162; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/south-sudan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_south_sudan_audio", "countries.south_sudan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_south_sudan_data", "countries.south_sudan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_south_sudan_graphics", "countries.south_sudan.graphics.spectrum", sb.toString());
        }
    }
}
