...
/**
 * Signal Processing instance for Togo (TG)
 * Continent: Africa | Capital: Lome
 * Population: 9300000 | Area: 56785 sq km
 * Port: 11174
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/togo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11174; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/togo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_togo_audio", "countries.togo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_togo_data", "countries.togo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_togo_graphics", "countries.togo.graphics.spectrum", sb.toString());
        }
    }
}
