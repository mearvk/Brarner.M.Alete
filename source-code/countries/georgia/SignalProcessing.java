...
/**
 * Signal Processing instance for Georgia (GE)
 * Continent: Asia | Capital: Tbilisi
 * Population: 3700000 | Area: 69700 sq km
 * Port: 11062
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/georgia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11062; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/georgia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_georgia_audio", "countries.georgia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_georgia_data", "countries.georgia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_georgia_graphics", "countries.georgia.graphics.spectrum", sb.toString());
        }
    }
}
