...
/**
 * Signal Processing instance for Australia (AU)
 * Continent: Oceania | Capital: Canberra
 * Population: 26800000 | Area: 7692024 sq km
 * Port: 11008
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/australia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11008; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/australia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_australia_audio", "countries.australia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_australia_data", "countries.australia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_australia_graphics", "countries.australia.graphics.spectrum", sb.toString());
        }
    }
}
