...
/**
 * Signal Processing instance for Tuvalu (TV)
 * Continent: Oceania | Capital: Funafuti
 * Population: 11000 | Area: 26 sq km
 * Port: 11180
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/tuvalu/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11180; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/tuvalu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_tuvalu_audio", "countries.tuvalu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_tuvalu_data", "countries.tuvalu.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_tuvalu_graphics", "countries.tuvalu.graphics.spectrum", sb.toString());
        }
    }
}
