...
/**
 * Signal Processing instance for Zambia (ZM)
 * Continent: Africa | Capital: Lusaka
 * Population: 21200000 | Area: 752618 sq km
 * Port: 11193
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/zambia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11193; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/zambia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_zambia_audio", "countries.zambia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_zambia_data", "countries.zambia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_zambia_graphics", "countries.zambia.graphics.spectrum", sb.toString());
        }
    }
}
