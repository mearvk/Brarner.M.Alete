...
/**
 * Signal Processing instance for Mali (ML)
 * Continent: Africa | Capital: Bamako
 * Population: 23800000 | Area: 1240192 sq km
 * Port: 11104
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mali/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11104; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mali";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mali_audio", "countries.mali.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mali_data", "countries.mali.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mali_graphics", "countries.mali.graphics.spectrum", sb.toString());
        }
    }
}
