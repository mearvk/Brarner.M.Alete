...
/**
 * Signal Processing instance for Somalia (SO)
 * Continent: Africa | Capital: Mogadishu
 * Population: 18700000 | Area: 637657 sq km
 * Port: 11159
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/somalia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11159; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/somalia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_somalia_audio", "countries.somalia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_somalia_data", "countries.somalia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_somalia_graphics", "countries.somalia.graphics.spectrum", sb.toString());
        }
    }
}
