...
/**
 * Signal Processing instance for Norway (NO)
 * Continent: Europe | Capital: Oslo
 * Population: 5500000 | Area: 323802 sq km
 * Port: 11128
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/norway/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11128; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/norway";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_norway_audio", "countries.norway.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_norway_data", "countries.norway.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_norway_graphics", "countries.norway.graphics.spectrum", sb.toString());
        }
    }
}
