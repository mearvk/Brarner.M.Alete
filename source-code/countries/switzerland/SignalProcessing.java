...
/**
 * Signal Processing instance for Switzerland (CH)
 * Continent: Europe | Capital: Bern
 * Population: 8900000 | Area: 41284 sq km
 * Port: 11168
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/switzerland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11168; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/switzerland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_switzerland_audio", "countries.switzerland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_switzerland_data", "countries.switzerland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_switzerland_graphics", "countries.switzerland.graphics.spectrum", sb.toString());
        }
    }
}
