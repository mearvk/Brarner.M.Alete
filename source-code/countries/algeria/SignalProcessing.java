...
/**
 * Signal Processing instance for Algeria (DZ)
 * Continent: Africa | Capital: Algiers
 * Population: 46500000 | Area: 2381741 sq km
 * Port: 11002
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/algeria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11002; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/algeria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_algeria_audio", "countries.algeria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_algeria_data", "countries.algeria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_algeria_graphics", "countries.algeria.graphics.spectrum", sb.toString());
        }
    }
}
