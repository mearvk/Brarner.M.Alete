...
/**
 * Signal Processing instance for Canada (CA)
 * Continent: North America | Capital: Ottawa
 * Population: 41000000 | Area: 9984670 sq km
 * Port: 11031
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/canada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11031; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/canada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_canada_audio", "countries.canada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_canada_data", "countries.canada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_canada_graphics", "countries.canada.graphics.spectrum", sb.toString());
        }
    }
}
