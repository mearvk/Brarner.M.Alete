package countries.dominican_republic;
...
/**
 * Signal Processing instance for Dominican Republic (DO)
 * Continent: North America | Capital: Santo Domingo
 * Population: 11400000 | Area: 48671 sq km
 * Port: 11048
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/dominican-republic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11048; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/dominican-republic";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_dominican_republic_audio", "countries.dominican_republic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_dominican_republic_data", "countries.dominican_republic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_dominican_republic_graphics", "countries.dominican_republic.graphics.spectrum", sb.toString());
        }
    }
}
