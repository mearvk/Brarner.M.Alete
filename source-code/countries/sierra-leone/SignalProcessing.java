package countries.sierra_leone;
...
/**
 * Signal Processing instance for Sierra Leone (SL)
 * Continent: Africa | Capital: Freetown
 * Population: 8900000 | Area: 71740 sq km
 * Port: 11154
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/sierra-leone/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11154; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/sierra-leone";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_sierra_leone_audio", "countries.sierra_leone.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_sierra_leone_data", "countries.sierra_leone.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_sierra_leone_graphics", "countries.sierra_leone.graphics.spectrum", sb.toString());
        }
    }
}
