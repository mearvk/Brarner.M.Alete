...
/**
 * Signal Processing instance for Nigeria (NG)
 * Continent: Africa | Capital: Abuja
 * Population: 229000000 | Area: 923768 sq km
 * Port: 11125
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/nigeria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11125; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/nigeria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_nigeria_audio", "countries.nigeria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_nigeria_data", "countries.nigeria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_nigeria_graphics", "countries.nigeria.graphics.spectrum", sb.toString());
        }
    }
}
