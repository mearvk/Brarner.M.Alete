package countries.saint_vincent_and_the_grenadines;
...
/**
 * Signal Processing instance for Saint Vincent and the Grenadines (VC)
 * Continent: North America | Capital: Kingstown
 * Population: 104000 | Area: 389 sq km
 * Port: 11146
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/saint-vincent-and-the-grenadines/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11146; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/saint-vincent-and-the-grenadines";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_saint_vincent_and_the_grenadines_audio", "countries.saint_vincent_and_the_grenadines.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_saint_vincent_and_the_grenadines_data", "countries.saint_vincent_and_the_grenadines.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_saint_vincent_and_the_grenadines_graphics", "countries.saint_vincent_and_the_grenadines.graphics.spectrum", sb.toString());
        }
    }
}
