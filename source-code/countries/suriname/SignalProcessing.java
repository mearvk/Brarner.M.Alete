...
/**
 * Signal Processing instance for Suriname (SR)
 * Continent: South America | Capital: Paramaribo
 * Population: 630000 | Area: 163820 sq km
 * Port: 11166
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/suriname/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11166; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/suriname";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_suriname_audio", "countries.suriname.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_suriname_data", "countries.suriname.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_suriname_graphics", "countries.suriname.graphics.spectrum", sb.toString());
        }
    }
}
