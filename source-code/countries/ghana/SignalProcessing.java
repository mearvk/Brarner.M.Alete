...
/**
 * Signal Processing instance for Ghana (GH)
 * Continent: Africa | Capital: Accra
 * Population: 34500000 | Area: 238533 sq km
 * Port: 11064
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/ghana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11064; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/ghana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_ghana_audio", "countries.ghana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_ghana_data", "countries.ghana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_ghana_graphics", "countries.ghana.graphics.spectrum", sb.toString());
        }
    }
}
