...
/**
 * Signal Processing instance for Burundi (BI)
 * Continent: Africa | Capital: Gitega
 * Population: 13600000 | Area: 27834 sq km
 * Port: 11027
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/burundi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11027; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/burundi";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_burundi_audio", "countries.burundi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_burundi_data", "countries.burundi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_burundi_graphics", "countries.burundi.graphics.spectrum", sb.toString());
        }
    }
}
