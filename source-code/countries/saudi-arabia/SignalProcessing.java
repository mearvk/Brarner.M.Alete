package countries.saudi_arabia;
...
/**
 * Signal Processing instance for Saudi Arabia (SA)
 * Continent: Asia | Capital: Riyadh
 * Population: 37000000 | Area: 2149690 sq km
 * Port: 11150
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/saudi-arabia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11150; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/saudi-arabia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_saudi_arabia_audio", "countries.saudi_arabia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_saudi_arabia_data", "countries.saudi_arabia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_saudi_arabia_graphics", "countries.saudi_arabia.graphics.spectrum", sb.toString());
        }
    }
}
