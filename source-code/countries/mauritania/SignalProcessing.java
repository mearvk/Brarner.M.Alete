...
/**
 * Signal Processing instance for Mauritania (MR)
 * Continent: Africa | Capital: Nouakchott
 * Population: 4900000 | Area: 1030700 sq km
 * Port: 11107
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mauritania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11107; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mauritania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mauritania_audio", "countries.mauritania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mauritania_data", "countries.mauritania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mauritania_graphics", "countries.mauritania.graphics.spectrum", sb.toString());
        }
    }
}
