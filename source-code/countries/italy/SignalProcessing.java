...
/**
 * Signal Processing instance for Italy (IT)
 * Continent: Europe | Capital: Rome
 * Population: 58700000 | Area: 301340 sq km
 * Port: 11081
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/italy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11081; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/italy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_italy_audio", "countries.italy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_italy_data", "countries.italy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_italy_graphics", "countries.italy.graphics.spectrum", sb.toString());
        }
    }
}
