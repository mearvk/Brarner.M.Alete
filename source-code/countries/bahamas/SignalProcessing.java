...
/**
 * Signal Processing instance for Bahamas (BS)
 * Continent: North America | Capital: Nassau
 * Population: 4100000 | Area: 13943 sq km
 * Port: 11011
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bahamas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11011; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bahamas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bahamas_audio", "countries.bahamas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bahamas_data", "countries.bahamas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bahamas_graphics", "countries.bahamas.graphics.spectrum", sb.toString());
        }
    }
}
