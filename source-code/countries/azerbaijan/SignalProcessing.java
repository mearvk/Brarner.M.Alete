...
/**
 * Signal Processing instance for Azerbaijan (AZ)
 * Continent: Asia | Capital: Baku
 * Population: 10200000 | Area: 86600 sq km
 * Port: 11010
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/azerbaijan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11010; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/azerbaijan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_azerbaijan_audio", "countries.azerbaijan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_azerbaijan_data", "countries.azerbaijan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_azerbaijan_graphics", "countries.azerbaijan.graphics.spectrum", sb.toString());
        }
    }
}
