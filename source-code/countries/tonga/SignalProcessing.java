...
/**
 * Signal Processing instance for Tonga (TO)
 * Continent: Oceania | Capital: Nuku'alofa
 * Population: 108000 | Area: 747 sq km
 * Port: 11175
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/tonga/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11175; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/tonga";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_tonga_audio", "countries.tonga.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_tonga_data", "countries.tonga.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_tonga_graphics", "countries.tonga.graphics.spectrum", sb.toString());
        }
    }
}
