...
/**
 * Signal Processing instance for Colombia (CO)
 * Continent: South America | Capital: Bogota
 * Population: 52500000 | Area: 1141748 sq km
 * Port: 11036
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/colombia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11036; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/colombia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_colombia_audio", "countries.colombia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_colombia_data", "countries.colombia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_colombia_graphics", "countries.colombia.graphics.spectrum", sb.toString());
        }
    }
}
