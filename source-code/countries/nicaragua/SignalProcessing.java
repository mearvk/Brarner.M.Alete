...
/**
 * Signal Processing instance for Nicaragua (NI)
 * Continent: North America | Capital: Managua
 * Population: 7100000 | Area: 130370 sq km
 * Port: 11123
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/nicaragua/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11123; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/nicaragua";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_nicaragua_audio", "countries.nicaragua.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_nicaragua_data", "countries.nicaragua.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_nicaragua_graphics", "countries.nicaragua.graphics.spectrum", sb.toString());
        }
    }
}
