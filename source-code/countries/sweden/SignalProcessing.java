...
/**
 * Signal Processing instance for Sweden (SE)
 * Continent: Europe | Capital: Stockholm
 * Population: 10600000 | Area: 450295 sq km
 * Port: 11167
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/sweden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11167; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/sweden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_sweden_audio", "countries.sweden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_sweden_data", "countries.sweden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_sweden_graphics", "countries.sweden.graphics.spectrum", sb.toString());
        }
    }
}
