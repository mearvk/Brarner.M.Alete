...
/**
 * Signal Processing instance for India (IN)
 * Continent: Asia | Capital: New Delhi
 * Population: 1440000000 | Area: 3287263 sq km
 * Port: 11075
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/india/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11075; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/india";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_india_audio", "countries.india.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_india_data", "countries.india.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_india_graphics", "countries.india.graphics.spectrum", sb.toString());
        }
    }
}
