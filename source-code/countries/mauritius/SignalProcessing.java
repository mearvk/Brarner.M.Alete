...
/**
 * Signal Processing instance for Mauritius (MU)
 * Continent: Africa | Capital: Port Louis
 * Population: 1300000 | Area: 2040 sq km
 * Port: 11108
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mauritius/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11108; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mauritius";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mauritius_audio", "countries.mauritius.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mauritius_data", "countries.mauritius.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mauritius_graphics", "countries.mauritius.graphics.spectrum", sb.toString());
        }
    }
}
