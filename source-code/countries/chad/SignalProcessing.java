...
/**
 * Signal Processing instance for Chad (TD)
 * Continent: Africa | Capital: N'Djamena
 * Population: 18800000 | Area: 1284000 sq km
 * Port: 11033
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/chad/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11033; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/chad";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_chad_audio", "countries.chad.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_chad_data", "countries.chad.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_chad_graphics", "countries.chad.graphics.spectrum", sb.toString());
        }
    }
}
