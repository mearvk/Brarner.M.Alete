...
/**
 * Signal Processing instance for Yemen (YE)
 * Continent: Asia | Capital: Sanaa
 * Population: 35000000 | Area: 527968 sq km
 * Port: 11192
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/yemen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11192; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/yemen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_yemen_audio", "countries.yemen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_yemen_data", "countries.yemen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_yemen_graphics", "countries.yemen.graphics.spectrum", sb.toString());
        }
    }
}
