package countries.congo_democratic_republic;
...
/**
 * Signal Processing instance for Congo (Democratic Republic) (CD)
 * Continent: Africa | Capital: Kinshasa
 * Population: 105000000 | Area: 2344858 sq km
 * Port: 11039
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/congo-democratic-republic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11039; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/congo-democratic-republic";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_congo_democratic_republic_audio", "countries.congo_democratic_republic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_congo_democratic_republic_data", "countries.congo_democratic_republic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_congo_democratic_republic_graphics", "countries.congo_democratic_republic.graphics.spectrum", sb.toString());
        }
    }
}
