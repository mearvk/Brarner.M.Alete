package countries.liechtenstein;
...
/**
 * Signal Processing instance for Liechtenstein (LI)
 * Continent: Europe | Capital: Vaduz
 * Population: 40000 | Area: 160 sq km
 * Port: 11097
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/liechtenstein/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11097; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/liechtenstein";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_liechtenstein_audio", "countries.liechtenstein.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_liechtenstein_data", "countries.liechtenstein.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_liechtenstein_graphics", "countries.liechtenstein.graphics.spectrum", sb.toString());
        }
    }
}
