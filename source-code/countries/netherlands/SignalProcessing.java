...
/**
 * Signal Processing instance for Netherlands (NL)
 * Continent: Europe | Capital: Amsterdam
 * Population: 17900000 | Area: 41543 sq km
 * Port: 11121
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/netherlands/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11121; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/netherlands";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_netherlands_audio", "countries.netherlands.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_netherlands_data", "countries.netherlands.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_netherlands_graphics", "countries.netherlands.graphics.spectrum", sb.toString());
        }
    }
}
