...
/**
 * Signal Processing instance for Kiribati (KI)
 * Continent: Oceania | Capital: Tarawa
 * Population: 135000 | Area: 811 sq km
 * Port: 11088
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/kiribati/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11088; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/kiribati";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_kiribati_audio", "countries.kiribati.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_kiribati_data", "countries.kiribati.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_kiribati_graphics", "countries.kiribati.graphics.spectrum", sb.toString());
        }
    }
}
