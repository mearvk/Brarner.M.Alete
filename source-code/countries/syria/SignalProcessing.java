...
/**
 * Signal Processing instance for Syria (SY)
 * Continent: Asia | Capital: Damascus
 * Population: 24000000 | Area: 185180 sq km
 * Port: 11169
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/syria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11169; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/syria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_syria_audio", "countries.syria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_syria_data", "countries.syria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_syria_graphics", "countries.syria.graphics.spectrum", sb.toString());
        }
    }
}
