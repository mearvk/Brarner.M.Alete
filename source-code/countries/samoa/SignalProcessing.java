...
/**
 * Signal Processing instance for Samoa (WS)
 * Continent: Oceania | Capital: Apia
 * Population: 229000 | Area: 2831 sq km
 * Port: 11147
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/samoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11147; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/samoa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_samoa_audio", "countries.samoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_samoa_data", "countries.samoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_samoa_graphics", "countries.samoa.graphics.spectrum", sb.toString());
        }
    }
}
