...
/**
 * Signal Processing instance for Tajikistan (TJ)
 * Continent: Asia | Capital: Dushanbe
 * Population: 10300000 | Area: 143100 sq km
 * Port: 11170
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/tajikistan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11170; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/tajikistan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_tajikistan_audio", "countries.tajikistan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_tajikistan_data", "countries.tajikistan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_tajikistan_graphics", "countries.tajikistan.graphics.spectrum", sb.toString());
        }
    }
}
