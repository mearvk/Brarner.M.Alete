package countries.myanmar_burma;
...
/**
 * Signal Processing instance for Myanmar (Burma) (MM)
 * Continent: Asia | Capital: Naypyidaw
 * Population: 54500000 | Area: 676578 sq km
 * Port: 11117
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/myanmar-burma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11117; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/myanmar-burma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_myanmar_burma_audio", "countries.myanmar_burma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_myanmar_burma_data", "countries.myanmar_burma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_myanmar_burma_graphics", "countries.myanmar_burma.graphics.spectrum", sb.toString());
        }
    }
}
