...
/**
 * Signal Processing instance for Chile (CL)
 * Continent: South America | Capital: Santiago
 * Population: 19600000 | Area: 756102 sq km
 * Port: 11034
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/chile/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11034; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/chile";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_chile_audio", "countries.chile.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_chile_data", "countries.chile.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_chile_graphics", "countries.chile.graphics.spectrum", sb.toString());
        }
    }
}
