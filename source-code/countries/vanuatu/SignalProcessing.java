...
/**
 * Signal Processing instance for Vanuatu (VU)
 * Continent: Oceania | Capital: Port Vila
 * Population: 335000 | Area: 12189 sq km
 * Port: 11188
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/vanuatu/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11188; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/vanuatu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_vanuatu_audio", "countries.vanuatu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_vanuatu_data", "countries.vanuatu.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_vanuatu_graphics", "countries.vanuatu.graphics.spectrum", sb.toString());
        }
    }
}
