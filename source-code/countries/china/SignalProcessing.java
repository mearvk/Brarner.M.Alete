...
/**
 * Signal Processing instance for China (CN)
 * Continent: Asia | Capital: Beijing
 * Population: 140900000 | Area: 9596960 sq km
 * Port: 11035
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/china/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11035; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/china";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_china_audio", "countries.china.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_china_data", "countries.china.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_china_graphics", "countries.china.graphics.spectrum", sb.toString());
        }
    }
}
