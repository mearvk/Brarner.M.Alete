...
/**
 * Signal Processing instance for Greece (GR)
 * Continent: Europe | Capital: Athens
 * Population: 10300000 | Area: 131957 sq km
 * Port: 11065
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/greece/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11065; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/greece";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_greece_audio", "countries.greece.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_greece_data", "countries.greece.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_greece_graphics", "countries.greece.graphics.spectrum", sb.toString());
        }
    }
}
