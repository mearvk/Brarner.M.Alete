...
/**
 * Signal Processing instance for Monaco (MC)
 * Continent: Europe | Capital: Monaco
 * Population: 39000 | Area: 2 sq km
 * Port: 11112
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/monaco/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11112; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/monaco";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_monaco_audio", "countries.monaco.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_monaco_data", "countries.monaco.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_monaco_graphics", "countries.monaco.graphics.spectrum", sb.toString());
        }
    }
}
