...
/**
 * Signal Processing instance for Guinea (GN)
 * Continent: Africa | Capital: Conakry
 * Population: 14400000 | Area: 245857 sq km
 * Port: 11068
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/guinea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11068; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/guinea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_guinea_audio", "countries.guinea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_guinea_data", "countries.guinea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_guinea_graphics", "countries.guinea.graphics.spectrum", sb.toString());
        }
    }
}
