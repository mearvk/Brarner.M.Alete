...
/**
 * Signal Processing instance for Latvia (LV)
 * Continent: Europe | Capital: Riga
 * Population: 1900000 | Area: 64589 sq km
 * Port: 11092
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/latvia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11092; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/latvia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_latvia_audio", "countries.latvia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_latvia_data", "countries.latvia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_latvia_graphics", "countries.latvia.graphics.spectrum", sb.toString());
        }
    }
}
