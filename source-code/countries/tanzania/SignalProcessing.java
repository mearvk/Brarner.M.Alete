...
/**
 * Signal Processing instance for Tanzania (TZ)
 * Continent: Africa | Capital: Dodoma
 * Population: 68500000 | Area: 947303 sq km
 * Port: 11171
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/tanzania/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11171; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/tanzania";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_tanzania_audio", "countries.tanzania.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_tanzania_data", "countries.tanzania.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_tanzania_graphics", "countries.tanzania.graphics.spectrum", sb.toString());
        }
    }
}
