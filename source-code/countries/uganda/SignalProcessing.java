...
/**
 * Signal Processing instance for Uganda (UG)
 * Continent: Africa | Capital: Kampala
 * Population: 49500000 | Area: 241038 sq km
 * Port: 11181
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/uganda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11181; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/uganda";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_uganda_audio", "countries.uganda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_uganda_data", "countries.uganda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_uganda_graphics", "countries.uganda.graphics.spectrum", sb.toString());
        }
    }
}
