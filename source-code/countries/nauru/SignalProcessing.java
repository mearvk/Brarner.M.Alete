...
/**
 * Signal Processing instance for Nauru (NR)
 * Continent: Oceania | Capital: Yaren
 * Population: 13000 | Area: 21 sq km
 * Port: 11119
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/nauru/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11119; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/nauru";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_nauru_audio", "countries.nauru.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_nauru_data", "countries.nauru.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_nauru_graphics", "countries.nauru.graphics.spectrum", sb.toString());
        }
    }
}
