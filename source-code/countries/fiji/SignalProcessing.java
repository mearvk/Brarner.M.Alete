...
/**
 * Signal Processing instance for Fiji (FJ)
 * Continent: Oceania | Capital: Suva
 * Population: 940000 | Area: 18274 sq km
 * Port: 11057
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/fiji/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11057; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/fiji";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_fiji_audio", "countries.fiji.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_fiji_data", "countries.fiji.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_fiji_graphics", "countries.fiji.graphics.spectrum", sb.toString());
        }
    }
}
