package countries.united_states;
...
/**
 * Signal Processing instance for United States (US)
 * Continent: North America | Capital: Washington D.C.
 * Population: 342000000 | Area: 9833517 sq km
 * Port: 11185
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/united-states/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11185; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/united-states";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_united_states_audio", "countries.united_states.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_united_states_data", "countries.united_states.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_united_states_graphics", "countries.united_states.graphics.spectrum", sb.toString());
        }
    }
}
