...
/**
 * Signal Processing instance for Haiti (HT)
 * Continent: North America | Capital: Port-au-Prince
 * Population: 11700000 | Area: 27750 sq km
 * Port: 11071
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/haiti/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11071; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/haiti";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_haiti_audio", "countries.haiti.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_haiti_data", "countries.haiti.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_haiti_graphics", "countries.haiti.graphics.spectrum", sb.toString());
        }
    }
}
