...
/**
 * Signal Processing instance for Mozambique (MZ)
 * Continent: Africa | Capital: Maputo
 * Population: 34800000 | Area: 799380 sq km
 * Port: 11116
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mozambique/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11116; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mozambique";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mozambique_audio", "countries.mozambique.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mozambique_data", "countries.mozambique.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mozambique_graphics", "countries.mozambique.graphics.spectrum", sb.toString());
        }
    }
}
