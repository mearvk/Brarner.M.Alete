...
/**
 * Signal Processing instance for Luxembourg (LU)
 * Continent: Europe | Capital: Luxembourg City
 * Population: 6600000 | Area: 2586 sq km
 * Port: 11099
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/luxembourg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11099; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/luxembourg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_luxembourg_audio", "countries.luxembourg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_luxembourg_data", "countries.luxembourg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_luxembourg_graphics", "countries.luxembourg.graphics.spectrum", sb.toString());
        }
    }
}
