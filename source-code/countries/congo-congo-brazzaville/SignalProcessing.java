package countries.congo_congo_brazzaville;
...
/**
 * Signal Processing instance for Congo (Congo-Brazzaville) (CG)
 * Continent: Africa | Capital: Brazzaville
 * Population: 6200000 | Area: 342000 sq km
 * Port: 11038
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/congo-congo-brazzaville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11038; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/congo-congo-brazzaville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_congo_congo_brazzaville_audio", "countries.congo_congo_brazzaville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_congo_congo_brazzaville_data", "countries.congo_congo_brazzaville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_congo_congo_brazzaville_graphics", "countries.congo_congo_brazzaville.graphics.spectrum", sb.toString());
        }
    }
}
