...
/**
 * Signal Processing instance for Cameroon (CM)
 * Continent: Africa | Capital: Yaounde
 * Population: 29400000 | Area: 475442 sq km
 * Port: 11030
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/cameroon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11030; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/cameroon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_cameroon_audio", "countries.cameroon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_cameroon_data", "countries.cameroon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_cameroon_graphics", "countries.cameroon.graphics.spectrum", sb.toString());
        }
    }
}
