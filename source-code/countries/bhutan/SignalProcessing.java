...
/**
 * Signal Processing instance for Bhutan (BT)
 * Continent: Asia | Capital: Thimphu
 * Population: 790000 | Area: 38394 sq km
 * Port: 11019
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/bhutan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11019; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/bhutan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_bhutan_audio", "countries.bhutan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_bhutan_data", "countries.bhutan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_bhutan_graphics", "countries.bhutan.graphics.spectrum", sb.toString());
        }
    }
}
