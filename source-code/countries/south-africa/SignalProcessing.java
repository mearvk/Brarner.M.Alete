package countries.south_africa;
...
/**
 * Signal Processing instance for South Africa (ZA)
 * Continent: Africa | Capital: Pretoria
 * Population: 61000000 | Area: 1221037 sq km
 * Port: 11160
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/south-africa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11160; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/south-africa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_south_africa_audio", "countries.south_africa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_south_africa_data", "countries.south_africa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_south_africa_graphics", "countries.south_africa.graphics.spectrum", sb.toString());
        }
    }
}
