...
/**
 * Signal Processing instance for Gambia (GM)
 * Continent: Africa | Capital: Banjul
 * Population: 2800000 | Area: 11300 sq km
 * Port: 11061
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/gambia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11061; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/gambia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_gambia_audio", "countries.gambia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_gambia_data", "countries.gambia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_gambia_graphics", "countries.gambia.graphics.spectrum", sb.toString());
        }
    }
}
