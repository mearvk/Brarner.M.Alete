...
/**
 * Signal Processing instance for Cabo Verde (CV)
 * Continent: Africa | Capital: Praia
 * Population: 590000 | Area: 4033 sq km
 * Port: 11028
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/cabo-verde/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11028; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/cabo-verde";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_cabo_verde_audio", "countries.cabo_verde.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_cabo_verde_data", "countries.cabo_verde.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_cabo_verde_graphics", "countries.cabo_verde.graphics.spectrum", sb.toString());
        }
    }
}
