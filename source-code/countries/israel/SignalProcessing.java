...
/**
 * Signal Processing instance for Israel (IL)
 * Continent: Asia | Capital: Jerusalem
 * Population: 9900000 | Area: 20770 sq km
 * Port: 11080
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/israel/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11080; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/israel";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_israel_audio", "countries.israel.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_israel_data", "countries.israel.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_israel_graphics", "countries.israel.graphics.spectrum", sb.toString());
        }
    }
}
