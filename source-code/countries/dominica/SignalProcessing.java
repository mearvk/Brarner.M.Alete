...
/**
 * Signal Processing instance for Dominica (DM)
 * Continent: North America | Capital: Roseau
 * Population: 73000 | Area: 751 sq km
 * Port: 11047
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/dominica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/dominica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_dominica_audio", "countries.dominica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_dominica_data", "countries.dominica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_dominica_graphics", "countries.dominica.graphics.spectrum", sb.toString());
        }
    }
}
