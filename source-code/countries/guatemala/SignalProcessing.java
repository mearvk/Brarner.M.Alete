...
/**
 * Signal Processing instance for Guatemala (GT)
 * Continent: North America | Capital: Guatemala City
 * Population: 18300000 | Area: 108889 sq km
 * Port: 11067
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/guatemala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11067; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/guatemala";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_guatemala_audio", "countries.guatemala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_guatemala_data", "countries.guatemala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_guatemala_graphics", "countries.guatemala.graphics.spectrum", sb.toString());
        }
    }
}
