...
/**
 * Signal Processing instance for Mongolia (MN)
 * Continent: Asia | Capital: Ulaanbaatar
 * Population: 3500000 | Area: 1564116 sq km
 * Port: 11113
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/mongolia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11113; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/mongolia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_mongolia_audio", "countries.mongolia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_mongolia_data", "countries.mongolia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_mongolia_graphics", "countries.mongolia.graphics.spectrum", sb.toString());
        }
    }
}
