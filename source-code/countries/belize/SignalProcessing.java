...
/**
 * Signal Processing instance for Belize (BZ)
 * Continent: North America | Capital: Belmopan
 * Population: 410000 | Area: 22966 sq km
 * Port: 11017
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/countries/belize/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11017; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/countries/belize";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("countries_belize_audio", "countries.belize.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("countries_belize_data", "countries.belize.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("countries_belize_graphics", "countries.belize.graphics.spectrum", sb.toString());
        }
    }
}
