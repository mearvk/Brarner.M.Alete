...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/unc/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/unc";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("unc_audio", "unc.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("unc_data", "unc.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("unc_graphics", "unc.graphics.spectrum", sb.toString());
        }
    }
}
