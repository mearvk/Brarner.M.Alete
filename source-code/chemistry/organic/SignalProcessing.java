...
/**
 * Signal Processing for Chemistry Division: Organic Chemistry
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/chemistry/organic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 20001; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/chemistry/organic";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Organic Chemistry"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chemistry_organic_audio", "chemistry.organic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chemistry_organic_data", "chemistry.organic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chemistry_organic_graphics", "chemistry.organic.graphics.spectrum", sb.toString());
        }
    }
}
