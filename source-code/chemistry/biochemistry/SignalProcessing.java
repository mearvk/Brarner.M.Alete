package chemistry.biochemistry;
...
/**
 * Signal Processing for Chemistry Division: Biochemistry
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/chemistry/biochemistry/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 20005; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/chemistry/biochemistry";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Biochemistry"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chemistry_biochemistry_audio", "chemistry.biochemistry.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chemistry_biochemistry_data", "chemistry.biochemistry.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chemistry_biochemistry_graphics", "chemistry.biochemistry.graphics.spectrum", sb.toString());
        }
    }
}
