...
import com.github.psambit9791.jdsp.filter.FIR;
import com.github.psambit9791.jdsp.filter.IIR;
import java.io.*;
import java.net.*;
import java.sql.*;
...
/**
 * Signal Processing for Chemistry Division: Analytical Chemistry
 * <p>Study of separation, identification, and quantification of matter</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/chemistry/analytical/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 20003; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/chemistry/analytical";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Analytical Chemistry"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chemistry_analytical_audio", "chemistry.analytical.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chemistry_analytical_data", "chemistry.analytical.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chemistry_analytical_graphics", "chemistry.analytical.graphics.spectrum", sb.toString());
        }
    }
}
