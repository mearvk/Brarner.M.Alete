...
/**
 * Signal Processing for Chemistry Division: Physical Chemistry
 * <p>Study of macroscopic and molecular phenomena in chemical systems using physics</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/chemistry/physical/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 20004; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/chemistry/physical";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Physical Chemistry"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chemistry_physical_audio", "chemistry.physical.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chemistry_physical_data", "chemistry.physical.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chemistry_physical_graphics", "chemistry.physical.graphics.spectrum", sb.toString());
        }
    }
}
