package species.ctenophora.nuda;
...
/**
 * Signal Processing for Phylum: Ctenophora, Class: Nuda
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/nuda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11276; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/nuda";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Nuda"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ctenophora_nuda_audio", "species.ctenophora.nuda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ctenophora_nuda_data", "species.ctenophora.nuda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ctenophora_nuda_graphics", "species.ctenophora.nuda.graphics.spectrum", sb.toString());
        }
    }
}