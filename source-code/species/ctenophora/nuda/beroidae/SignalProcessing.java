package species.ctenophora.nuda.beroidae;
...
/**
 * Signal Processing for Family: Beroidae
 * <p>Phylum: Ctenophora | Class: Nuda | Order: Beroida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/nuda/beroidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11277; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/nuda/beroidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Nuda"); ps.setString(3, "Beroidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("beroidae_audio", "species.ctenophora.nuda.beroidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("beroidae_data", "species.ctenophora.nuda.beroidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("beroidae_graphics", "species.ctenophora.nuda.beroidae.graphics.spectrum", sb.toString());
        }
    }
}