package species.ctenophora.tentaculata.thalassocalycidae;
...
/**
 * Signal Processing for Family: Thalassocalycidae
 * <p>Phylum: Ctenophora | Class: Tentaculata | Order: Thalassocalycida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/thalassocalycidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11299; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata/thalassocalycidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, "Thalassocalycidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thalassocalycidae_audio", "species.ctenophora.tentaculata.thalassocalycidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thalassocalycidae_data", "species.ctenophora.tentaculata.thalassocalycidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thalassocalycidae_graphics", "species.ctenophora.tentaculata.thalassocalycidae.graphics.spectrum", sb.toString());
        }
    }
}