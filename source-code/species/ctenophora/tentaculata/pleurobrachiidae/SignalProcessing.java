package species.ctenophora.tentaculata.pleurobrachiidae;
...
/**
 * Signal Processing for Family: Pleurobrachiidae
 * <p>Phylum: Ctenophora | Class: Tentaculata | Order: Cydippida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/pleurobrachiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11288; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata/pleurobrachiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, "Pleurobrachiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pleurobrachiidae_audio", "species.ctenophora.tentaculata.pleurobrachiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pleurobrachiidae_data", "species.ctenophora.tentaculata.pleurobrachiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pleurobrachiidae_graphics", "species.ctenophora.tentaculata.pleurobrachiidae.graphics.spectrum", sb.toString());
        }
    }
}