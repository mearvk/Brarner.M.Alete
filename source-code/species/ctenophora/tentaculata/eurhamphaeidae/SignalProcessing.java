package species.ctenophora.tentaculata.eurhamphaeidae;
...
/**
 * Signal Processing for Family: Eurhamphaeidae
 * <p>Phylum: Ctenophora | Class: Tentaculata | Order: Lobata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/eurhamphaeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11292; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata/eurhamphaeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, "Eurhamphaeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eurhamphaeidae_audio", "species.ctenophora.tentaculata.eurhamphaeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eurhamphaeidae_data", "species.ctenophora.tentaculata.eurhamphaeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eurhamphaeidae_graphics", "species.ctenophora.tentaculata.eurhamphaeidae.graphics.spectrum", sb.toString());
        }
    }
}