package species.ctenophora.tentaculata.euplokamididae;
...
/**
 * Signal Processing for Family: Euplokamididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/euplokamididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11284; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata/euplokamididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, "Euplokamididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("euplokamididae_audio", "species.ctenophora.tentaculata.euplokamididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("euplokamididae_data", "species.ctenophora.tentaculata.euplokamididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("euplokamididae_graphics", "species.ctenophora.tentaculata.euplokamididae.graphics.spectrum", sb.toString());
        }
    }
}