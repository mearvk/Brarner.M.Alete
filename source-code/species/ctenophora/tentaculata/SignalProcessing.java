package species.ctenophora.tentaculata;
...
/**
 * Signal Processing for Phylum: Ctenophora, Class: Tentaculata
 * <p>Families: 21</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11278; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ctenophora_tentaculata_audio", "species.ctenophora.tentaculata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ctenophora_tentaculata_data", "species.ctenophora.tentaculata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ctenophora_tentaculata_graphics", "species.ctenophora.tentaculata.graphics.spectrum", sb.toString());
        }
    }
}