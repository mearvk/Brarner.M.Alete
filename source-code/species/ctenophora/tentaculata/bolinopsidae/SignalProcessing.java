package species.ctenophora.tentaculata.bolinopsidae;
...
/**
 * Signal Processing for Family: Bolinopsidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/ctenophora/tentaculata/bolinopsidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11291; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/ctenophora/tentaculata/bolinopsidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ctenophora"); ps.setString(2, "Tentaculata"); ps.setString(3, "Bolinopsidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bolinopsidae_audio", "species.ctenophora.tentaculata.bolinopsidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bolinopsidae_data", "species.ctenophora.tentaculata.bolinopsidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bolinopsidae_graphics", "species.ctenophora.tentaculata.bolinopsidae.graphics.spectrum", sb.toString());
        }
    }
}