...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Gastrotricha
 * <p>Classes: 0 | Families: 13</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/gastrotricha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10424; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/gastrotricha";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Gastrotricha"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_gastrotricha_audio", "species.gastrotricha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_gastrotricha_data", "species.gastrotricha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_gastrotricha_graphics", "species.gastrotricha.graphics.spectrum", sb.toString());
        }
    }
}