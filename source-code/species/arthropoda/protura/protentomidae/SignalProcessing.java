package species.arthropoda.protura.protentomidae;
...
/**
 * Signal Processing for Family: Protentomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/protura/protentomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16162; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/protura/protentomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Protura"); ps.setString(3, "Protentomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protentomidae_audio", "species.arthropoda.protura.protentomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protentomidae_data", "species.arthropoda.protura.protentomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protentomidae_graphics", "species.arthropoda.protura.protentomidae.graphics.spectrum", sb.toString());
        }
    }
}