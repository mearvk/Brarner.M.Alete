package species.arthropoda.protura.fujientomidae;
...
/**
 * Signal Processing for Family: Fujientomidae
 * <p>Phylum: Arthropoda | Class: Protura | Order: Sinentomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/protura/fujientomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16165; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/protura/fujientomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Protura"); ps.setString(3, "Fujientomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("fujientomidae_audio", "species.arthropoda.protura.fujientomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("fujientomidae_data", "species.arthropoda.protura.fujientomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("fujientomidae_graphics", "species.arthropoda.protura.fujientomidae.graphics.spectrum", sb.toString());
        }
    }
}