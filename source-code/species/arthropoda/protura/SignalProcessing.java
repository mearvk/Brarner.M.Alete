package species.arthropoda.protura;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Protura
 * <p>Families: 7</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/protura/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16159; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/protura";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Protura"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_protura_audio", "species.arthropoda.protura.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_protura_data", "species.arthropoda.protura.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_protura_graphics", "species.arthropoda.protura.graphics.spectrum", sb.toString());
        }
    }
}