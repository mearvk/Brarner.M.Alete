package species.arthropoda.protura.hesperentomidae;
...
/**
 * Signal Processing for Family: Hesperentomidae
 * <p>Phylum: Arthropoda | Class: Protura | Order: Acerentomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/protura/hesperentomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16161; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/protura/hesperentomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Protura"); ps.setString(3, "Hesperentomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hesperentomidae_audio", "species.arthropoda.protura.hesperentomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hesperentomidae_data", "species.arthropoda.protura.hesperentomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hesperentomidae_graphics", "species.arthropoda.protura.hesperentomidae.graphics.spectrum", sb.toString());
        }
    }
}