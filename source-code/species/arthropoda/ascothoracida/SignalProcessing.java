package species.arthropoda.ascothoracida;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Ascothoracida
 * <p>Families: 6</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/ascothoracida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14764; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/ascothoracida";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Ascothoracida"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_ascothoracida_audio", "species.arthropoda.ascothoracida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_ascothoracida_data", "species.arthropoda.ascothoracida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_ascothoracida_graphics", "species.arthropoda.ascothoracida.graphics.spectrum", sb.toString());
        }
    }
}