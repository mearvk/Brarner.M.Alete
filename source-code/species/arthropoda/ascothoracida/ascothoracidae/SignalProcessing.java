package species.arthropoda.ascothoracida.ascothoracidae;
...
/**
 * Signal Processing for Family: Ascothoracidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/ascothoracida/ascothoracidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14765; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/ascothoracida/ascothoracidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Ascothoracida"); ps.setString(3, "Ascothoracidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ascothoracidae_audio", "species.arthropoda.ascothoracida.ascothoracidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ascothoracidae_data", "species.arthropoda.ascothoracida.ascothoracidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ascothoracidae_graphics", "species.arthropoda.ascothoracida.ascothoracidae.graphics.spectrum", sb.toString());
        }
    }
}