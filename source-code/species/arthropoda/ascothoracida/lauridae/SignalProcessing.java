package species.arthropoda.ascothoracida.lauridae;
...
/**
 * Signal Processing for Family: Lauridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/ascothoracida/lauridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14768; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/ascothoracida/lauridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Ascothoracida"); ps.setString(3, "Lauridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lauridae_audio", "species.arthropoda.ascothoracida.lauridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lauridae_data", "species.arthropoda.ascothoracida.lauridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lauridae_graphics", "species.arthropoda.ascothoracida.lauridae.graphics.spectrum", sb.toString());
        }
    }
}