package species.arthropoda.ascothoracida.ctenosculidae;
...
/**
 * Signal Processing for Family: Ctenosculidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/ascothoracida/ctenosculidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14766; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/ascothoracida/ctenosculidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Ascothoracida"); ps.setString(3, "Ctenosculidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ctenosculidae_audio", "species.arthropoda.ascothoracida.ctenosculidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ctenosculidae_data", "species.arthropoda.ascothoracida.ctenosculidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ctenosculidae_graphics", "species.arthropoda.ascothoracida.ctenosculidae.graphics.spectrum", sb.toString());
        }
    }
}