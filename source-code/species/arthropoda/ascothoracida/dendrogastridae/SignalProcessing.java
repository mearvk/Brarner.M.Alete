package species.arthropoda.ascothoracida.dendrogastridae;
...
/**
 * Signal Processing for Family: Dendrogastridae
 * <p>Phylum: Arthropoda | Class: Ascothoracida | Order: Dendrogastrida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/ascothoracida/dendrogastridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14767; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/ascothoracida/dendrogastridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Ascothoracida"); ps.setString(3, "Dendrogastridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendrogastridae_audio", "species.arthropoda.ascothoracida.dendrogastridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendrogastridae_data", "species.arthropoda.ascothoracida.dendrogastridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendrogastridae_graphics", "species.arthropoda.ascothoracida.dendrogastridae.graphics.spectrum", sb.toString());
        }
    }
}