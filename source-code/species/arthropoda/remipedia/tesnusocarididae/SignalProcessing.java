package species.arthropoda.remipedia.tesnusocarididae;
...
/**
 * Signal Processing for Family: Tesnusocarididae
 * <p>Phylum: Arthropoda | Class: Remipedia | Order: Enantiopoda</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/remipedia/tesnusocarididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14749; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/remipedia/tesnusocarididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Remipedia"); ps.setString(3, "Tesnusocarididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tesnusocarididae_audio", "species.arthropoda.remipedia.tesnusocarididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tesnusocarididae_data", "species.arthropoda.remipedia.tesnusocarididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tesnusocarididae_graphics", "species.arthropoda.remipedia.tesnusocarididae.graphics.spectrum", sb.toString());
        }
    }
}