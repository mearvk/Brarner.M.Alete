package species.arthropoda.remipedia.xibalbanidae;
...
/**
 * Signal Processing for Family: Xibalbanidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/remipedia/xibalbanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14757; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/remipedia/xibalbanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Remipedia"); ps.setString(3, "Xibalbanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xibalbanidae_audio", "species.arthropoda.remipedia.xibalbanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xibalbanidae_data", "species.arthropoda.remipedia.xibalbanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xibalbanidae_graphics", "species.arthropoda.remipedia.xibalbanidae.graphics.spectrum", sb.toString());
        }
    }
}