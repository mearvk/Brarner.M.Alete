package species.arthropoda.remipedia.cryptocorynetidae;
...
/**
 * Signal Processing for Family: Cryptocorynetidae
 * <p>Phylum: Arthropoda | Class: Remipedia | Order: Nectiopoda</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/remipedia/cryptocorynetidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14750; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/remipedia/cryptocorynetidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Remipedia"); ps.setString(3, "Cryptocorynetidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cryptocorynetidae_audio", "species.arthropoda.remipedia.cryptocorynetidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cryptocorynetidae_data", "species.arthropoda.remipedia.cryptocorynetidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cryptocorynetidae_graphics", "species.arthropoda.remipedia.cryptocorynetidae.graphics.spectrum", sb.toString());
        }
    }
}