package species.arthropoda.remipedia.godzilliidae;
...
/**
 * Signal Processing for Family: Godzilliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/remipedia/godzilliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14751; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/remipedia/godzilliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Remipedia"); ps.setString(3, "Godzilliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("godzilliidae_audio", "species.arthropoda.remipedia.godzilliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("godzilliidae_data", "species.arthropoda.remipedia.godzilliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("godzilliidae_graphics", "species.arthropoda.remipedia.godzilliidae.graphics.spectrum", sb.toString());
        }
    }
}