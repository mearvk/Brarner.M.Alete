package species.arthropoda.phyllocarida.nebaliopsididae;
...
/**
 * Signal Processing for Family: Nebaliopsididae
 * <p>Phylum: Arthropoda | Class: Phyllocarida | Order: Leptostraca</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/phyllocarida/nebaliopsididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14746; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/phyllocarida/nebaliopsididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Phyllocarida"); ps.setString(3, "Nebaliopsididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nebaliopsididae_audio", "species.arthropoda.phyllocarida.nebaliopsididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nebaliopsididae_data", "species.arthropoda.phyllocarida.nebaliopsididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nebaliopsididae_graphics", "species.arthropoda.phyllocarida.nebaliopsididae.graphics.spectrum", sb.toString());
        }
    }
}