package species.arthropoda.phyllocarida.paranebaliidae;
...
/**
 * Signal Processing for Family: Paranebaliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/phyllocarida/paranebaliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14747; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/phyllocarida/paranebaliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Phyllocarida"); ps.setString(3, "Paranebaliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paranebaliidae_audio", "species.arthropoda.phyllocarida.paranebaliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paranebaliidae_data", "species.arthropoda.phyllocarida.paranebaliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paranebaliidae_graphics", "species.arthropoda.phyllocarida.paranebaliidae.graphics.spectrum", sb.toString());
        }
    }
}