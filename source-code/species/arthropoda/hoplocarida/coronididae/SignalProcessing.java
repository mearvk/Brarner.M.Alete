package species.arthropoda.hoplocarida.coronididae;
...
/**
 * Signal Processing for Family: Coronididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/hoplocarida/coronididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14736; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/hoplocarida/coronididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Hoplocarida"); ps.setString(3, "Coronididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("coronididae_audio", "species.arthropoda.hoplocarida.coronididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("coronididae_data", "species.arthropoda.hoplocarida.coronididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("coronididae_graphics", "species.arthropoda.hoplocarida.coronididae.graphics.spectrum", sb.toString());
        }
    }
}