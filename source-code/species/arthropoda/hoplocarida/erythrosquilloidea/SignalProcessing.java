package species.arthropoda.hoplocarida.erythrosquilloidea;
...
/**
 * Signal Processing for Family: Erythrosquilloidea
 * <p>Phylum: Arthropoda | Class: Hoplocarida | Order: Unipeltata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/hoplocarida/erythrosquilloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14723; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/hoplocarida/erythrosquilloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Hoplocarida"); ps.setString(3, "Erythrosquilloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("erythrosquilloidea_audio", "species.arthropoda.hoplocarida.erythrosquilloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("erythrosquilloidea_data", "species.arthropoda.hoplocarida.erythrosquilloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("erythrosquilloidea_graphics", "species.arthropoda.hoplocarida.erythrosquilloidea.graphics.spectrum", sb.toString());
        }
    }
}