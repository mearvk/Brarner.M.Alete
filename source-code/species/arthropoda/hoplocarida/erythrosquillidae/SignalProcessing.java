package species.arthropoda.hoplocarida.erythrosquillidae;
...
/**
 * Signal Processing for Family: Erythrosquillidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/hoplocarida/erythrosquillidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14724; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/hoplocarida/erythrosquillidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Hoplocarida"); ps.setString(3, "Erythrosquillidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("erythrosquillidae_audio", "species.arthropoda.hoplocarida.erythrosquillidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("erythrosquillidae_data", "species.arthropoda.hoplocarida.erythrosquillidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("erythrosquillidae_graphics", "species.arthropoda.hoplocarida.erythrosquillidae.graphics.spectrum", sb.toString());
        }
    }
}