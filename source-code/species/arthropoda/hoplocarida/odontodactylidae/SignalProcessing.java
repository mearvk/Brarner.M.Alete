package species.arthropoda.hoplocarida.odontodactylidae;
...
/**
 * Signal Processing for Family: Odontodactylidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/hoplocarida/odontodactylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14731; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/hoplocarida/odontodactylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Hoplocarida"); ps.setString(3, "Odontodactylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("odontodactylidae_audio", "species.arthropoda.hoplocarida.odontodactylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("odontodactylidae_data", "species.arthropoda.hoplocarida.odontodactylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("odontodactylidae_graphics", "species.arthropoda.hoplocarida.odontodactylidae.graphics.spectrum", sb.toString());
        }
    }
}