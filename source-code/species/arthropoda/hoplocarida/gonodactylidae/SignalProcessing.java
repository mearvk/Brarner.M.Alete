package species.arthropoda.hoplocarida.gonodactylidae;
...
/**
 * Signal Processing for Family: Gonodactylidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/hoplocarida/gonodactylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14729; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/hoplocarida/gonodactylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Hoplocarida"); ps.setString(3, "Gonodactylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gonodactylidae_audio", "species.arthropoda.hoplocarida.gonodactylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gonodactylidae_data", "species.arthropoda.hoplocarida.gonodactylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gonodactylidae_graphics", "species.arthropoda.hoplocarida.gonodactylidae.graphics.spectrum", sb.toString());
        }
    }
}