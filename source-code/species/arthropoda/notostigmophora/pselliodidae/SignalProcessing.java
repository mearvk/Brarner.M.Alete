package species.arthropoda.notostigmophora.pselliodidae;
...
/**
 * Signal Processing for Family: Pselliodidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/notostigmophora/pselliodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16168; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/notostigmophora/pselliodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Notostigmophora"); ps.setString(3, "Pselliodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pselliodidae_audio", "species.arthropoda.notostigmophora.pselliodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pselliodidae_data", "species.arthropoda.notostigmophora.pselliodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pselliodidae_graphics", "species.arthropoda.notostigmophora.pselliodidae.graphics.spectrum", sb.toString());
        }
    }
}