package species.arthropoda.notostigmophora;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Notostigmophora
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/notostigmophora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16167; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/notostigmophora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Notostigmophora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_notostigmophora_audio", "species.arthropoda.notostigmophora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_notostigmophora_data", "species.arthropoda.notostigmophora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_notostigmophora_graphics", "species.arthropoda.notostigmophora.graphics.spectrum", sb.toString());
        }
    }
}