package species.arthropoda.notostigmophora.scutigerinidae;
...
/**
 * Signal Processing for Family: Scutigerinidae
 * <p>Phylum: Arthropoda | Class: Notostigmophora | Order: Scutigeromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/notostigmophora/scutigerinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16170; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/notostigmophora/scutigerinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Notostigmophora"); ps.setString(3, "Scutigerinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scutigerinidae_audio", "species.arthropoda.notostigmophora.scutigerinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scutigerinidae_data", "species.arthropoda.notostigmophora.scutigerinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scutigerinidae_graphics", "species.arthropoda.notostigmophora.scutigerinidae.graphics.spectrum", sb.toString());
        }
    }
}