package species.arthropoda.notostigmophora.scutigeridae;
...
/**
 * Signal Processing for Family: Scutigeridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/notostigmophora/scutigeridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16169; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/notostigmophora/scutigeridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Notostigmophora"); ps.setString(3, "Scutigeridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scutigeridae_audio", "species.arthropoda.notostigmophora.scutigeridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scutigeridae_data", "species.arthropoda.notostigmophora.scutigeridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scutigeridae_graphics", "species.arthropoda.notostigmophora.scutigeridae.graphics.spectrum", sb.toString());
        }
    }
}