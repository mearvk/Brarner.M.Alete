package species.arthropoda.palaeoptera.ameletidae;
...
/**
 * Signal Processing for Family: Ameletidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/palaeoptera/ameletidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16128; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/palaeoptera/ameletidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Palaeoptera"); ps.setString(3, "Ameletidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ameletidae_audio", "species.arthropoda.palaeoptera.ameletidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ameletidae_data", "species.arthropoda.palaeoptera.ameletidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ameletidae_graphics", "species.arthropoda.palaeoptera.ameletidae.graphics.spectrum", sb.toString());
        }
    }
}