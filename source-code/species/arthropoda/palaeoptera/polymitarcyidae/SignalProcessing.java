package species.arthropoda.palaeoptera.polymitarcyidae;
...
/**
 * Signal Processing for Family: Polymitarcyidae
 * <p>Phylum: Arthropoda | Class: Palaeoptera | Order: Scapphodonta</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/palaeoptera/polymitarcyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16122; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/palaeoptera/polymitarcyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Palaeoptera"); ps.setString(3, "Polymitarcyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polymitarcyidae_audio", "species.arthropoda.palaeoptera.polymitarcyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polymitarcyidae_data", "species.arthropoda.palaeoptera.polymitarcyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polymitarcyidae_graphics", "species.arthropoda.palaeoptera.polymitarcyidae.graphics.spectrum", sb.toString());
        }
    }
}