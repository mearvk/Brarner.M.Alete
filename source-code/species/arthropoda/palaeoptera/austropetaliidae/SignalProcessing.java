package species.arthropoda.palaeoptera.austropetaliidae;
...
/**
 * Signal Processing for Family: Austropetaliidae
 * <p>Phylum: Arthropoda | Class: Palaeoptera | Order: Anisoptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/palaeoptera/austropetaliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16140; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/palaeoptera/austropetaliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Palaeoptera"); ps.setString(3, "Austropetaliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("austropetaliidae_audio", "species.arthropoda.palaeoptera.austropetaliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("austropetaliidae_data", "species.arthropoda.palaeoptera.austropetaliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("austropetaliidae_graphics", "species.arthropoda.palaeoptera.austropetaliidae.graphics.spectrum", sb.toString());
        }
    }
}