package species.arthropoda.palaeoptera.leptophlebiidae;
...
/**
 * Signal Processing for Family: Leptophlebiidae
 * <p>Phylum: Arthropoda | Class: Palaeoptera | Order: Lanceolata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/palaeoptera/leptophlebiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16110; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/palaeoptera/leptophlebiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Palaeoptera"); ps.setString(3, "Leptophlebiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leptophlebiidae_audio", "species.arthropoda.palaeoptera.leptophlebiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leptophlebiidae_data", "species.arthropoda.palaeoptera.leptophlebiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leptophlebiidae_graphics", "species.arthropoda.palaeoptera.leptophlebiidae.graphics.spectrum", sb.toString());
        }
    }
}