package species.arthropoda.palaeoptera.ephemerelloidea;
...
/**
 * Signal Processing for Family: Ephemerelloidea
 * <p>Phylum: Arthropoda | Class: Palaeoptera | Order: Pannota</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/palaeoptera/ephemerelloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16115; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/palaeoptera/ephemerelloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Palaeoptera"); ps.setString(3, "Ephemerelloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ephemerelloidea_audio", "species.arthropoda.palaeoptera.ephemerelloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ephemerelloidea_data", "species.arthropoda.palaeoptera.ephemerelloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ephemerelloidea_graphics", "species.arthropoda.palaeoptera.ephemerelloidea.graphics.spectrum", sb.toString());
        }
    }
}