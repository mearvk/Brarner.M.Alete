package species.arthropoda.myodocopa.thaumatocyprididae;
...
/**
 * Signal Processing for Family: Thaumatocyprididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/myodocopa/thaumatocyprididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14830; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/myodocopa/thaumatocyprididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Myodocopa"); ps.setString(3, "Thaumatocyprididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thaumatocyprididae_audio", "species.arthropoda.myodocopa.thaumatocyprididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thaumatocyprididae_data", "species.arthropoda.myodocopa.thaumatocyprididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thaumatocyprididae_graphics", "species.arthropoda.myodocopa.thaumatocyprididae.graphics.spectrum", sb.toString());
        }
    }
}