package species.arthropoda.myodocopa.cylindroleberidoidea;
...
/**
 * Signal Processing for Family: Cylindroleberidoidea
 * <p>Phylum: Arthropoda | Class: Myodocopa | Order: Myodocopina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/myodocopa/cylindroleberidoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14831; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/myodocopa/cylindroleberidoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Myodocopa"); ps.setString(3, "Cylindroleberidoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cylindroleberidoidea_audio", "species.arthropoda.myodocopa.cylindroleberidoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cylindroleberidoidea_data", "species.arthropoda.myodocopa.cylindroleberidoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cylindroleberidoidea_graphics", "species.arthropoda.myodocopa.cylindroleberidoidea.graphics.spectrum", sb.toString());
        }
    }
}