package species.arthropoda.myodocopa.cylindroleberididae;
...
/**
 * Signal Processing for Family: Cylindroleberididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/myodocopa/cylindroleberididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14832; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/myodocopa/cylindroleberididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Myodocopa"); ps.setString(3, "Cylindroleberididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cylindroleberididae_audio", "species.arthropoda.myodocopa.cylindroleberididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cylindroleberididae_data", "species.arthropoda.myodocopa.cylindroleberididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cylindroleberididae_graphics", "species.arthropoda.myodocopa.cylindroleberididae.graphics.spectrum", sb.toString());
        }
    }
}