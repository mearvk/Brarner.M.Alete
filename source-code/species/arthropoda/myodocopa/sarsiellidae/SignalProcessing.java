package species.arthropoda.myodocopa.sarsiellidae;
...
/**
 * Signal Processing for Family: Sarsiellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/myodocopa/sarsiellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14838; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/myodocopa/sarsiellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Myodocopa"); ps.setString(3, "Sarsiellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sarsiellidae_audio", "species.arthropoda.myodocopa.sarsiellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sarsiellidae_data", "species.arthropoda.myodocopa.sarsiellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sarsiellidae_graphics", "species.arthropoda.myodocopa.sarsiellidae.graphics.spectrum", sb.toString());
        }
    }
}