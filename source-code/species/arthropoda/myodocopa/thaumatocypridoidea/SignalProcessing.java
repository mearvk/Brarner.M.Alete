package species.arthropoda.myodocopa.thaumatocypridoidea;
...
/**
 * Signal Processing for Family: Thaumatocypridoidea
 * <p>Phylum: Arthropoda | Class: Myodocopa | Order: Halocypridina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/myodocopa/thaumatocypridoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14829; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/myodocopa/thaumatocypridoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Myodocopa"); ps.setString(3, "Thaumatocypridoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thaumatocypridoidea_audio", "species.arthropoda.myodocopa.thaumatocypridoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thaumatocypridoidea_data", "species.arthropoda.myodocopa.thaumatocypridoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thaumatocypridoidea_graphics", "species.arthropoda.myodocopa.thaumatocypridoidea.graphics.spectrum", sb.toString());
        }
    }
}