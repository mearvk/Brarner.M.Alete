package species.arthropoda.diplura.projapygidae;
...
/**
 * Signal Processing for Family: Projapygidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/projapygidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14965; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/projapygidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Projapygidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("projapygidae_audio", "species.arthropoda.diplura.projapygidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("projapygidae_data", "species.arthropoda.diplura.projapygidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("projapygidae_graphics", "species.arthropoda.diplura.projapygidae.graphics.spectrum", sb.toString());
        }
    }
}