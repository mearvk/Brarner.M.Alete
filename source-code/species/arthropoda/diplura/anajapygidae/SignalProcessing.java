package species.arthropoda.diplura.anajapygidae;
...
/**
 * Signal Processing for Family: Anajapygidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/anajapygidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14964; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/anajapygidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Anajapygidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anajapygidae_audio", "species.arthropoda.diplura.anajapygidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anajapygidae_data", "species.arthropoda.diplura.anajapygidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anajapygidae_graphics", "species.arthropoda.diplura.anajapygidae.graphics.spectrum", sb.toString());
        }
    }
}