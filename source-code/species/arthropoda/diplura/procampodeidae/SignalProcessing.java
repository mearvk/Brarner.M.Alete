package species.arthropoda.diplura.procampodeidae;
...
/**
 * Signal Processing for Family: Procampodeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/procampodeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14962; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/procampodeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Procampodeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("procampodeidae_audio", "species.arthropoda.diplura.procampodeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("procampodeidae_data", "species.arthropoda.diplura.procampodeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("procampodeidae_graphics", "species.arthropoda.diplura.procampodeidae.graphics.spectrum", sb.toString());
        }
    }
}