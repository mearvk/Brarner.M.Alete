package species.arthropoda.diplura.dinjapygidae;
...
/**
 * Signal Processing for Family: Dinjapygidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/dinjapygidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14956; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/dinjapygidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Dinjapygidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dinjapygidae_audio", "species.arthropoda.diplura.dinjapygidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dinjapygidae_data", "species.arthropoda.diplura.dinjapygidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dinjapygidae_graphics", "species.arthropoda.diplura.dinjapygidae.graphics.spectrum", sb.toString());
        }
    }
}