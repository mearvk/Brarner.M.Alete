package species.arthropoda.diplura.octostigmatidae;
...
/**
 * Signal Processing for Family: Octostigmatidae
 * <p>Phylum: Arthropoda | Class: Diplura | Order: Rhabdura</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/octostigmatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14961; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/octostigmatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Octostigmatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("octostigmatidae_audio", "species.arthropoda.diplura.octostigmatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("octostigmatidae_data", "species.arthropoda.diplura.octostigmatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("octostigmatidae_graphics", "species.arthropoda.diplura.octostigmatidae.graphics.spectrum", sb.toString());
        }
    }
}