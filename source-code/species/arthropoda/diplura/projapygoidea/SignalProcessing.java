package species.arthropoda.diplura.projapygoidea;
...
/**
 * Signal Processing for Family: Projapygoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/diplura/projapygoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14963; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/diplura/projapygoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Diplura"); ps.setString(3, "Projapygoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("projapygoidea_audio", "species.arthropoda.diplura.projapygoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("projapygoidea_data", "species.arthropoda.diplura.projapygoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("projapygoidea_graphics", "species.arthropoda.diplura.projapygoidea.graphics.spectrum", sb.toString());
        }
    }
}