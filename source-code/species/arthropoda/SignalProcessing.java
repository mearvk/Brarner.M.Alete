...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Arthropoda
 * <p>Classes: 43 | Families: 3427</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10410; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_arthropoda_audio", "species.arthropoda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_arthropoda_data", "species.arthropoda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_arthropoda_graphics", "species.arthropoda.graphics.spectrum", sb.toString());
        }
    }
}