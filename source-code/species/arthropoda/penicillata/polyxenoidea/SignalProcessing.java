package species.arthropoda.penicillata.polyxenoidea;
...
/**
 * Signal Processing for Family: Polyxenoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/penicillata/polyxenoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/penicillata/polyxenoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Penicillata"); ps.setString(3, "Polyxenoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polyxenoidea_audio", "species.arthropoda.penicillata.polyxenoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polyxenoidea_data", "species.arthropoda.penicillata.polyxenoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polyxenoidea_graphics", "species.arthropoda.penicillata.polyxenoidea.graphics.spectrum", sb.toString());
        }
    }
}