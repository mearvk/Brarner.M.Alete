package species.arthropoda.penicillata.lophoproctidae;
...
/**
 * Signal Processing for Family: Lophoproctidae
 * <p>Phylum: Arthropoda | Class: Penicillata | Order: Polyxenida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/penicillata/lophoproctidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16272; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/penicillata/lophoproctidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Penicillata"); ps.setString(3, "Lophoproctidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lophoproctidae_audio", "species.arthropoda.penicillata.lophoproctidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lophoproctidae_data", "species.arthropoda.penicillata.lophoproctidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lophoproctidae_graphics", "species.arthropoda.penicillata.lophoproctidae.graphics.spectrum", sb.toString());
        }
    }
}