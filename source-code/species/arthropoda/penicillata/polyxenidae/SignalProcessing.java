package species.arthropoda.penicillata.polyxenidae;
...
/**
 * Signal Processing for Family: Polyxenidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/penicillata/polyxenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16273; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/penicillata/polyxenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Penicillata"); ps.setString(3, "Polyxenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polyxenidae_audio", "species.arthropoda.penicillata.polyxenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polyxenidae_data", "species.arthropoda.penicillata.polyxenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polyxenidae_graphics", "species.arthropoda.penicillata.polyxenidae.graphics.spectrum", sb.toString());
        }
    }
}