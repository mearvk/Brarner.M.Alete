package species.arthropoda.penicillata;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Penicillata
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/penicillata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16270; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/penicillata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Penicillata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_penicillata_audio", "species.arthropoda.penicillata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_penicillata_data", "species.arthropoda.penicillata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_penicillata_graphics", "species.arthropoda.penicillata.graphics.spectrum", sb.toString());
        }
    }
}