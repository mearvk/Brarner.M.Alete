package species.arthropoda.collembola;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Collembola
 * <p>Families: 48</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14905; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_collembola_audio", "species.arthropoda.collembola.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_collembola_data", "species.arthropoda.collembola.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_collembola_graphics", "species.arthropoda.collembola.graphics.spectrum", sb.toString());
        }
    }
}