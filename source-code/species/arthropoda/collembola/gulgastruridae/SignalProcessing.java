package species.arthropoda.collembola.gulgastruridae;
...
/**
 * Signal Processing for Family: Gulgastruridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/gulgastruridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14924; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/gulgastruridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Gulgastruridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gulgastruridae_audio", "species.arthropoda.collembola.gulgastruridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gulgastruridae_data", "species.arthropoda.collembola.gulgastruridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gulgastruridae_graphics", "species.arthropoda.collembola.gulgastruridae.graphics.spectrum", sb.toString());
        }
    }
}