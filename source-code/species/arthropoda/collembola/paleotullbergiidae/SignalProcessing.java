package species.arthropoda.collembola.paleotullbergiidae;
...
/**
 * Signal Processing for Family: Paleotullbergiidae
 * <p>Phylum: Arthropoda | Class: Collembola | Order: Poduromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/paleotullbergiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14927; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/paleotullbergiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Paleotullbergiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paleotullbergiidae_audio", "species.arthropoda.collembola.paleotullbergiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paleotullbergiidae_data", "species.arthropoda.collembola.paleotullbergiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paleotullbergiidae_graphics", "species.arthropoda.collembola.paleotullbergiidae.graphics.spectrum", sb.toString());
        }
    }
}