package species.arthropoda.collembola.protentomobryidae;
...
/**
 * Signal Processing for Family: Protentomobryidae
 * <p>Phylum: Arthropoda | Class: Collembola | Order: Entomobryomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/protentomobryidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14918; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/protentomobryidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Protentomobryidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protentomobryidae_audio", "species.arthropoda.collembola.protentomobryidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protentomobryidae_data", "species.arthropoda.collembola.protentomobryidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protentomobryidae_graphics", "species.arthropoda.collembola.protentomobryidae.graphics.spectrum", sb.toString());
        }
    }
}