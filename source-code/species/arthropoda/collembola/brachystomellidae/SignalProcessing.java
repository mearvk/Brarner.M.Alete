package species.arthropoda.collembola.brachystomellidae;
...
/**
 * Signal Processing for Family: Brachystomellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/brachystomellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14929; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/brachystomellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Brachystomellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brachystomellidae_audio", "species.arthropoda.collembola.brachystomellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brachystomellidae_data", "species.arthropoda.collembola.brachystomellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brachystomellidae_graphics", "species.arthropoda.collembola.brachystomellidae.graphics.spectrum", sb.toString());
        }
    }
}