package species.arthropoda.collembola.sminthurididoidea;
...
/**
 * Signal Processing for Family: Sminthurididoidea
 * <p>Phylum: Arthropoda | Class: Collembola | Order: Symphypleona</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/sminthurididoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14946; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/sminthurididoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Sminthurididoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sminthurididoidea_audio", "species.arthropoda.collembola.sminthurididoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sminthurididoidea_data", "species.arthropoda.collembola.sminthurididoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sminthurididoidea_graphics", "species.arthropoda.collembola.sminthurididoidea.graphics.spectrum", sb.toString());
        }
    }
}