package species.arthropoda.collembola.dicyrtomidae;
...
/**
 * Signal Processing for Family: Dicyrtomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/collembola/dicyrtomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14940; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/collembola/dicyrtomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Collembola"); ps.setString(3, "Dicyrtomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dicyrtomidae_audio", "species.arthropoda.collembola.dicyrtomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dicyrtomidae_data", "species.arthropoda.collembola.dicyrtomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dicyrtomidae_graphics", "species.arthropoda.collembola.dicyrtomidae.graphics.spectrum", sb.toString());
        }
    }
}