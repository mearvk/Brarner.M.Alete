package species.arthropoda.tantulocarida.microdajidae;
...
/**
 * Signal Processing for Family: Microdajidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/tantulocarida/microdajidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14762; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/tantulocarida/microdajidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Tantulocarida"); ps.setString(3, "Microdajidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("microdajidae_audio", "species.arthropoda.tantulocarida.microdajidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("microdajidae_data", "species.arthropoda.tantulocarida.microdajidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("microdajidae_graphics", "species.arthropoda.tantulocarida.microdajidae.graphics.spectrum", sb.toString());
        }
    }
}