package species.arthropoda.tantulocarida.onceroxenidae;
...
/**
 * Signal Processing for Family: Onceroxenidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/tantulocarida/onceroxenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14763; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/tantulocarida/onceroxenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Tantulocarida"); ps.setString(3, "Onceroxenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("onceroxenidae_audio", "species.arthropoda.tantulocarida.onceroxenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("onceroxenidae_data", "species.arthropoda.tantulocarida.onceroxenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("onceroxenidae_graphics", "species.arthropoda.tantulocarida.onceroxenidae.graphics.spectrum", sb.toString());
        }
    }
}