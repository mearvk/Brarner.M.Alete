package species.arthropoda.tantulocarida.deoterthridae;
...
/**
 * Signal Processing for Family: Deoterthridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/tantulocarida/deoterthridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14760; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/tantulocarida/deoterthridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Tantulocarida"); ps.setString(3, "Deoterthridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("deoterthridae_audio", "species.arthropoda.tantulocarida.deoterthridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("deoterthridae_data", "species.arthropoda.tantulocarida.deoterthridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("deoterthridae_graphics", "species.arthropoda.tantulocarida.deoterthridae.graphics.spectrum", sb.toString());
        }
    }
}