package species.arthropoda.tantulocarida;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Tantulocarida
 * <p>Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/tantulocarida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14758; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/tantulocarida";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Tantulocarida"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_tantulocarida_audio", "species.arthropoda.tantulocarida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_tantulocarida_data", "species.arthropoda.tantulocarida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_tantulocarida_graphics", "species.arthropoda.tantulocarida.graphics.spectrum", sb.toString());
        }
    }
}