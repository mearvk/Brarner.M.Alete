package species.arthropoda.tantulocarida.doryphallophoridae;
...
/**
 * Signal Processing for Family: Doryphallophoridae
 * <p>Phylum: Arthropoda | Class: Tantulocarida | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/tantulocarida/doryphallophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14761; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/tantulocarida/doryphallophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Tantulocarida"); ps.setString(3, "Doryphallophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("doryphallophoridae_audio", "species.arthropoda.tantulocarida.doryphallophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("doryphallophoridae_data", "species.arthropoda.tantulocarida.doryphallophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("doryphallophoridae_graphics", "species.arthropoda.tantulocarida.doryphallophoridae.graphics.spectrum", sb.toString());
        }
    }
}