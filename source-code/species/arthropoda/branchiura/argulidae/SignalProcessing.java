package species.arthropoda.branchiura.argulidae;
...
/**
 * Signal Processing for Family: Argulidae
 * <p>Phylum: Arthropoda | Class: Branchiura | Order: Arguloida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiura/argulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14821; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiura/argulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiura"); ps.setString(3, "Argulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("argulidae_audio", "species.arthropoda.branchiura.argulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("argulidae_data", "species.arthropoda.branchiura.argulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("argulidae_graphics", "species.arthropoda.branchiura.argulidae.graphics.spectrum", sb.toString());
        }
    }
}