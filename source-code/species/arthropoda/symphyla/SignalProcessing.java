package species.arthropoda.symphyla;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Symphyla
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/symphyla/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16290; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/symphyla";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Symphyla"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_symphyla_audio", "species.arthropoda.symphyla.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_symphyla_data", "species.arthropoda.symphyla.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_symphyla_graphics", "species.arthropoda.symphyla.graphics.spectrum", sb.toString());
        }
    }
}