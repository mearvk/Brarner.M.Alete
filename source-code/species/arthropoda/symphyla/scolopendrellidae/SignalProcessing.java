package species.arthropoda.symphyla.scolopendrellidae;
...
/**
 * Signal Processing for Family: Scolopendrellidae
 * <p>Phylum: Arthropoda | Class: Symphyla | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/symphyla/scolopendrellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16291; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/symphyla/scolopendrellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Symphyla"); ps.setString(3, "Scolopendrellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scolopendrellidae_audio", "species.arthropoda.symphyla.scolopendrellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scolopendrellidae_data", "species.arthropoda.symphyla.scolopendrellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scolopendrellidae_graphics", "species.arthropoda.symphyla.scolopendrellidae.graphics.spectrum", sb.toString());
        }
    }
}