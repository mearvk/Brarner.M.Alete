package species.arthropoda.symphyla.scutigerellidae;
...
/**
 * Signal Processing for Family: Scutigerellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/symphyla/scutigerellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16292; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/symphyla/scutigerellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Symphyla"); ps.setString(3, "Scutigerellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scutigerellidae_audio", "species.arthropoda.symphyla.scutigerellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scutigerellidae_data", "species.arthropoda.symphyla.scutigerellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scutigerellidae_graphics", "species.arthropoda.symphyla.scutigerellidae.graphics.spectrum", sb.toString());
        }
    }
}