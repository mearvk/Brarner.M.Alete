package species.arthropoda.pycnogonida.rhynchothoracoidea;
...
/**
 * Signal Processing for Family: Rhynchothoracoidea
 * <p>Phylum: Arthropoda | Class: Pycnogonida | Order: Eupantopodida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pycnogonida/rhynchothoracoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13788; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pycnogonida/rhynchothoracoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pycnogonida"); ps.setString(3, "Rhynchothoracoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhynchothoracoidea_audio", "species.arthropoda.pycnogonida.rhynchothoracoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhynchothoracoidea_data", "species.arthropoda.pycnogonida.rhynchothoracoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhynchothoracoidea_graphics", "species.arthropoda.pycnogonida.rhynchothoracoidea.graphics.spectrum", sb.toString());
        }
    }
}