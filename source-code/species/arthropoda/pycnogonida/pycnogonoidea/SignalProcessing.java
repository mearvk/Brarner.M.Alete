package species.arthropoda.pycnogonida.pycnogonoidea;
...
/**
 * Signal Processing for Family: Pycnogonoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pycnogonida/pycnogonoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13786; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pycnogonida/pycnogonoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pycnogonida"); ps.setString(3, "Pycnogonoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pycnogonoidea_audio", "species.arthropoda.pycnogonida.pycnogonoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pycnogonoidea_data", "species.arthropoda.pycnogonida.pycnogonoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pycnogonoidea_graphics", "species.arthropoda.pycnogonida.pycnogonoidea.graphics.spectrum", sb.toString());
        }
    }
}