package species.arthropoda.pycnogonida.ascorhynchoidea;
...
/**
 * Signal Processing for Family: Ascorhynchoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pycnogonida/ascorhynchoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13774; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pycnogonida/ascorhynchoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pycnogonida"); ps.setString(3, "Ascorhynchoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ascorhynchoidea_audio", "species.arthropoda.pycnogonida.ascorhynchoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ascorhynchoidea_data", "species.arthropoda.pycnogonida.ascorhynchoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ascorhynchoidea_graphics", "species.arthropoda.pycnogonida.ascorhynchoidea.graphics.spectrum", sb.toString());
        }
    }
}