package species.arthropoda.pycnogonida.endeidae;
...
/**
 * Signal Processing for Family: Endeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pycnogonida/endeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13784; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pycnogonida/endeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pycnogonida"); ps.setString(3, "Endeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("endeidae_audio", "species.arthropoda.pycnogonida.endeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("endeidae_data", "species.arthropoda.pycnogonida.endeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("endeidae_graphics", "species.arthropoda.pycnogonida.endeidae.graphics.spectrum", sb.toString());
        }
    }
}