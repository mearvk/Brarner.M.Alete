package species.arthropoda.pycnogonida.phoxichilidoidea;
...
/**
 * Signal Processing for Family: Phoxichilidoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pycnogonida/phoxichilidoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13783; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pycnogonida/phoxichilidoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pycnogonida"); ps.setString(3, "Phoxichilidoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phoxichilidoidea_audio", "species.arthropoda.pycnogonida.phoxichilidoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phoxichilidoidea_data", "species.arthropoda.pycnogonida.phoxichilidoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phoxichilidoidea_graphics", "species.arthropoda.pycnogonida.phoxichilidoidea.graphics.spectrum", sb.toString());
        }
    }
}