package species.arthropoda.mystacocarida.derocheilocarididae;
...
/**
 * Signal Processing for Family: Derocheilocarididae
 * <p>Phylum: Arthropoda | Class: Mystacocarida | Order: Mystacocaridida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/mystacocarida/derocheilocarididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14823; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/mystacocarida/derocheilocarididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Mystacocarida"); ps.setString(3, "Derocheilocarididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("derocheilocarididae_audio", "species.arthropoda.mystacocarida.derocheilocarididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("derocheilocarididae_data", "species.arthropoda.mystacocarida.derocheilocarididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("derocheilocarididae_graphics", "species.arthropoda.mystacocarida.derocheilocarididae.graphics.spectrum", sb.toString());
        }
    }
}