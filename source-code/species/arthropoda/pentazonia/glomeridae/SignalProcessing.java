package species.arthropoda.pentazonia.glomeridae;
...
/**
 * Signal Processing for Family: Glomeridae
 * <p>Phylum: Arthropoda | Class: Pentazonia | Order: Glomerida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentazonia/glomeridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16268; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentazonia/glomeridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentazonia"); ps.setString(3, "Glomeridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glomeridae_audio", "species.arthropoda.pentazonia.glomeridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glomeridae_data", "species.arthropoda.pentazonia.glomeridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glomeridae_graphics", "species.arthropoda.pentazonia.glomeridae.graphics.spectrum", sb.toString());
        }
    }
}