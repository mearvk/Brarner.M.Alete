package species.arthropoda.pentazonia.glomeridesmidae;
...
/**
 * Signal Processing for Family: Glomeridesmidae
 * <p>Phylum: Arthropoda | Class: Pentazonia | Order: Glomeridesmida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentazonia/glomeridesmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16269; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentazonia/glomeridesmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentazonia"); ps.setString(3, "Glomeridesmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glomeridesmidae_audio", "species.arthropoda.pentazonia.glomeridesmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glomeridesmidae_data", "species.arthropoda.pentazonia.glomeridesmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glomeridesmidae_graphics", "species.arthropoda.pentazonia.glomeridesmidae.graphics.spectrum", sb.toString());
        }
    }
}