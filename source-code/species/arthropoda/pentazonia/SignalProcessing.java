package species.arthropoda.pentazonia;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Pentazonia
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentazonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentazonia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentazonia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_pentazonia_audio", "species.arthropoda.pentazonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_pentazonia_data", "species.arthropoda.pentazonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_pentazonia_graphics", "species.arthropoda.pentazonia.graphics.spectrum", sb.toString());
        }
    }
}