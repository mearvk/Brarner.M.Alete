package species.arthropoda.pauropoda.amphipauropodidae;
...
/**
 * Signal Processing for Family: Amphipauropodidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pauropoda/amphipauropodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16285; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pauropoda/amphipauropodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pauropoda"); ps.setString(3, "Amphipauropodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("amphipauropodidae_audio", "species.arthropoda.pauropoda.amphipauropodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("amphipauropodidae_data", "species.arthropoda.pauropoda.amphipauropodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("amphipauropodidae_graphics", "species.arthropoda.pauropoda.amphipauropodidae.graphics.spectrum", sb.toString());
        }
    }
}