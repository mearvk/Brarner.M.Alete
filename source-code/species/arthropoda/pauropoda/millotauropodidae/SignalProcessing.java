package species.arthropoda.pauropoda.millotauropodidae;
...
/**
 * Signal Processing for Family: Millotauropodidae
 * <p>Phylum: Arthropoda | Class: Pauropoda | Order: Hexamerocerata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pauropoda/millotauropodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pauropoda/millotauropodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pauropoda"); ps.setString(3, "Millotauropodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("millotauropodidae_audio", "species.arthropoda.pauropoda.millotauropodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("millotauropodidae_data", "species.arthropoda.pauropoda.millotauropodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("millotauropodidae_graphics", "species.arthropoda.pauropoda.millotauropodidae.graphics.spectrum", sb.toString());
        }
    }
}