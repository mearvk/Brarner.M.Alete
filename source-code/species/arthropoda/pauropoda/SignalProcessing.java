package species.arthropoda.pauropoda;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Pauropoda
 * <p>Families: 15</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pauropoda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16274; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pauropoda";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pauropoda"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_pauropoda_audio", "species.arthropoda.pauropoda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_pauropoda_data", "species.arthropoda.pauropoda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_pauropoda_graphics", "species.arthropoda.pauropoda.graphics.spectrum", sb.toString());
        }
    }
}