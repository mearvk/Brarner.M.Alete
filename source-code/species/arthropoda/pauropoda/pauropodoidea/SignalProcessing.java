package species.arthropoda.pauropoda.pauropodoidea;
...
/**
 * Signal Processing for Family: Pauropodoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pauropoda/pauropodoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16284; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pauropoda/pauropodoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pauropoda"); ps.setString(3, "Pauropodoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pauropodoidea_audio", "species.arthropoda.pauropoda.pauropodoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pauropodoidea_data", "species.arthropoda.pauropoda.pauropodoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pauropodoidea_graphics", "species.arthropoda.pauropoda.pauropodoidea.graphics.spectrum", sb.toString());
        }
    }
}