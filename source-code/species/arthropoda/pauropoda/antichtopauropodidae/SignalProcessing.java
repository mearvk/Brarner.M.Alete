package species.arthropoda.pauropoda.antichtopauropodidae;
...
/**
 * Signal Processing for Family: Antichtopauropodidae
 * <p>Phylum: Arthropoda | Class: Pauropoda | Order: Tetramerocerata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pauropoda/antichtopauropodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16276; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pauropoda/antichtopauropodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pauropoda"); ps.setString(3, "Antichtopauropodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("antichtopauropodidae_audio", "species.arthropoda.pauropoda.antichtopauropodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("antichtopauropodidae_data", "species.arthropoda.pauropoda.antichtopauropodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("antichtopauropodidae_graphics", "species.arthropoda.pauropoda.antichtopauropodidae.graphics.spectrum", sb.toString());
        }
    }
}