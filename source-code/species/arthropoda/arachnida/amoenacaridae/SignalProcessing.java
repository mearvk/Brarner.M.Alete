package species.arthropoda.arachnida.amoenacaridae;
...
/**
 * Signal Processing for Family: Amoenacaridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/amoenacaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13444; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/amoenacaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Amoenacaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("amoenacaridae_audio", "species.arthropoda.arachnida.amoenacaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("amoenacaridae_data", "species.arthropoda.arachnida.amoenacaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("amoenacaridae_graphics", "species.arthropoda.arachnida.amoenacaridae.graphics.spectrum", sb.toString());
        }
    }
}