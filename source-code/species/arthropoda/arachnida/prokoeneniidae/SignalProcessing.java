package species.arthropoda.arachnida.prokoeneniidae;
...
/**
 * Signal Processing for Family: Prokoeneniidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Palpigradi</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/prokoeneniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13012; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/prokoeneniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Prokoeneniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("prokoeneniidae_audio", "species.arthropoda.arachnida.prokoeneniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("prokoeneniidae_data", "species.arthropoda.arachnida.prokoeneniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("prokoeneniidae_graphics", "species.arthropoda.arachnida.prokoeneniidae.graphics.spectrum", sb.toString());
        }
    }
}