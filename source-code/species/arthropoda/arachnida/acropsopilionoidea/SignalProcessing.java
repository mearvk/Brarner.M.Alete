package species.arthropoda.arachnida.acropsopilionoidea;
...
/**
 * Signal Processing for Family: Acropsopilionoidea
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Dyspnoi</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/acropsopilionoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12955; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/acropsopilionoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Acropsopilionoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acropsopilionoidea_audio", "species.arthropoda.arachnida.acropsopilionoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acropsopilionoidea_data", "species.arthropoda.arachnida.acropsopilionoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acropsopilionoidea_graphics", "species.arthropoda.arachnida.acropsopilionoidea.graphics.spectrum", sb.toString());
        }
    }
}