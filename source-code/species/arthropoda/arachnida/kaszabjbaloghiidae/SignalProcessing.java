package species.arthropoda.arachnida.kaszabjbaloghiidae;
...
/**
 * Signal Processing for Family: Kaszabjbaloghiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/kaszabjbaloghiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13706; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/kaszabjbaloghiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Kaszabjbaloghiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kaszabjbaloghiidae_audio", "species.arthropoda.arachnida.kaszabjbaloghiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kaszabjbaloghiidae_data", "species.arthropoda.arachnida.kaszabjbaloghiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kaszabjbaloghiidae_graphics", "species.arthropoda.arachnida.kaszabjbaloghiidae.graphics.spectrum", sb.toString());
        }
    }
}