package species.arthropoda.arachnida.xenocaligonellididae;
...
/**
 * Signal Processing for Family: Xenocaligonellididae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Eleutherengona</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/xenocaligonellididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13574; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/xenocaligonellididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Xenocaligonellididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xenocaligonellididae_audio", "species.arthropoda.arachnida.xenocaligonellididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xenocaligonellididae_data", "species.arthropoda.arachnida.xenocaligonellididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xenocaligonellididae_graphics", "species.arthropoda.arachnida.xenocaligonellididae.graphics.spectrum", sb.toString());
        }
    }
}