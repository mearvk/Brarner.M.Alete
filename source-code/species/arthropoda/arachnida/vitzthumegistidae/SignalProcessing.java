package species.arthropoda.arachnida.vitzthumegistidae;
...
/**
 * Signal Processing for Family: Vitzthumegistidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Cercomegistina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/vitzthumegistidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13769; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/vitzthumegistidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Vitzthumegistidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("vitzthumegistidae_audio", "species.arthropoda.arachnida.vitzthumegistidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("vitzthumegistidae_data", "species.arthropoda.arachnida.vitzthumegistidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("vitzthumegistidae_graphics", "species.arthropoda.arachnida.vitzthumegistidae.graphics.spectrum", sb.toString());
        }
    }
}