package species.arthropoda.arachnida.klinckowstroemiidae;
...
/**
 * Signal Processing for Family: Klinckowstroemiidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Antennophorina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/klinckowstroemiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13752; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/klinckowstroemiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Klinckowstroemiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("klinckowstroemiidae_audio", "species.arthropoda.arachnida.klinckowstroemiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("klinckowstroemiidae_data", "species.arthropoda.arachnida.klinckowstroemiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("klinckowstroemiidae_graphics", "species.arthropoda.arachnida.klinckowstroemiidae.graphics.spectrum", sb.toString());
        }
    }
}