package species.arthropoda.arachnida.ameronothroidea;
...
/**
 * Signal Processing for Family: Ameronothroidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/ameronothroidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13277; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/ameronothroidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Ameronothroidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ameronothroidea_audio", "species.arthropoda.arachnida.ameronothroidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ameronothroidea_data", "species.arthropoda.arachnida.ameronothroidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ameronothroidea_graphics", "species.arthropoda.arachnida.ameronothroidea.graphics.spectrum", sb.toString());
        }
    }
}