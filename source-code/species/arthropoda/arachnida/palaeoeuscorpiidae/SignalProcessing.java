package species.arthropoda.arachnida.palaeoeuscorpiidae;
...
/**
 * Signal Processing for Family: Palaeoeuscorpiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/palaeoeuscorpiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13073; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/palaeoeuscorpiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Palaeoeuscorpiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("palaeoeuscorpiidae_audio", "species.arthropoda.arachnida.palaeoeuscorpiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("palaeoeuscorpiidae_data", "species.arthropoda.arachnida.palaeoeuscorpiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("palaeoeuscorpiidae_graphics", "species.arthropoda.arachnida.palaeoeuscorpiidae.graphics.spectrum", sb.toString());
        }
    }
}