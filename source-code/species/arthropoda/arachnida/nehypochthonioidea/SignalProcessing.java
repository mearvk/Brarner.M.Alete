package species.arthropoda.arachnida.nehypochthonioidea;
...
/**
 * Signal Processing for Family: Nehypochthonioidea
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Mixonomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/nehypochthonioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13407; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/nehypochthonioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Nehypochthonioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nehypochthonioidea_audio", "species.arthropoda.arachnida.nehypochthonioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nehypochthonioidea_data", "species.arthropoda.arachnida.nehypochthonioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nehypochthonioidea_graphics", "species.arthropoda.arachnida.nehypochthonioidea.graphics.spectrum", sb.toString());
        }
    }
}