package species.arthropoda.arachnida.palaeoburmesebuthidae;
...
/**
 * Signal Processing for Family: Palaeoburmesebuthidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Scorpiones</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/palaeoburmesebuthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13064; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/palaeoburmesebuthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Palaeoburmesebuthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("palaeoburmesebuthidae_audio", "species.arthropoda.arachnida.palaeoburmesebuthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("palaeoburmesebuthidae_data", "species.arthropoda.arachnida.palaeoburmesebuthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("palaeoburmesebuthidae_graphics", "species.arthropoda.arachnida.palaeoburmesebuthidae.graphics.spectrum", sb.toString());
        }
    }
}