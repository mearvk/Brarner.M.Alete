package species.arthropoda.arachnida.pseudotyrannochthoniidae;
...
/**
 * Signal Processing for Family: Pseudotyrannochthoniidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Heterosphyronida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/pseudotyrannochthoniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13018; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/pseudotyrannochthoniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Pseudotyrannochthoniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudotyrannochthoniidae_audio", "species.arthropoda.arachnida.pseudotyrannochthoniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudotyrannochthoniidae_data", "species.arthropoda.arachnida.pseudotyrannochthoniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudotyrannochthoniidae_graphics", "species.arthropoda.arachnida.pseudotyrannochthoniidae.graphics.spectrum", sb.toString());
        }
    }
}