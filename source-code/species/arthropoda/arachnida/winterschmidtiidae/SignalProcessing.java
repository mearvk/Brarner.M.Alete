package species.arthropoda.arachnida.winterschmidtiidae;
...
/**
 * Signal Processing for Family: Winterschmidtiidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Astigmata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/winterschmidtiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13159; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/winterschmidtiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Winterschmidtiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("winterschmidtiidae_audio", "species.arthropoda.arachnida.winterschmidtiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("winterschmidtiidae_data", "species.arthropoda.arachnida.winterschmidtiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("winterschmidtiidae_graphics", "species.arthropoda.arachnida.winterschmidtiidae.graphics.spectrum", sb.toString());
        }
    }
}