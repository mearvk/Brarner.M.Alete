package species.arthropoda.arachnida.ichthyostomatogasteridae;
...
/**
 * Signal Processing for Family: Ichthyostomatogasteridae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Sejida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/ichthyostomatogasteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13730; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/ichthyostomatogasteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Ichthyostomatogasteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ichthyostomatogasteridae_audio", "species.arthropoda.arachnida.ichthyostomatogasteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ichthyostomatogasteridae_data", "species.arthropoda.arachnida.ichthyostomatogasteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ichthyostomatogasteridae_graphics", "species.arthropoda.arachnida.ichthyostomatogasteridae.graphics.spectrum", sb.toString());
        }
    }
}