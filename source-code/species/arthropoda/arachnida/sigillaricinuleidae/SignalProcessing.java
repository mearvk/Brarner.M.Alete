package species.arthropoda.arachnida.sigillaricinuleidae;
...
/**
 * Signal Processing for Family: Sigillaricinuleidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Primoricinulei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/sigillaricinuleidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13053; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/sigillaricinuleidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Sigillaricinuleidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sigillaricinuleidae_audio", "species.arthropoda.arachnida.sigillaricinuleidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sigillaricinuleidae_data", "species.arthropoda.arachnida.sigillaricinuleidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sigillaricinuleidae_graphics", "species.arthropoda.arachnida.sigillaricinuleidae.graphics.spectrum", sb.toString());
        }
    }
}