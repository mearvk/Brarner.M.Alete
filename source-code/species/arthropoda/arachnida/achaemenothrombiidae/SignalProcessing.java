package species.arthropoda.arachnida.achaemenothrombiidae;
...
/**
 * Signal Processing for Family: Achaemenothrombiidae
 * <p>Phylum: Arthropoda | Class: Arachnida | Order: Anystina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/achaemenothrombiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13533; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/achaemenothrombiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Achaemenothrombiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("achaemenothrombiidae_audio", "species.arthropoda.arachnida.achaemenothrombiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("achaemenothrombiidae_data", "species.arthropoda.arachnida.achaemenothrombiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("achaemenothrombiidae_graphics", "species.arthropoda.arachnida.achaemenothrombiidae.graphics.spectrum", sb.toString());
        }
    }
}