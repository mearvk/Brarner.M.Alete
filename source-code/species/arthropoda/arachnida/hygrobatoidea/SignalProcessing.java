package species.arthropoda.arachnida.hygrobatoidea;
...
/**
 * Signal Processing for Family: Hygrobatoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/arachnida/hygrobatoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13491; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/arachnida/hygrobatoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Arachnida"); ps.setString(3, "Hygrobatoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hygrobatoidea_audio", "species.arthropoda.arachnida.hygrobatoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hygrobatoidea_data", "species.arthropoda.arachnida.hygrobatoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hygrobatoidea_graphics", "species.arthropoda.arachnida.hygrobatoidea.graphics.spectrum", sb.toString());
        }
    }
}