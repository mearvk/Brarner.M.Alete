package species.arthropoda.eumalacostraca.metacrangonyctidae;
...
/**
 * Signal Processing for Family: Metacrangonyctidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Hadziida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/metacrangonyctidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14510; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/metacrangonyctidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Metacrangonyctidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("metacrangonyctidae_audio", "species.arthropoda.eumalacostraca.metacrangonyctidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("metacrangonyctidae_data", "species.arthropoda.eumalacostraca.metacrangonyctidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("metacrangonyctidae_graphics", "species.arthropoda.eumalacostraca.metacrangonyctidae.graphics.spectrum", sb.toString());
        }
    }
}