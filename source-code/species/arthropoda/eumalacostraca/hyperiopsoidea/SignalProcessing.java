package species.arthropoda.eumalacostraca.hyperiopsoidea;
...
/**
 * Signal Processing for Family: Hyperiopsoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Hyperiopsidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/hyperiopsoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14405; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/hyperiopsoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Hyperiopsoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hyperiopsoidea_audio", "species.arthropoda.eumalacostraca.hyperiopsoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hyperiopsoidea_data", "species.arthropoda.eumalacostraca.hyperiopsoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hyperiopsoidea_graphics", "species.arthropoda.eumalacostraca.hyperiopsoidea.graphics.spectrum", sb.toString());
        }
    }
}