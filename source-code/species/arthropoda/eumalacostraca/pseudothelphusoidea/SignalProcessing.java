package species.arthropoda.eumalacostraca.pseudothelphusoidea;
...
/**
 * Signal Processing for Family: Pseudothelphusoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Brachyura</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/pseudothelphusoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14198; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/pseudothelphusoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Pseudothelphusoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudothelphusoidea_audio", "species.arthropoda.eumalacostraca.pseudothelphusoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudothelphusoidea_data", "species.arthropoda.eumalacostraca.pseudothelphusoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudothelphusoidea_graphics", "species.arthropoda.eumalacostraca.pseudothelphusoidea.graphics.spectrum", sb.toString());
        }
    }
}