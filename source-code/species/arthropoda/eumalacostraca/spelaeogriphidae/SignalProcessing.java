package species.arthropoda.eumalacostraca.spelaeogriphidae;
...
/**
 * Signal Processing for Family: Spelaeogriphidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Spelaeogriphacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/spelaeogriphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14680; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/spelaeogriphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Spelaeogriphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spelaeogriphidae_audio", "species.arthropoda.eumalacostraca.spelaeogriphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spelaeogriphidae_data", "species.arthropoda.eumalacostraca.spelaeogriphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spelaeogriphidae_graphics", "species.arthropoda.eumalacostraca.spelaeogriphidae.graphics.spectrum", sb.toString());
        }
    }
}