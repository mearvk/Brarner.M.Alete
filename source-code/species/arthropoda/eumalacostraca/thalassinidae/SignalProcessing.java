package species.arthropoda.eumalacostraca.thalassinidae;
...
/**
 * Signal Processing for Family: Thalassinidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Gebiidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/thalassinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14269; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/thalassinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Thalassinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thalassinidae_audio", "species.arthropoda.eumalacostraca.thalassinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thalassinidae_data", "species.arthropoda.eumalacostraca.thalassinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thalassinidae_graphics", "species.arthropoda.eumalacostraca.thalassinidae.graphics.spectrum", sb.toString());
        }
    }
}