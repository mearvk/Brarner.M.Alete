package species.arthropoda.eumalacostraca.hypsimetopodidae;
...
/**
 * Signal Processing for Family: Hypsimetopodidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Phreatoicidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/hypsimetopodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14659; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/hypsimetopodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Hypsimetopodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hypsimetopodidae_audio", "species.arthropoda.eumalacostraca.hypsimetopodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hypsimetopodidae_data", "species.arthropoda.eumalacostraca.hypsimetopodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hypsimetopodidae_graphics", "species.arthropoda.eumalacostraca.hypsimetopodidae.graphics.spectrum", sb.toString());
        }
    }
}