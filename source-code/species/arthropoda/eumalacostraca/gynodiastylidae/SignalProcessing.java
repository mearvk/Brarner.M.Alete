package species.arthropoda.eumalacostraca.gynodiastylidae;
...
/**
 * Signal Processing for Family: Gynodiastylidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Cumacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/gynodiastylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14534; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/gynodiastylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Gynodiastylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gynodiastylidae_audio", "species.arthropoda.eumalacostraca.gynodiastylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gynodiastylidae_data", "species.arthropoda.eumalacostraca.gynodiastylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gynodiastylidae_graphics", "species.arthropoda.eumalacostraca.gynodiastylidae.graphics.spectrum", sb.toString());
        }
    }
}