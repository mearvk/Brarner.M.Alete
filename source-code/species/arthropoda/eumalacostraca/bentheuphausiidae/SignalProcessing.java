package species.arthropoda.eumalacostraca.bentheuphausiidae;
...
/**
 * Signal Processing for Family: Bentheuphausiidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Euphausiacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/bentheuphausiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14280; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/bentheuphausiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Bentheuphausiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bentheuphausiidae_audio", "species.arthropoda.eumalacostraca.bentheuphausiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bentheuphausiidae_data", "species.arthropoda.eumalacostraca.bentheuphausiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bentheuphausiidae_graphics", "species.arthropoda.eumalacostraca.bentheuphausiidae.graphics.spectrum", sb.toString());
        }
    }
}