package species.arthropoda.eumalacostraca.temnophliantidae;
...
/**
 * Signal Processing for Family: Temnophliantidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Talitrida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/temnophliantidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14530; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/temnophliantidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Temnophliantidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("temnophliantidae_audio", "species.arthropoda.eumalacostraca.temnophliantidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("temnophliantidae_data", "species.arthropoda.eumalacostraca.temnophliantidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("temnophliantidae_graphics", "species.arthropoda.eumalacostraca.temnophliantidae.graphics.spectrum", sb.toString());
        }
    }
}