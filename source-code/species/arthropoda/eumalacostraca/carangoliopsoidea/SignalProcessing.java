package species.arthropoda.eumalacostraca.carangoliopsoidea;
...
/**
 * Signal Processing for Family: Carangoliopsoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Carangoliopsida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/carangoliopsoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14418; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/carangoliopsoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Carangoliopsoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("carangoliopsoidea_audio", "species.arthropoda.eumalacostraca.carangoliopsoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("carangoliopsoidea_data", "species.arthropoda.eumalacostraca.carangoliopsoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("carangoliopsoidea_graphics", "species.arthropoda.eumalacostraca.carangoliopsoidea.graphics.spectrum", sb.toString());
        }
    }
}