package species.arthropoda.eumalacostraca.cryptoniscoidea;
...
/**
 * Signal Processing for Family: Cryptoniscoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Epicaridea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/cryptoniscoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14587; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/cryptoniscoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Cryptoniscoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cryptoniscoidea_audio", "species.arthropoda.eumalacostraca.cryptoniscoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cryptoniscoidea_data", "species.arthropoda.eumalacostraca.cryptoniscoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cryptoniscoidea_graphics", "species.arthropoda.eumalacostraca.cryptoniscoidea.graphics.spectrum", sb.toString());
        }
    }
}