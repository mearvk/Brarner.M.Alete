package species.arthropoda.eumalacostraca.anthracocarididae;
...
/**
 * Signal Processing for Family: Anthracocarididae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Anthracocaridomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/anthracocarididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14683; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/anthracocarididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Anthracocarididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anthracocarididae_audio", "species.arthropoda.eumalacostraca.anthracocarididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anthracocarididae_data", "species.arthropoda.eumalacostraca.anthracocarididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anthracocarididae_graphics", "species.arthropoda.eumalacostraca.anthracocarididae.graphics.spectrum", sb.toString());
        }
    }
}