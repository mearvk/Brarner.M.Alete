package species.arthropoda.eumalacostraca.metaingolfielloidea;
...
/**
 * Signal Processing for Family: Metaingolfielloidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Ingolfiellidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/metaingolfielloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14541; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/metaingolfielloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Metaingolfielloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("metaingolfielloidea_audio", "species.arthropoda.eumalacostraca.metaingolfielloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("metaingolfielloidea_data", "species.arthropoda.eumalacostraca.metaingolfielloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("metaingolfielloidea_graphics", "species.arthropoda.eumalacostraca.metaingolfielloidea.graphics.spectrum", sb.toString());
        }
    }
}