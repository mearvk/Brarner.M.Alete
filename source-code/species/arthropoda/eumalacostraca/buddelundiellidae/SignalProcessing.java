package species.arthropoda.eumalacostraca.buddelundiellidae;
...
/**
 * Signal Processing for Family: Buddelundiellidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Ligiamorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/buddelundiellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14655; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/buddelundiellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Buddelundiellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("buddelundiellidae_audio", "species.arthropoda.eumalacostraca.buddelundiellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("buddelundiellidae_data", "species.arthropoda.eumalacostraca.buddelundiellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("buddelundiellidae_graphics", "species.arthropoda.eumalacostraca.buddelundiellidae.graphics.spectrum", sb.toString());
        }
    }
}