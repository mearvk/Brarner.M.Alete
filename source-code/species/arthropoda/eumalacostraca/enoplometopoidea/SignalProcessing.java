package species.arthropoda.eumalacostraca.enoplometopoidea;
...
/**
 * Signal Processing for Family: Enoplometopoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Astacidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/enoplometopoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14100; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/enoplometopoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Enoplometopoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("enoplometopoidea_audio", "species.arthropoda.eumalacostraca.enoplometopoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("enoplometopoidea_data", "species.arthropoda.eumalacostraca.enoplometopoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("enoplometopoidea_graphics", "species.arthropoda.eumalacostraca.enoplometopoidea.graphics.spectrum", sb.toString());
        }
    }
}