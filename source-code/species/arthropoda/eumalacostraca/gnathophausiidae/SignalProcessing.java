package species.arthropoda.eumalacostraca.gnathophausiidae;
...
/**
 * Signal Processing for Family: Gnathophausiidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Lophogastrida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/gnathophausiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14674; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/gnathophausiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Gnathophausiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gnathophausiidae_audio", "species.arthropoda.eumalacostraca.gnathophausiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gnathophausiidae_data", "species.arthropoda.eumalacostraca.gnathophausiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gnathophausiidae_graphics", "species.arthropoda.eumalacostraca.gnathophausiidae.graphics.spectrum", sb.toString());
        }
    }
}