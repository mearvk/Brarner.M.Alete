package species.arthropoda.eumalacostraca.austrarcturellidae;
...
/**
 * Signal Processing for Family: Austrarcturellidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Valvifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/austrarcturellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14665; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/austrarcturellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Austrarcturellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("austrarcturellidae_audio", "species.arthropoda.eumalacostraca.austrarcturellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("austrarcturellidae_data", "species.arthropoda.eumalacostraca.austrarcturellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("austrarcturellidae_graphics", "species.arthropoda.eumalacostraca.austrarcturellidae.graphics.spectrum", sb.toString());
        }
    }
}