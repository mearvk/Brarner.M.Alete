package species.arthropoda.eumalacostraca.tanzanapseudidae;
...
/**
 * Signal Processing for Family: Tanzanapseudidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Apseudomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/tanzanapseudidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14693; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/tanzanapseudidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Tanzanapseudidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tanzanapseudidae_audio", "species.arthropoda.eumalacostraca.tanzanapseudidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tanzanapseudidae_data", "species.arthropoda.eumalacostraca.tanzanapseudidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tanzanapseudidae_graphics", "species.arthropoda.eumalacostraca.tanzanapseudidae.graphics.spectrum", sb.toString());
        }
    }
}