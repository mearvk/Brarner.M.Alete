package species.arthropoda.eumalacostraca.pseudingolfielloidea;
...
/**
 * Signal Processing for Family: Pseudingolfielloidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Pseudingolfiellidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/pseudingolfielloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14410; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/pseudingolfielloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Pseudingolfielloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudingolfielloidea_audio", "species.arthropoda.eumalacostraca.pseudingolfielloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudingolfielloidea_data", "species.arthropoda.eumalacostraca.pseudingolfielloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudingolfielloidea_graphics", "species.arthropoda.eumalacostraca.pseudingolfielloidea.graphics.spectrum", sb.toString());
        }
    }
}