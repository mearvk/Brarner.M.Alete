package species.arthropoda.eumalacostraca.acanthonotozomellidae;
...
/**
 * Signal Processing for Family: Acanthonotozomellidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Amphilochida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/acanthonotozomellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14299; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/acanthonotozomellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Acanthonotozomellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthonotozomellidae_audio", "species.arthropoda.eumalacostraca.acanthonotozomellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthonotozomellidae_data", "species.arthropoda.eumalacostraca.acanthonotozomellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthonotozomellidae_graphics", "species.arthropoda.eumalacostraca.acanthonotozomellidae.graphics.spectrum", sb.toString());
        }
    }
}