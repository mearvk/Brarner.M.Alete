package species.arthropoda.eumalacostraca.australomicroprotopidae;
...
/**
 * Signal Processing for Family: Australomicroprotopidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Corophiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/australomicroprotopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14445; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/australomicroprotopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Australomicroprotopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("australomicroprotopidae_audio", "species.arthropoda.eumalacostraca.australomicroprotopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("australomicroprotopidae_data", "species.arthropoda.eumalacostraca.australomicroprotopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("australomicroprotopidae_graphics", "species.arthropoda.eumalacostraca.australomicroprotopidae.graphics.spectrum", sb.toString());
        }
    }
}