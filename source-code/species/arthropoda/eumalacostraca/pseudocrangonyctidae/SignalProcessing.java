package species.arthropoda.eumalacostraca.pseudocrangonyctidae;
...
/**
 * Signal Processing for Family: Pseudocrangonyctidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Gammarida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/pseudocrangonyctidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14471; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/pseudocrangonyctidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Pseudocrangonyctidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudocrangonyctidae_audio", "species.arthropoda.eumalacostraca.pseudocrangonyctidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudocrangonyctidae_data", "species.arthropoda.eumalacostraca.pseudocrangonyctidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudocrangonyctidae_graphics", "species.arthropoda.eumalacostraca.pseudocrangonyctidae.graphics.spectrum", sb.toString());
        }
    }
}