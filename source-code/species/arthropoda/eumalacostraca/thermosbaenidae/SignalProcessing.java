package species.arthropoda.eumalacostraca.thermosbaenidae;
...
/**
 * Signal Processing for Family: Thermosbaenidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Thermosbaenacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/thermosbaenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14711; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/thermosbaenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Thermosbaenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thermosbaenidae_audio", "species.arthropoda.eumalacostraca.thermosbaenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thermosbaenidae_data", "species.arthropoda.eumalacostraca.thermosbaenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thermosbaenidae_graphics", "species.arthropoda.eumalacostraca.thermosbaenidae.graphics.spectrum", sb.toString());
        }
    }
}