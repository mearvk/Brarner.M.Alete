package species.arthropoda.eumalacostraca.benthesicymidae;
...
/**
 * Signal Processing for Family: Benthesicymidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Dendrobranchiata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/benthesicymidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14056; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/benthesicymidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Benthesicymidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("benthesicymidae_audio", "species.arthropoda.eumalacostraca.benthesicymidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("benthesicymidae_data", "species.arthropoda.eumalacostraca.benthesicymidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("benthesicymidae_graphics", "species.arthropoda.eumalacostraca.benthesicymidae.graphics.spectrum", sb.toString());
        }
    }
}