package species.arthropoda.eumalacostraca.bathypalaemonellidae;
...
/**
 * Signal Processing for Family: Bathypalaemonellidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Caridea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/bathypalaemonellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14236; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/bathypalaemonellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Bathypalaemonellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathypalaemonellidae_audio", "species.arthropoda.eumalacostraca.bathypalaemonellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathypalaemonellidae_data", "species.arthropoda.eumalacostraca.bathypalaemonellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathypalaemonellidae_graphics", "species.arthropoda.eumalacostraca.bathypalaemonellidae.graphics.spectrum", sb.toString());
        }
    }
}