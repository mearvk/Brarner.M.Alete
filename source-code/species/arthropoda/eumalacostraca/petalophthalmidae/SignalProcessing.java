package species.arthropoda.eumalacostraca.petalophthalmidae;
...
/**
 * Signal Processing for Family: Petalophthalmidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Mysida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/petalophthalmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14679; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/petalophthalmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Petalophthalmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("petalophthalmidae_audio", "species.arthropoda.eumalacostraca.petalophthalmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("petalophthalmidae_data", "species.arthropoda.eumalacostraca.petalophthalmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("petalophthalmidae_graphics", "species.arthropoda.eumalacostraca.petalophthalmidae.graphics.spectrum", sb.toString());
        }
    }
}