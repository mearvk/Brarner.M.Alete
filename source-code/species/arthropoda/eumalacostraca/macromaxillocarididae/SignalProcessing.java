package species.arthropoda.eumalacostraca.macromaxillocarididae;
...
/**
 * Signal Processing for Family: Macromaxillocarididae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Stenopodidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/macromaxillocarididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14277; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/macromaxillocarididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Macromaxillocarididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("macromaxillocarididae_audio", "species.arthropoda.eumalacostraca.macromaxillocarididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("macromaxillocarididae_data", "species.arthropoda.eumalacostraca.macromaxillocarididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("macromaxillocarididae_graphics", "species.arthropoda.eumalacostraca.macromaxillocarididae.graphics.spectrum", sb.toString());
        }
    }
}