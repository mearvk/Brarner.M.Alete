package species.arthropoda.eumalacostraca.colomastigoidea;
...
/**
 * Signal Processing for Family: Colomastigoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Colomastigidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/colomastigoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14370; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/colomastigoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Colomastigoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("colomastigoidea_audio", "species.arthropoda.eumalacostraca.colomastigoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("colomastigoidea_data", "species.arthropoda.eumalacostraca.colomastigoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("colomastigoidea_graphics", "species.arthropoda.eumalacostraca.colomastigoidea.graphics.spectrum", sb.toString());
        }
    }
}