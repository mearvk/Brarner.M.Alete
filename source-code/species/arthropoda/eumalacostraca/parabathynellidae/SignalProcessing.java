package species.arthropoda.eumalacostraca.parabathynellidae;
...
/**
 * Signal Processing for Family: Parabathynellidae
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Bathynellacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/parabathynellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14718; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/parabathynellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Parabathynellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parabathynellidae_audio", "species.arthropoda.eumalacostraca.parabathynellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parabathynellidae_data", "species.arthropoda.eumalacostraca.parabathynellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parabathynellidae_graphics", "species.arthropoda.eumalacostraca.parabathynellidae.graphics.spectrum", sb.toString());
        }
    }
}