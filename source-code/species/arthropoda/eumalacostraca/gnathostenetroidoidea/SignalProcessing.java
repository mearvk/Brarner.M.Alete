package species.arthropoda.eumalacostraca.gnathostenetroidoidea;
...
/**
 * Signal Processing for Family: Gnathostenetroidoidea
 * <p>Phylum: Arthropoda | Class: Eumalacostraca | Order: Asellota</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/eumalacostraca/gnathostenetroidoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14552; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/eumalacostraca/gnathostenetroidoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Eumalacostraca"); ps.setString(3, "Gnathostenetroidoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gnathostenetroidoidea_audio", "species.arthropoda.eumalacostraca.gnathostenetroidoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gnathostenetroidoidea_data", "species.arthropoda.eumalacostraca.gnathostenetroidoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gnathostenetroidoidea_graphics", "species.arthropoda.eumalacostraca.gnathostenetroidoidea.graphics.spectrum", sb.toString());
        }
    }
}