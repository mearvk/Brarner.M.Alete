package species.arthropoda.pleurostigmophora.gonibregmatidae;
...
/**
 * Signal Processing for Family: Gonibregmatidae
 * <p>Phylum: Arthropoda | Class: Pleurostigmophora | Order: Adesmata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/gonibregmatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16175; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/gonibregmatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Gonibregmatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gonibregmatidae_audio", "species.arthropoda.pleurostigmophora.gonibregmatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gonibregmatidae_data", "species.arthropoda.pleurostigmophora.gonibregmatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gonibregmatidae_graphics", "species.arthropoda.pleurostigmophora.gonibregmatidae.graphics.spectrum", sb.toString());
        }
    }
}