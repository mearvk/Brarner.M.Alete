package species.arthropoda.pleurostigmophora.scolopocryptopidae;
...
/**
 * Signal Processing for Family: Scolopocryptopidae
 * <p>Phylum: Arthropoda | Class: Pleurostigmophora | Order: Scolopendromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/scolopocryptopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16188; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/scolopocryptopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Scolopocryptopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scolopocryptopidae_audio", "species.arthropoda.pleurostigmophora.scolopocryptopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scolopocryptopidae_data", "species.arthropoda.pleurostigmophora.scolopocryptopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scolopocryptopidae_graphics", "species.arthropoda.pleurostigmophora.scolopocryptopidae.graphics.spectrum", sb.toString());
        }
    }
}