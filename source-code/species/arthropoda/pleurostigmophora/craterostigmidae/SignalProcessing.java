package species.arthropoda.pleurostigmophora.craterostigmidae;
...
/**
 * Signal Processing for Family: Craterostigmidae
 * <p>Phylum: Arthropoda | Class: Pleurostigmophora | Order: Craterostigmomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/craterostigmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16172; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/craterostigmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Craterostigmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("craterostigmidae_audio", "species.arthropoda.pleurostigmophora.craterostigmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("craterostigmidae_data", "species.arthropoda.pleurostigmophora.craterostigmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("craterostigmidae_graphics", "species.arthropoda.pleurostigmophora.craterostigmidae.graphics.spectrum", sb.toString());
        }
    }
}