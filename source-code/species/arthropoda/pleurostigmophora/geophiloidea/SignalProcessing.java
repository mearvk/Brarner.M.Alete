package species.arthropoda.pleurostigmophora.geophiloidea;
...
/**
 * Signal Processing for Family: Geophiloidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/geophiloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16173; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/geophiloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Geophiloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("geophiloidea_audio", "species.arthropoda.pleurostigmophora.geophiloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("geophiloidea_data", "species.arthropoda.pleurostigmophora.geophiloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("geophiloidea_graphics", "species.arthropoda.pleurostigmophora.geophiloidea.graphics.spectrum", sb.toString());
        }
    }
}