package species.arthropoda.pleurostigmophora.henicopidae;
...
/**
 * Signal Processing for Family: Henicopidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/henicopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16182; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/henicopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Henicopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("henicopidae_audio", "species.arthropoda.pleurostigmophora.henicopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("henicopidae_data", "species.arthropoda.pleurostigmophora.henicopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("henicopidae_graphics", "species.arthropoda.pleurostigmophora.henicopidae.graphics.spectrum", sb.toString());
        }
    }
}