package species.arthropoda.pleurostigmophora.mecistocephalidae;
...
/**
 * Signal Processing for Family: Mecistocephalidae
 * <p>Phylum: Arthropoda | Class: Pleurostigmophora | Order: Placodesmata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pleurostigmophora/mecistocephalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16181; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pleurostigmophora/mecistocephalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pleurostigmophora"); ps.setString(3, "Mecistocephalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mecistocephalidae_audio", "species.arthropoda.pleurostigmophora.mecistocephalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mecistocephalidae_data", "species.arthropoda.pleurostigmophora.mecistocephalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mecistocephalidae_graphics", "species.arthropoda.pleurostigmophora.mecistocephalidae.graphics.spectrum", sb.toString());
        }
    }
}