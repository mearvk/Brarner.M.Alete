package species.arthropoda.cirripedia.pollicipedidae;
...
/**
 * Signal Processing for Family: Pollicipedidae
 * <p>Phylum: Arthropoda | Class: Cirripedia | Order: Scalpellomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/pollicipedidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14797; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/pollicipedidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Pollicipedidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pollicipedidae_audio", "species.arthropoda.cirripedia.pollicipedidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pollicipedidae_data", "species.arthropoda.cirripedia.pollicipedidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pollicipedidae_graphics", "species.arthropoda.cirripedia.pollicipedidae.graphics.spectrum", sb.toString());
        }
    }
}