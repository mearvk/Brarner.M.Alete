package species.arthropoda.cirripedia.koleolepadidae;
...
/**
 * Signal Processing for Family: Koleolepadidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/koleolepadidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14787; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/koleolepadidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Koleolepadidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("koleolepadidae_audio", "species.arthropoda.cirripedia.koleolepadidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("koleolepadidae_data", "species.arthropoda.cirripedia.koleolepadidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("koleolepadidae_graphics", "species.arthropoda.cirripedia.koleolepadidae.graphics.spectrum", sb.toString());
        }
    }
}