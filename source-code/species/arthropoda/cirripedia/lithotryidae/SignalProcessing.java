package species.arthropoda.cirripedia.lithotryidae;
...
/**
 * Signal Processing for Family: Lithotryidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/lithotryidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14796; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/lithotryidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Lithotryidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lithotryidae_audio", "species.arthropoda.cirripedia.lithotryidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lithotryidae_data", "species.arthropoda.cirripedia.lithotryidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lithotryidae_graphics", "species.arthropoda.cirripedia.lithotryidae.graphics.spectrum", sb.toString());
        }
    }
}