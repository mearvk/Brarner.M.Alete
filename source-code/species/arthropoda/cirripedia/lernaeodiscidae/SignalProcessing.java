package species.arthropoda.cirripedia.lernaeodiscidae;
...
/**
 * Signal Processing for Family: Lernaeodiscidae
 * <p>Phylum: Arthropoda | Class: Cirripedia | Order: Kentrogonida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/lernaeodiscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14782; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/lernaeodiscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Lernaeodiscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lernaeodiscidae_audio", "species.arthropoda.cirripedia.lernaeodiscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lernaeodiscidae_data", "species.arthropoda.cirripedia.lernaeodiscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lernaeodiscidae_graphics", "species.arthropoda.cirripedia.lernaeodiscidae.graphics.spectrum", sb.toString());
        }
    }
}