package species.arthropoda.cirripedia.coronulidae;
...
/**
 * Signal Processing for Family: Coronulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/coronulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14810; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/coronulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Coronulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("coronulidae_audio", "species.arthropoda.cirripedia.coronulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("coronulidae_data", "species.arthropoda.cirripedia.coronulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("coronulidae_graphics", "species.arthropoda.cirripedia.coronulidae.graphics.spectrum", sb.toString());
        }
    }
}