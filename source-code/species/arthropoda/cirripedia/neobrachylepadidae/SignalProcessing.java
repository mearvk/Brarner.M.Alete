package species.arthropoda.cirripedia.neobrachylepadidae;
...
/**
 * Signal Processing for Family: Neobrachylepadidae
 * <p>Phylum: Arthropoda | Class: Cirripedia | Order: Brachylepadomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cirripedia/neobrachylepadidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14817; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cirripedia/neobrachylepadidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cirripedia"); ps.setString(3, "Neobrachylepadidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neobrachylepadidae_audio", "species.arthropoda.cirripedia.neobrachylepadidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neobrachylepadidae_data", "species.arthropoda.cirripedia.neobrachylepadidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neobrachylepadidae_graphics", "species.arthropoda.cirripedia.neobrachylepadidae.graphics.spectrum", sb.toString());
        }
    }
}