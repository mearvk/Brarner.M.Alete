package species.arthropoda.insecta.meinertellidae;
...
/**
 * Signal Processing for Family: Meinertellidae
 * <p>Phylum: Arthropoda | Class: Insecta | Order: Archaeognatha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/insecta/meinertellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14968; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/insecta/meinertellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Insecta"); ps.setString(3, "Meinertellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("meinertellidae_audio", "species.arthropoda.insecta.meinertellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("meinertellidae_data", "species.arthropoda.insecta.meinertellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("meinertellidae_graphics", "species.arthropoda.insecta.meinertellidae.graphics.spectrum", sb.toString());
        }
    }
}