package species.arthropoda.insecta.lepidotrichidae;
...
/**
 * Signal Processing for Family: Lepidotrichidae
 * <p>Phylum: Arthropoda | Class: Insecta | Order: Zygentoma</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/insecta/lepidotrichidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14969; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/insecta/lepidotrichidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Insecta"); ps.setString(3, "Lepidotrichidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepidotrichidae_audio", "species.arthropoda.insecta.lepidotrichidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepidotrichidae_data", "species.arthropoda.insecta.lepidotrichidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepidotrichidae_graphics", "species.arthropoda.insecta.lepidotrichidae.graphics.spectrum", sb.toString());
        }
    }
}