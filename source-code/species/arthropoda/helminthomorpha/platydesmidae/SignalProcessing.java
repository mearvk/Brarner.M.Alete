package species.arthropoda.helminthomorpha.platydesmidae;
...
/**
 * Signal Processing for Family: Platydesmidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/platydesmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16222; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/platydesmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Platydesmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platydesmidae_audio", "species.arthropoda.helminthomorpha.platydesmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platydesmidae_data", "species.arthropoda.helminthomorpha.platydesmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platydesmidae_graphics", "species.arthropoda.helminthomorpha.platydesmidae.graphics.spectrum", sb.toString());
        }
    }
}