package species.arthropoda.helminthomorpha.heterochordeumatoidea;
...
/**
 * Signal Processing for Family: Heterochordeumatoidea
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Chordeumatidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/heterochordeumatoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16204; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/heterochordeumatoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Heterochordeumatoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heterochordeumatoidea_audio", "species.arthropoda.helminthomorpha.heterochordeumatoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heterochordeumatoidea_data", "species.arthropoda.helminthomorpha.heterochordeumatoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heterochordeumatoidea_graphics", "species.arthropoda.helminthomorpha.heterochordeumatoidea.graphics.spectrum", sb.toString());
        }
    }
}