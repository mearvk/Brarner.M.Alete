package species.arthropoda.helminthomorpha.schizopetalidae;
...
/**
 * Signal Processing for Family: Schizopetalidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Callipodida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/schizopetalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16191; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/schizopetalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Schizopetalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("schizopetalidae_audio", "species.arthropoda.helminthomorpha.schizopetalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("schizopetalidae_data", "species.arthropoda.helminthomorpha.schizopetalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("schizopetalidae_graphics", "species.arthropoda.helminthomorpha.schizopetalidae.graphics.spectrum", sb.toString());
        }
    }
}