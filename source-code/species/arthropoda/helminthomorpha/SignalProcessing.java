package species.arthropoda.helminthomorpha;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Helminthomorpha
 * <p>Families: 77</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16189; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_helminthomorpha_audio", "species.arthropoda.helminthomorpha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_helminthomorpha_data", "species.arthropoda.helminthomorpha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_helminthomorpha_graphics", "species.arthropoda.helminthomorpha.graphics.spectrum", sb.toString());
        }
    }
}