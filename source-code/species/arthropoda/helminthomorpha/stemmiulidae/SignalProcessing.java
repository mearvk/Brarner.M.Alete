package species.arthropoda.helminthomorpha.stemmiulidae;
...
/**
 * Signal Processing for Family: Stemmiulidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Stemmiulida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/stemmiulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16266; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/stemmiulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Stemmiulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("stemmiulidae_audio", "species.arthropoda.helminthomorpha.stemmiulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("stemmiulidae_data", "species.arthropoda.helminthomorpha.stemmiulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("stemmiulidae_graphics", "species.arthropoda.helminthomorpha.stemmiulidae.graphics.spectrum", sb.toString());
        }
    }
}