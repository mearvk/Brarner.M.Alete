package species.arthropoda.helminthomorpha.paradoxosomatidae;
...
/**
 * Signal Processing for Family: Paradoxosomatidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Paradoxosomatidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/paradoxosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16233; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/paradoxosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Paradoxosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paradoxosomatidae_audio", "species.arthropoda.helminthomorpha.paradoxosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paradoxosomatidae_data", "species.arthropoda.helminthomorpha.paradoxosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paradoxosomatidae_graphics", "species.arthropoda.helminthomorpha.paradoxosomatidae.graphics.spectrum", sb.toString());
        }
    }
}