package species.arthropoda.helminthomorpha.sphaeriodesmidae;
...
/**
 * Signal Processing for Family: Sphaeriodesmidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Chelodesmidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/sphaeriodesmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16230; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/sphaeriodesmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Sphaeriodesmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaeriodesmidae_audio", "species.arthropoda.helminthomorpha.sphaeriodesmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaeriodesmidae_data", "species.arthropoda.helminthomorpha.sphaeriodesmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaeriodesmidae_graphics", "species.arthropoda.helminthomorpha.sphaeriodesmidae.graphics.spectrum", sb.toString());
        }
    }
}