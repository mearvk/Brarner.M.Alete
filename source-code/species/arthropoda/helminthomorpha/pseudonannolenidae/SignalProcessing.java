package species.arthropoda.helminthomorpha.pseudonannolenidae;
...
/**
 * Signal Processing for Family: Pseudonannolenidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Epinannolenoidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/pseudonannolenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16264; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/pseudonannolenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Pseudonannolenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudonannolenidae_audio", "species.arthropoda.helminthomorpha.pseudonannolenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudonannolenidae_data", "species.arthropoda.helminthomorpha.pseudonannolenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudonannolenidae_graphics", "species.arthropoda.helminthomorpha.pseudonannolenidae.graphics.spectrum", sb.toString());
        }
    }
}