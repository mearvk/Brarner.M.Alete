package species.arthropoda.helminthomorpha.pseudospirobolellidae;
...
/**
 * Signal Processing for Family: Pseudospirobolellidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Spirobolida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/pseudospirobolellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16255; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/pseudospirobolellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Pseudospirobolellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudospirobolellidae_audio", "species.arthropoda.helminthomorpha.pseudospirobolellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudospirobolellidae_data", "species.arthropoda.helminthomorpha.pseudospirobolellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudospirobolellidae_graphics", "species.arthropoda.helminthomorpha.pseudospirobolellidae.graphics.spectrum", sb.toString());
        }
    }
}