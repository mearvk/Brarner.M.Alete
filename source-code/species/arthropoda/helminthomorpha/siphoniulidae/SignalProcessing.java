package species.arthropoda.helminthomorpha.siphoniulidae;
...
/**
 * Signal Processing for Family: Siphoniulidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Siphoniulida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/siphoniulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16247; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/siphoniulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Siphoniulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("siphoniulidae_audio", "species.arthropoda.helminthomorpha.siphoniulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("siphoniulidae_data", "species.arthropoda.helminthomorpha.siphoniulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("siphoniulidae_graphics", "species.arthropoda.helminthomorpha.siphoniulidae.graphics.spectrum", sb.toString());
        }
    }
}