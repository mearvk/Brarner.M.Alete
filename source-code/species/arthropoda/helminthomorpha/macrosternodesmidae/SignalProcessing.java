package species.arthropoda.helminthomorpha.macrosternodesmidae;
...
/**
 * Signal Processing for Family: Macrosternodesmidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Polydesmidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/macrosternodesmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16239; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/macrosternodesmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Macrosternodesmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("macrosternodesmidae_audio", "species.arthropoda.helminthomorpha.macrosternodesmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("macrosternodesmidae_data", "species.arthropoda.helminthomorpha.macrosternodesmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("macrosternodesmidae_graphics", "species.arthropoda.helminthomorpha.macrosternodesmidae.graphics.spectrum", sb.toString());
        }
    }
}