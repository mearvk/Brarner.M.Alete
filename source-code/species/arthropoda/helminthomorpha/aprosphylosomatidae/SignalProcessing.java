package species.arthropoda.helminthomorpha.aprosphylosomatidae;
...
/**
 * Signal Processing for Family: Aprosphylosomatidae
 * <p>Phylum: Arthropoda | Class: Helminthomorpha | Order: Julida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/helminthomorpha/aprosphylosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16217; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/helminthomorpha/aprosphylosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Helminthomorpha"); ps.setString(3, "Aprosphylosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aprosphylosomatidae_audio", "species.arthropoda.helminthomorpha.aprosphylosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aprosphylosomatidae_data", "species.arthropoda.helminthomorpha.aprosphylosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aprosphylosomatidae_graphics", "species.arthropoda.helminthomorpha.aprosphylosomatidae.graphics.spectrum", sb.toString());
        }
    }
}