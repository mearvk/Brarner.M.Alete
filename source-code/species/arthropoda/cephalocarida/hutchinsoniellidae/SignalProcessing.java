package species.arthropoda.cephalocarida.hutchinsoniellidae;
...
/**
 * Signal Processing for Family: Hutchinsoniellidae
 * <p>Phylum: Arthropoda | Class: Cephalocarida | Order: Brachypoda</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cephalocarida/hutchinsoniellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13825; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cephalocarida/hutchinsoniellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cephalocarida"); ps.setString(3, "Hutchinsoniellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hutchinsoniellidae_audio", "species.arthropoda.cephalocarida.hutchinsoniellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hutchinsoniellidae_data", "species.arthropoda.cephalocarida.hutchinsoniellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hutchinsoniellidae_graphics", "species.arthropoda.cephalocarida.hutchinsoniellidae.graphics.spectrum", sb.toString());
        }
    }
}