package species.arthropoda.cephalocarida;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Cephalocarida
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/cephalocarida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13824; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/cephalocarida";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Cephalocarida"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_cephalocarida_audio", "species.arthropoda.cephalocarida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_cephalocarida_data", "species.arthropoda.cephalocarida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_cephalocarida_graphics", "species.arthropoda.cephalocarida.graphics.spectrum", sb.toString());
        }
    }
}