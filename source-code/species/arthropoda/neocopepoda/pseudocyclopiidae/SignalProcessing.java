package species.arthropoda.neocopepoda.pseudocyclopiidae;
...
/**
 * Signal Processing for Family: Pseudocyclopiidae
 * <p>Phylum: Arthropoda | Class: Neocopepoda | Order: Calanoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/pseudocyclopiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13858; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/pseudocyclopiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Pseudocyclopiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudocyclopiidae_audio", "species.arthropoda.neocopepoda.pseudocyclopiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudocyclopiidae_data", "species.arthropoda.neocopepoda.pseudocyclopiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudocyclopiidae_graphics", "species.arthropoda.neocopepoda.pseudocyclopiidae.graphics.spectrum", sb.toString());
        }
    }
}