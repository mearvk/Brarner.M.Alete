package species.arthropoda.neocopepoda.spongiocnizontidae;
...
/**
 * Signal Processing for Family: Spongiocnizontidae
 * <p>Phylum: Arthropoda | Class: Neocopepoda | Order: Siphonostomatoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/spongiocnizontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/spongiocnizontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Spongiocnizontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spongiocnizontidae_audio", "species.arthropoda.neocopepoda.spongiocnizontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spongiocnizontidae_data", "species.arthropoda.neocopepoda.spongiocnizontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spongiocnizontidae_graphics", "species.arthropoda.neocopepoda.spongiocnizontidae.graphics.spectrum", sb.toString());
        }
    }
}