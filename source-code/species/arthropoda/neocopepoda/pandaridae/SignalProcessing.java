package species.arthropoda.neocopepoda.pandaridae;
...
/**
 * Signal Processing for Family: Pandaridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/pandaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14039; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/pandaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Pandaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pandaridae_audio", "species.arthropoda.neocopepoda.pandaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pandaridae_data", "species.arthropoda.neocopepoda.pandaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pandaridae_graphics", "species.arthropoda.neocopepoda.pandaridae.graphics.spectrum", sb.toString());
        }
    }
}