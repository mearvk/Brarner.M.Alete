package species.arthropoda.neocopepoda.splanchnotrophidae;
...
/**
 * Signal Processing for Family: Splanchnotrophidae
 * <p>Phylum: Arthropoda | Class: Neocopepoda | Order: Poecilostomatoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/splanchnotrophidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13996; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/splanchnotrophidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Splanchnotrophidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("splanchnotrophidae_audio", "species.arthropoda.neocopepoda.splanchnotrophidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("splanchnotrophidae_data", "species.arthropoda.neocopepoda.splanchnotrophidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("splanchnotrophidae_graphics", "species.arthropoda.neocopepoda.splanchnotrophidae.graphics.spectrum", sb.toString());
        }
    }
}