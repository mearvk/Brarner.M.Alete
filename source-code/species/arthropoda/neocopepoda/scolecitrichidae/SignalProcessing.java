package species.arthropoda.neocopepoda.scolecitrichidae;
...
/**
 * Signal Processing for Family: Scolecitrichidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/scolecitrichidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13863; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/scolecitrichidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Scolecitrichidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scolecitrichidae_audio", "species.arthropoda.neocopepoda.scolecitrichidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scolecitrichidae_data", "species.arthropoda.neocopepoda.scolecitrichidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scolecitrichidae_graphics", "species.arthropoda.neocopepoda.scolecitrichidae.graphics.spectrum", sb.toString());
        }
    }
}