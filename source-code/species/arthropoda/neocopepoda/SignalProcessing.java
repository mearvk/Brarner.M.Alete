package species.arthropoda.neocopepoda;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Neocopepoda
 * <p>Families: 224</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13826; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_neocopepoda_audio", "species.arthropoda.neocopepoda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_neocopepoda_data", "species.arthropoda.neocopepoda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_neocopepoda_graphics", "species.arthropoda.neocopepoda.graphics.spectrum", sb.toString());
        }
    }
}