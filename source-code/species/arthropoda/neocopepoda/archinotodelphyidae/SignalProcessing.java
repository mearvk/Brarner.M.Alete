package species.arthropoda.neocopepoda.archinotodelphyidae;
...
/**
 * Signal Processing for Family: Archinotodelphyidae
 * <p>Phylum: Arthropoda | Class: Neocopepoda | Order: Cyclopoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/archinotodelphyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13870; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/archinotodelphyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Archinotodelphyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("archinotodelphyidae_audio", "species.arthropoda.neocopepoda.archinotodelphyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("archinotodelphyidae_data", "species.arthropoda.neocopepoda.archinotodelphyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("archinotodelphyidae_graphics", "species.arthropoda.neocopepoda.archinotodelphyidae.graphics.spectrum", sb.toString());
        }
    }
}