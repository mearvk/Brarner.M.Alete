package species.arthropoda.neocopepoda.phyllognathopodidae;
...
/**
 * Signal Processing for Family: Phyllognathopodidae
 * <p>Phylum: Arthropoda | Class: Neocopepoda | Order: Harpacticoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neocopepoda/phyllognathopodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13930; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neocopepoda/phyllognathopodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neocopepoda"); ps.setString(3, "Phyllognathopodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phyllognathopodidae_audio", "species.arthropoda.neocopepoda.phyllognathopodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phyllognathopodidae_data", "species.arthropoda.neocopepoda.phyllognathopodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phyllognathopodidae_graphics", "species.arthropoda.neocopepoda.phyllognathopodidae.graphics.spectrum", sb.toString());
        }
    }
}