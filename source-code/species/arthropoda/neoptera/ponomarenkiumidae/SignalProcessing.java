package species.arthropoda.neoptera.ponomarenkiumidae;
...
/**
 * Signal Processing for Family: Ponomarenkiumidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Metaxycoleoptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/ponomarenkiumidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15301; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/ponomarenkiumidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Ponomarenkiumidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ponomarenkiumidae_audio", "species.arthropoda.neoptera.ponomarenkiumidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ponomarenkiumidae_data", "species.arthropoda.neoptera.ponomarenkiumidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ponomarenkiumidae_graphics", "species.arthropoda.neoptera.ponomarenkiumidae.graphics.spectrum", sb.toString());
        }
    }
}