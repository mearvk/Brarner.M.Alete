package species.arthropoda.neoptera.paraphrynoveliidae;
...
/**
 * Signal Processing for Family: Paraphrynoveliidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Gerromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/paraphrynoveliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/paraphrynoveliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Paraphrynoveliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paraphrynoveliidae_audio", "species.arthropoda.neoptera.paraphrynoveliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paraphrynoveliidae_data", "species.arthropoda.neoptera.paraphrynoveliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paraphrynoveliidae_graphics", "species.arthropoda.neoptera.paraphrynoveliidae.graphics.spectrum", sb.toString());
        }
    }
}