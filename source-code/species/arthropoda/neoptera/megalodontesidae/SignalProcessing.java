package species.arthropoda.neoptera.megalodontesidae;
...
/**
 * Signal Processing for Family: Megalodontesidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Symphyta</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/megalodontesidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15740; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/megalodontesidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Megalodontesidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("megalodontesidae_audio", "species.arthropoda.neoptera.megalodontesidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("megalodontesidae_data", "species.arthropoda.neoptera.megalodontesidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("megalodontesidae_graphics", "species.arthropoda.neoptera.megalodontesidae.graphics.spectrum", sb.toString());
        }
    }
}