package species.arthropoda.neoptera.trigonopterygoidea;
...
/**
 * Signal Processing for Family: Trigonopterygoidea
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Acrididea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/trigonopterygoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16060; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/trigonopterygoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Trigonopterygoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trigonopterygoidea_audio", "species.arthropoda.neoptera.trigonopterygoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trigonopterygoidea_data", "species.arthropoda.neoptera.trigonopterygoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trigonopterygoidea_graphics", "species.arthropoda.neoptera.trigonopterygoidea.graphics.spectrum", sb.toString());
        }
    }
}