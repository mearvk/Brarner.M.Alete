package species.arthropoda.neoptera.pseudophyllodromiidae;
...
/**
 * Signal Processing for Family: Pseudophyllodromiidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Blattodea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/pseudophyllodromiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15982; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/pseudophyllodromiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Pseudophyllodromiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudophyllodromiidae_audio", "species.arthropoda.neoptera.pseudophyllodromiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudophyllodromiidae_data", "species.arthropoda.neoptera.pseudophyllodromiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudophyllodromiidae_graphics", "species.arthropoda.neoptera.pseudophyllodromiidae.graphics.spectrum", sb.toString());
        }
    }
}