package species.arthropoda.neoptera.mogoplistidae;
...
/**
 * Signal Processing for Family: Mogoplistidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/mogoplistidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16080; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/mogoplistidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Mogoplistidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mogoplistidae_audio", "species.arthropoda.neoptera.mogoplistidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mogoplistidae_data", "species.arthropoda.neoptera.mogoplistidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mogoplistidae_graphics", "species.arthropoda.neoptera.mogoplistidae.graphics.spectrum", sb.toString());
        }
    }
}