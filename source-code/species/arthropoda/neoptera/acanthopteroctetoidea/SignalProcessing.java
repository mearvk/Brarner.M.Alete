package species.arthropoda.neoptera.acanthopteroctetoidea;
...
/**
 * Signal Processing for Family: Acanthopteroctetoidea
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Lepidoptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/acanthopteroctetoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15756; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/acanthopteroctetoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Acanthopteroctetoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthopteroctetoidea_audio", "species.arthropoda.neoptera.acanthopteroctetoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthopteroctetoidea_data", "species.arthropoda.neoptera.acanthopteroctetoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthopteroctetoidea_graphics", "species.arthropoda.neoptera.acanthopteroctetoidea.graphics.spectrum", sb.toString());
        }
    }
}