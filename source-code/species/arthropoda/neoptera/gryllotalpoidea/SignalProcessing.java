package species.arthropoda.neoptera.gryllotalpoidea;
...
/**
 * Signal Processing for Family: Gryllotalpoidea
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Gryllidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/gryllotalpoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16076; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/gryllotalpoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Gryllotalpoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gryllotalpoidea_audio", "species.arthropoda.neoptera.gryllotalpoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gryllotalpoidea_data", "species.arthropoda.neoptera.gryllotalpoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gryllotalpoidea_graphics", "species.arthropoda.neoptera.gryllotalpoidea.graphics.spectrum", sb.toString());
        }
    }
}