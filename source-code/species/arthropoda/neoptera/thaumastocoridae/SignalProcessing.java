package species.arthropoda.neoptera.thaumastocoridae;
...
/**
 * Signal Processing for Family: Thaumastocoridae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Cimicomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/thaumastocoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15023; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/thaumastocoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Thaumastocoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thaumastocoridae_audio", "species.arthropoda.neoptera.thaumastocoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thaumastocoridae_data", "species.arthropoda.neoptera.thaumastocoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thaumastocoridae_graphics", "species.arthropoda.neoptera.thaumastocoridae.graphics.spectrum", sb.toString());
        }
    }
}