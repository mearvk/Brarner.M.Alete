package species.arthropoda.neoptera.deuterophlebiidae;
...
/**
 * Signal Processing for Family: Deuterophlebiidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Blephariceromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/deuterophlebiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15611; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/deuterophlebiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Deuterophlebiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("deuterophlebiidae_audio", "species.arthropoda.neoptera.deuterophlebiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("deuterophlebiidae_data", "species.arthropoda.neoptera.deuterophlebiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("deuterophlebiidae_graphics", "species.arthropoda.neoptera.deuterophlebiidae.graphics.spectrum", sb.toString());
        }
    }
}