package species.arthropoda.neoptera.tanzaniophasmatidae;
...
/**
 * Signal Processing for Family: Tanzaniophasmatidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Mantophasmatodea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/tanzaniophasmatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16030; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/tanzaniophasmatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Tanzaniophasmatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tanzaniophasmatidae_audio", "species.arthropoda.neoptera.tanzaniophasmatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tanzaniophasmatidae_data", "species.arthropoda.neoptera.tanzaniophasmatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tanzaniophasmatidae_graphics", "species.arthropoda.neoptera.tanzaniophasmatidae.graphics.spectrum", sb.toString());
        }
    }
}