package species.arthropoda.neoptera.pseudocaeciliidae;
...
/**
 * Signal Processing for Family: Pseudocaeciliidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Homilopsocidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/pseudocaeciliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15225; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/pseudocaeciliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Pseudocaeciliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudocaeciliidae_audio", "species.arthropoda.neoptera.pseudocaeciliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudocaeciliidae_data", "species.arthropoda.neoptera.pseudocaeciliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudocaeciliidae_graphics", "species.arthropoda.neoptera.pseudocaeciliidae.graphics.spectrum", sb.toString());
        }
    }
}