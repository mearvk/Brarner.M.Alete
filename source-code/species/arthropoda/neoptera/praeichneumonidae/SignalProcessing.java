package species.arthropoda.neoptera.praeichneumonidae;
...
/**
 * Signal Processing for Family: Praeichneumonidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Terebrantes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/praeichneumonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15707; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/praeichneumonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Praeichneumonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("praeichneumonidae_audio", "species.arthropoda.neoptera.praeichneumonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("praeichneumonidae_data", "species.arthropoda.neoptera.praeichneumonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("praeichneumonidae_graphics", "species.arthropoda.neoptera.praeichneumonidae.graphics.spectrum", sb.toString());
        }
    }
}