package species.arthropoda.neoptera.strongylophthalmyiidae;
...
/**
 * Signal Processing for Family: Strongylophthalmyiidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Muscomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/strongylophthalmyiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15580; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/strongylophthalmyiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Strongylophthalmyiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("strongylophthalmyiidae_audio", "species.arthropoda.neoptera.strongylophthalmyiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("strongylophthalmyiidae_data", "species.arthropoda.neoptera.strongylophthalmyiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("strongylophthalmyiidae_graphics", "species.arthropoda.neoptera.strongylophthalmyiidae.graphics.spectrum", sb.toString());
        }
    }
}