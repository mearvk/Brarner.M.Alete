package species.arthropoda.neoptera.ensiferoblattidae;
...
/**
 * Signal Processing for Family: Ensiferoblattidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Eoblattodea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/ensiferoblattidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16013; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/ensiferoblattidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Ensiferoblattidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ensiferoblattidae_audio", "species.arthropoda.neoptera.ensiferoblattidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ensiferoblattidae_data", "species.arthropoda.neoptera.ensiferoblattidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ensiferoblattidae_graphics", "species.arthropoda.neoptera.ensiferoblattidae.graphics.spectrum", sb.toString());
        }
    }
}