package species.arthropoda.neoptera.hystrichopsyllidae;
...
/**
 * Signal Processing for Family: Hystrichopsyllidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Siphonaptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/hystrichopsyllidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15900; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/hystrichopsyllidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Hystrichopsyllidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hystrichopsyllidae_audio", "species.arthropoda.neoptera.hystrichopsyllidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hystrichopsyllidae_data", "species.arthropoda.neoptera.hystrichopsyllidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hystrichopsyllidae_graphics", "species.arthropoda.neoptera.hystrichopsyllidae.graphics.spectrum", sb.toString());
        }
    }
}