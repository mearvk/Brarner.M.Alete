package species.arthropoda.neoptera.phlaeothripidae;
...
/**
 * Signal Processing for Family: Phlaeothripidae
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Tubulifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/phlaeothripidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15255; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/phlaeothripidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Phlaeothripidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phlaeothripidae_audio", "species.arthropoda.neoptera.phlaeothripidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phlaeothripidae_data", "species.arthropoda.neoptera.phlaeothripidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phlaeothripidae_graphics", "species.arthropoda.neoptera.phlaeothripidae.graphics.spectrum", sb.toString());
        }
    }
}