package species.arthropoda.neoptera.myrmeleontoidea;
...
/**
 * Signal Processing for Family: Myrmeleontoidea
 * <p>Phylum: Arthropoda | Class: Neoptera | Order: Myrmeleontiformia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/neoptera/myrmeleontoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 15891; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/neoptera/myrmeleontoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Neoptera"); ps.setString(3, "Myrmeleontoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myrmeleontoidea_audio", "species.arthropoda.neoptera.myrmeleontoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myrmeleontoidea_data", "species.arthropoda.neoptera.myrmeleontoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myrmeleontoidea_graphics", "species.arthropoda.neoptera.myrmeleontoidea.graphics.spectrum", sb.toString());
        }
    }
}