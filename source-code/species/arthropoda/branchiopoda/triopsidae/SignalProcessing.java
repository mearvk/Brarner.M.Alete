package species.arthropoda.branchiopoda.triopsidae;
...
/**
 * Signal Processing for Family: Triopsidae
 * <p>Phylum: Arthropoda | Class: Branchiopoda | Order: Notostraca</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/triopsidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13823; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda/triopsidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, "Triopsidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("triopsidae_audio", "species.arthropoda.branchiopoda.triopsidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("triopsidae_data", "species.arthropoda.branchiopoda.triopsidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("triopsidae_graphics", "species.arthropoda.branchiopoda.triopsidae.graphics.spectrum", sb.toString());
        }
    }
}