package species.arthropoda.branchiopoda.cyclestheriidae;
...
/**
 * Signal Processing for Family: Cyclestheriidae
 * <p>Phylum: Arthropoda | Class: Branchiopoda | Order: Cladoceromorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/cyclestheriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13804; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda/cyclestheriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, "Cyclestheriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cyclestheriidae_audio", "species.arthropoda.branchiopoda.cyclestheriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cyclestheriidae_data", "species.arthropoda.branchiopoda.cyclestheriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cyclestheriidae_graphics", "species.arthropoda.branchiopoda.cyclestheriidae.graphics.spectrum", sb.toString());
        }
    }
}