package species.arthropoda.branchiopoda;
...
/**
 * Signal Processing for Phylum: Arthropoda, Class: Branchiopoda
 * <p>Families: 32</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13791; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arthropoda_branchiopoda_audio", "species.arthropoda.branchiopoda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arthropoda_branchiopoda_data", "species.arthropoda.branchiopoda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arthropoda_branchiopoda_graphics", "species.arthropoda.branchiopoda.graphics.spectrum", sb.toString());
        }
    }
}