package species.arthropoda.branchiopoda.leptestheriidae;
...
/**
 * Signal Processing for Family: Leptestheriidae
 * <p>Phylum: Arthropoda | Class: Branchiopoda | Order: Spinicaudata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/leptestheriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13820; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda/leptestheriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, "Leptestheriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leptestheriidae_audio", "species.arthropoda.branchiopoda.leptestheriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leptestheriidae_data", "species.arthropoda.branchiopoda.leptestheriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leptestheriidae_graphics", "species.arthropoda.branchiopoda.leptestheriidae.graphics.spectrum", sb.toString());
        }
    }
}