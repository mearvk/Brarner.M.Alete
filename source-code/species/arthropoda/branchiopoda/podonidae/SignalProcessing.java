package species.arthropoda.branchiopoda.podonidae;
...
/**
 * Signal Processing for Family: Podonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/podonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13811; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda/podonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, "Podonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("podonidae_audio", "species.arthropoda.branchiopoda.podonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("podonidae_data", "species.arthropoda.branchiopoda.podonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("podonidae_graphics", "species.arthropoda.branchiopoda.podonidae.graphics.spectrum", sb.toString());
        }
    }
}