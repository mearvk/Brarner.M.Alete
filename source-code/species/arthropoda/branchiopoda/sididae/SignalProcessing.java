package species.arthropoda.branchiopoda.sididae;
...
/**
 * Signal Processing for Family: Sididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/branchiopoda/sididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13813; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/branchiopoda/sididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Branchiopoda"); ps.setString(3, "Sididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sididae_audio", "species.arthropoda.branchiopoda.sididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sididae_data", "species.arthropoda.branchiopoda.sididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sididae_graphics", "species.arthropoda.branchiopoda.sididae.graphics.spectrum", sb.toString());
        }
    }
}