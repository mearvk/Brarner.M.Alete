package species.arthropoda.podocopa.thaerocytheridae;
...
/**
 * Signal Processing for Family: Thaerocytheridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/podocopa/thaerocytheridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14887; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/podocopa/thaerocytheridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Podocopa"); ps.setString(3, "Thaerocytheridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thaerocytheridae_audio", "species.arthropoda.podocopa.thaerocytheridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thaerocytheridae_data", "species.arthropoda.podocopa.thaerocytheridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thaerocytheridae_graphics", "species.arthropoda.podocopa.thaerocytheridae.graphics.spectrum", sb.toString());
        }
    }
}