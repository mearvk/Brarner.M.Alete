package species.arthropoda.podocopa.parvocytheridae;
...
/**
 * Signal Processing for Family: Parvocytheridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/podocopa/parvocytheridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14881; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/podocopa/parvocytheridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Podocopa"); ps.setString(3, "Parvocytheridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parvocytheridae_audio", "species.arthropoda.podocopa.parvocytheridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parvocytheridae_data", "species.arthropoda.podocopa.parvocytheridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parvocytheridae_graphics", "species.arthropoda.podocopa.parvocytheridae.graphics.spectrum", sb.toString());
        }
    }
}