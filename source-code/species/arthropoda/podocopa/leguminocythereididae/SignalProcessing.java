package species.arthropoda.podocopa.leguminocythereididae;
...
/**
 * Signal Processing for Family: Leguminocythereididae
 * <p>Phylum: Arthropoda | Class: Podocopa | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/podocopa/leguminocythereididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14842; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/podocopa/leguminocythereididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Podocopa"); ps.setString(3, "Leguminocythereididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leguminocythereididae_audio", "species.arthropoda.podocopa.leguminocythereididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leguminocythereididae_data", "species.arthropoda.podocopa.leguminocythereididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leguminocythereididae_graphics", "species.arthropoda.podocopa.leguminocythereididae.graphics.spectrum", sb.toString());
        }
    }
}