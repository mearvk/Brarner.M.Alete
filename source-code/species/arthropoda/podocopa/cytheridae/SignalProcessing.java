package species.arthropoda.podocopa.cytheridae;
...
/**
 * Signal Processing for Family: Cytheridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/podocopa/cytheridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14865; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/podocopa/cytheridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Podocopa"); ps.setString(3, "Cytheridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cytheridae_audio", "species.arthropoda.podocopa.cytheridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cytheridae_data", "species.arthropoda.podocopa.cytheridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cytheridae_graphics", "species.arthropoda.podocopa.cytheridae.graphics.spectrum", sb.toString());
        }
    }
}