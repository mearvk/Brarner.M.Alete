package species.arthropoda.podocopa.brachycytheridae;
...
/**
 * Signal Processing for Family: Brachycytheridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/podocopa/brachycytheridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14846; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/podocopa/brachycytheridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Podocopa"); ps.setString(3, "Brachycytheridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brachycytheridae_audio", "species.arthropoda.podocopa.brachycytheridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brachycytheridae_data", "species.arthropoda.podocopa.brachycytheridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brachycytheridae_graphics", "species.arthropoda.podocopa.brachycytheridae.graphics.spectrum", sb.toString());
        }
    }
}