package species.arthropoda.merostomata.limulidae;
...
/**
 * Signal Processing for Family: Limulidae
 * <p>Phylum: Arthropoda | Class: Merostomata | Order: Limulina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/merostomata/limulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 13772; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/merostomata/limulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Merostomata"); ps.setString(3, "Limulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("limulidae_audio", "species.arthropoda.merostomata.limulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("limulidae_data", "species.arthropoda.merostomata.limulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("limulidae_graphics", "species.arthropoda.merostomata.limulidae.graphics.spectrum", sb.toString());
        }
    }
}