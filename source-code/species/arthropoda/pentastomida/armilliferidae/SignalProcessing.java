package species.arthropoda.pentastomida.armilliferidae;
...
/**
 * Signal Processing for Family: Armilliferidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentastomida/armilliferidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14898; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentastomida/armilliferidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentastomida"); ps.setString(3, "Armilliferidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("armilliferidae_audio", "species.arthropoda.pentastomida.armilliferidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("armilliferidae_data", "species.arthropoda.pentastomida.armilliferidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("armilliferidae_graphics", "species.arthropoda.pentastomida.armilliferidae.graphics.spectrum", sb.toString());
        }
    }
}