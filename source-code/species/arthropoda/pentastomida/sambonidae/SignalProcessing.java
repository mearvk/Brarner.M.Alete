package species.arthropoda.pentastomida.sambonidae;
...
/**
 * Signal Processing for Family: Sambonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentastomida/sambonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14902; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentastomida/sambonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentastomida"); ps.setString(3, "Sambonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sambonidae_audio", "species.arthropoda.pentastomida.sambonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sambonidae_data", "species.arthropoda.pentastomida.sambonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sambonidae_graphics", "species.arthropoda.pentastomida.sambonidae.graphics.spectrum", sb.toString());
        }
    }
}