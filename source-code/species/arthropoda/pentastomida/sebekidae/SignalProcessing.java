package species.arthropoda.pentastomida.sebekidae;
...
/**
 * Signal Processing for Family: Sebekidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentastomida/sebekidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14903; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentastomida/sebekidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentastomida"); ps.setString(3, "Sebekidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sebekidae_audio", "species.arthropoda.pentastomida.sebekidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sebekidae_data", "species.arthropoda.pentastomida.sebekidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sebekidae_graphics", "species.arthropoda.pentastomida.sebekidae.graphics.spectrum", sb.toString());
        }
    }
}