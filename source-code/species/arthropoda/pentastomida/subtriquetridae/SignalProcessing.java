package species.arthropoda.pentastomida.subtriquetridae;
...
/**
 * Signal Processing for Family: Subtriquetridae
 * <p>Phylum: Arthropoda | Class: Pentastomida | Order: Porocephalida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentastomida/subtriquetridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14904; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentastomida/subtriquetridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentastomida"); ps.setString(3, "Subtriquetridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("subtriquetridae_audio", "species.arthropoda.pentastomida.subtriquetridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("subtriquetridae_data", "species.arthropoda.pentastomida.subtriquetridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("subtriquetridae_graphics", "species.arthropoda.pentastomida.subtriquetridae.graphics.spectrum", sb.toString());
        }
    }
}