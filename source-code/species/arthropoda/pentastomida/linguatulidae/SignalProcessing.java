package species.arthropoda.pentastomida.linguatulidae;
...
/**
 * Signal Processing for Family: Linguatulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/pentastomida/linguatulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14900; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/pentastomida/linguatulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Pentastomida"); ps.setString(3, "Linguatulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("linguatulidae_audio", "species.arthropoda.pentastomida.linguatulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("linguatulidae_data", "species.arthropoda.pentastomida.linguatulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("linguatulidae_graphics", "species.arthropoda.pentastomida.linguatulidae.graphics.spectrum", sb.toString());
        }
    }
}