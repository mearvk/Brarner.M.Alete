package species.arthropoda.progymnoplea.platycopiidae;
...
/**
 * Signal Processing for Family: Platycopiidae
 * <p>Phylum: Arthropoda | Class: Progymnoplea | Order: Platycopioida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/arthropoda/progymnoplea/platycopiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 14052; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/arthropoda/progymnoplea/platycopiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Arthropoda"); ps.setString(2, "Progymnoplea"); ps.setString(3, "Platycopiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platycopiidae_audio", "species.arthropoda.progymnoplea.platycopiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platycopiidae_data", "species.arthropoda.progymnoplea.platycopiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platycopiidae_graphics", "species.arthropoda.progymnoplea.platycopiidae.graphics.spectrum", sb.toString());
        }
    }
}