package species.xenacoelomorpha.acoela.dakuidae;
...
/**
 * Signal Processing for Family: Dakuidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/acoela/dakuidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11464; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/acoela/dakuidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Acoela"); ps.setString(3, "Dakuidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dakuidae_audio", "species.xenacoelomorpha.acoela.dakuidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dakuidae_data", "species.xenacoelomorpha.acoela.dakuidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dakuidae_graphics", "species.xenacoelomorpha.acoela.dakuidae.graphics.spectrum", sb.toString());
        }
    }
}