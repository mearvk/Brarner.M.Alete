package species.xenacoelomorpha.acoela;
...
/**
 * Signal Processing for Phylum: Xenacoelomorpha, Class: Acoela
 * <p>Families: 16</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/acoela/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11459; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/acoela";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Acoela"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_acoela_audio", "species.xenacoelomorpha.acoela.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_acoela_data", "species.xenacoelomorpha.acoela.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_acoela_graphics", "species.xenacoelomorpha.acoela.graphics.spectrum", sb.toString());
        }
    }
}