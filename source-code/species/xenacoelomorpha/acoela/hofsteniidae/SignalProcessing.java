package species.xenacoelomorpha.acoela.hofsteniidae;
...
/**
 * Signal Processing for Family: Hofsteniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/acoela/hofsteniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11467; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/acoela/hofsteniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Acoela"); ps.setString(3, "Hofsteniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hofsteniidae_audio", "species.xenacoelomorpha.acoela.hofsteniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hofsteniidae_data", "species.xenacoelomorpha.acoela.hofsteniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hofsteniidae_graphics", "species.xenacoelomorpha.acoela.hofsteniidae.graphics.spectrum", sb.toString());
        }
    }
}