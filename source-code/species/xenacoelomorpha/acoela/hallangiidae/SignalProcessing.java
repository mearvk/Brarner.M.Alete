package species.xenacoelomorpha.acoela.hallangiidae;
...
/**
 * Signal Processing for Family: Hallangiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/acoela/hallangiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11466; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/acoela/hallangiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Acoela"); ps.setString(3, "Hallangiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hallangiidae_audio", "species.xenacoelomorpha.acoela.hallangiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hallangiidae_data", "species.xenacoelomorpha.acoela.hallangiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hallangiidae_graphics", "species.xenacoelomorpha.acoela.hallangiidae.graphics.spectrum", sb.toString());
        }
    }
}