package species.xenacoelomorpha.acoela.solenofilomorphidae;
...
/**
 * Signal Processing for Family: Solenofilomorphidae
 * <p>Phylum: Xenacoelomorpha | Class: Acoela | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/acoela/solenofilomorphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11474; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/acoela/solenofilomorphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Acoela"); ps.setString(3, "Solenofilomorphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("solenofilomorphidae_audio", "species.xenacoelomorpha.acoela.solenofilomorphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("solenofilomorphidae_data", "species.xenacoelomorpha.acoela.solenofilomorphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("solenofilomorphidae_graphics", "species.xenacoelomorpha.acoela.solenofilomorphidae.graphics.spectrum", sb.toString());
        }
    }
}