package species.xenacoelomorpha;
...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Xenacoelomorpha
 * <p>Classes: 2 | Families: 19</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10405; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_xenacoelomorpha_audio", "species.xenacoelomorpha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_xenacoelomorpha_data", "species.xenacoelomorpha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_xenacoelomorpha_graphics", "species.xenacoelomorpha.graphics.spectrum", sb.toString());
        }
    }
}