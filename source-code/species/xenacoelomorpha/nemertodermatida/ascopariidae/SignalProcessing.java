package species.xenacoelomorpha.nemertodermatida.ascopariidae;
...
/**
 * Signal Processing for Family: Ascopariidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/nemertodermatida/ascopariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11477; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/nemertodermatida/ascopariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Nemertodermatida"); ps.setString(3, "Ascopariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ascopariidae_audio", "species.xenacoelomorpha.nemertodermatida.ascopariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ascopariidae_data", "species.xenacoelomorpha.nemertodermatida.ascopariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ascopariidae_graphics", "species.xenacoelomorpha.nemertodermatida.ascopariidae.graphics.spectrum", sb.toString());
        }
    }
}