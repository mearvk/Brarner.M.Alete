package species.xenacoelomorpha.nemertodermatida.nemertodermatidae;
...
/**
 * Signal Processing for Family: Nemertodermatidae
 * <p>Phylum: Xenacoelomorpha | Class: Nemertodermatida | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/nemertodermatida/nemertodermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11478; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/nemertodermatida/nemertodermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Nemertodermatida"); ps.setString(3, "Nemertodermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nemertodermatidae_audio", "species.xenacoelomorpha.nemertodermatida.nemertodermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nemertodermatidae_data", "species.xenacoelomorpha.nemertodermatida.nemertodermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nemertodermatidae_graphics", "species.xenacoelomorpha.nemertodermatida.nemertodermatidae.graphics.spectrum", sb.toString());
        }
    }
}