package species.xenacoelomorpha.nemertodermatida;
...
/**
 * Signal Processing for Phylum: Xenacoelomorpha, Class: Nemertodermatida
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/xenacoelomorpha/nemertodermatida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11476; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/xenacoelomorpha/nemertodermatida";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Xenacoelomorpha"); ps.setString(2, "Nemertodermatida"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_nemertodermatida_audio", "species.xenacoelomorpha.nemertodermatida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_nemertodermatida_data", "species.xenacoelomorpha.nemertodermatida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xenacoelomorpha_nemertodermatida_graphics", "species.xenacoelomorpha.nemertodermatida.graphics.spectrum", sb.toString());
        }
    }
}