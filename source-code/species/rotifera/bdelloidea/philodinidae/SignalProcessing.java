package species.rotifera.bdelloidea.philodinidae;
...
/**
 * Signal Processing for Family: Philodinidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/bdelloidea/philodinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18272; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/bdelloidea/philodinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Bdelloidea"); ps.setString(3, "Philodinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("philodinidae_audio", "species.rotifera.bdelloidea.philodinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("philodinidae_data", "species.rotifera.bdelloidea.philodinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("philodinidae_graphics", "species.rotifera.bdelloidea.philodinidae.graphics.spectrum", sb.toString());
        }
    }
}