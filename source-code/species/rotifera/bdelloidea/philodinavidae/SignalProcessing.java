package species.rotifera.bdelloidea.philodinavidae;
...
/**
 * Signal Processing for Family: Philodinavidae
 * <p>Phylum: Rotifera | Class: Bdelloidea | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/bdelloidea/philodinavidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/bdelloidea/philodinavidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Bdelloidea"); ps.setString(3, "Philodinavidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("philodinavidae_audio", "species.rotifera.bdelloidea.philodinavidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("philodinavidae_data", "species.rotifera.bdelloidea.philodinavidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("philodinavidae_graphics", "species.rotifera.bdelloidea.philodinavidae.graphics.spectrum", sb.toString());
        }
    }
}