package species.rotifera.bdelloidea.habrotrochidae;
...
/**
 * Signal Processing for Family: Habrotrochidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/bdelloidea/habrotrochidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18270; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/bdelloidea/habrotrochidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Bdelloidea"); ps.setString(3, "Habrotrochidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("habrotrochidae_audio", "species.rotifera.bdelloidea.habrotrochidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("habrotrochidae_data", "species.rotifera.bdelloidea.habrotrochidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("habrotrochidae_graphics", "species.rotifera.bdelloidea.habrotrochidae.graphics.spectrum", sb.toString());
        }
    }
}