package species.rotifera.pararotatoria.seisonidae;
...
/**
 * Signal Processing for Family: Seisonidae
 * <p>Phylum: Rotifera | Class: Pararotatoria | Order: Seisonacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/pararotatoria/seisonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18304; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/pararotatoria/seisonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Pararotatoria"); ps.setString(3, "Seisonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("seisonidae_audio", "species.rotifera.pararotatoria.seisonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("seisonidae_data", "species.rotifera.pararotatoria.seisonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("seisonidae_graphics", "species.rotifera.pararotatoria.seisonidae.graphics.spectrum", sb.toString());
        }
    }
}