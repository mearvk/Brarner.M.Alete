package species.rotifera.pararotatoria;
...
/**
 * Signal Processing for Phylum: Rotifera, Class: Pararotatoria
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/pararotatoria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18303; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/pararotatoria";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Pararotatoria"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rotifera_pararotatoria_audio", "species.rotifera.pararotatoria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rotifera_pararotatoria_data", "species.rotifera.pararotatoria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rotifera_pararotatoria_graphics", "species.rotifera.pararotatoria.graphics.spectrum", sb.toString());
        }
    }
}