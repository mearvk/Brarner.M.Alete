package species.rotifera.monogononta.flosculariidae;
...
/**
 * Signal Processing for Family: Flosculariidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/flosculariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18278; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/flosculariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Flosculariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("flosculariidae_audio", "species.rotifera.monogononta.flosculariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("flosculariidae_data", "species.rotifera.monogononta.flosculariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("flosculariidae_graphics", "species.rotifera.monogononta.flosculariidae.graphics.spectrum", sb.toString());
        }
    }
}