package species.rotifera.monogononta.collothecidae;
...
/**
 * Signal Processing for Family: Collothecidae
 * <p>Phylum: Rotifera | Class: Monogononta | Order: Collothecaceae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/collothecidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/collothecidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Collothecidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("collothecidae_audio", "species.rotifera.monogononta.collothecidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("collothecidae_data", "species.rotifera.monogononta.collothecidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("collothecidae_graphics", "species.rotifera.monogononta.collothecidae.graphics.spectrum", sb.toString());
        }
    }
}