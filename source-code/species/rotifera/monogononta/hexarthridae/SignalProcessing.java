package species.rotifera.monogononta.hexarthridae;
...
/**
 * Signal Processing for Family: Hexarthridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/hexarthridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18279; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/hexarthridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Hexarthridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hexarthridae_audio", "species.rotifera.monogononta.hexarthridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hexarthridae_data", "species.rotifera.monogononta.hexarthridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hexarthridae_graphics", "species.rotifera.monogononta.hexarthridae.graphics.spectrum", sb.toString());
        }
    }
}