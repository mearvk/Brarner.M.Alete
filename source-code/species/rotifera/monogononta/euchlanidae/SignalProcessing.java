package species.rotifera.monogononta.euchlanidae;
...
/**
 * Signal Processing for Family: Euchlanidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/euchlanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18288; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/euchlanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Euchlanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("euchlanidae_audio", "species.rotifera.monogononta.euchlanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("euchlanidae_data", "species.rotifera.monogononta.euchlanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("euchlanidae_graphics", "species.rotifera.monogononta.euchlanidae.graphics.spectrum", sb.toString());
        }
    }
}