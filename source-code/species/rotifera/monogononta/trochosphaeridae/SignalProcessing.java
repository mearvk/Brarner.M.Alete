package species.rotifera.monogononta.trochosphaeridae;
...
/**
 * Signal Processing for Family: Trochosphaeridae
 * <p>Phylum: Rotifera | Class: Monogononta | Order: Flosculariaceae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/trochosphaeridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18281; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/trochosphaeridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Trochosphaeridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trochosphaeridae_audio", "species.rotifera.monogononta.trochosphaeridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trochosphaeridae_data", "species.rotifera.monogononta.trochosphaeridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trochosphaeridae_graphics", "species.rotifera.monogononta.trochosphaeridae.graphics.spectrum", sb.toString());
        }
    }
}