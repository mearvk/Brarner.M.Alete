package species.rotifera.monogononta.tetrasiphonidae;
...
/**
 * Signal Processing for Family: Tetrasiphonidae
 * <p>Phylum: Rotifera | Class: Monogononta | Order: Ploima</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/tetrasiphonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18300; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta/tetrasiphonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, "Tetrasiphonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tetrasiphonidae_audio", "species.rotifera.monogononta.tetrasiphonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tetrasiphonidae_data", "species.rotifera.monogononta.tetrasiphonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tetrasiphonidae_graphics", "species.rotifera.monogononta.tetrasiphonidae.graphics.spectrum", sb.toString());
        }
    }
}