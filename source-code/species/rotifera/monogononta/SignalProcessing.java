package species.rotifera.monogononta;
...
/**
 * Signal Processing for Phylum: Rotifera, Class: Monogononta
 * <p>Families: 29</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/rotifera/monogononta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18273; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/rotifera/monogononta";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Rotifera"); ps.setString(2, "Monogononta"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rotifera_monogononta_audio", "species.rotifera.monogononta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rotifera_monogononta_data", "species.rotifera.monogononta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rotifera_monogononta_graphics", "species.rotifera.monogononta.graphics.spectrum", sb.toString());
        }
    }
}