package species.platyhelminthes.proseriata.ciliopharyngiellidae;
...
/**
 * Signal Processing for Family: Ciliopharyngiellidae
 * <p>Phylum: Platyhelminthes | Class: Proseriata | Order: Unguiphora</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/ciliopharyngiellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18224; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata/ciliopharyngiellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, "Ciliopharyngiellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ciliopharyngiellidae_audio", "species.platyhelminthes.proseriata.ciliopharyngiellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ciliopharyngiellidae_data", "species.platyhelminthes.proseriata.ciliopharyngiellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ciliopharyngiellidae_graphics", "species.platyhelminthes.proseriata.ciliopharyngiellidae.graphics.spectrum", sb.toString());
        }
    }
}