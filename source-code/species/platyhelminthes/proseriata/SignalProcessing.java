package species.platyhelminthes.proseriata;
...
/**
 * Signal Processing for Phylum: Platyhelminthes, Class: Proseriata
 * <p>Families: 11</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18215; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_proseriata_audio", "species.platyhelminthes.proseriata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_proseriata_data", "species.platyhelminthes.proseriata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_proseriata_graphics", "species.platyhelminthes.proseriata.graphics.spectrum", sb.toString());
        }
    }
}