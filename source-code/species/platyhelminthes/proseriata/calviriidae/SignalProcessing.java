package species.platyhelminthes.proseriata.calviriidae;
...
/**
 * Signal Processing for Family: Calviriidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/calviriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18217; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata/calviriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, "Calviriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calviriidae_audio", "species.platyhelminthes.proseriata.calviriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calviriidae_data", "species.platyhelminthes.proseriata.calviriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calviriidae_graphics", "species.platyhelminthes.proseriata.calviriidae.graphics.spectrum", sb.toString());
        }
    }
}