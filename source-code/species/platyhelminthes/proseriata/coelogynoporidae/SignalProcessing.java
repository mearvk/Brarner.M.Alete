package species.platyhelminthes.proseriata.coelogynoporidae;
...
/**
 * Signal Processing for Family: Coelogynoporidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/coelogynoporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18218; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata/coelogynoporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, "Coelogynoporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("coelogynoporidae_audio", "species.platyhelminthes.proseriata.coelogynoporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("coelogynoporidae_data", "species.platyhelminthes.proseriata.coelogynoporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("coelogynoporidae_graphics", "species.platyhelminthes.proseriata.coelogynoporidae.graphics.spectrum", sb.toString());
        }
    }
}