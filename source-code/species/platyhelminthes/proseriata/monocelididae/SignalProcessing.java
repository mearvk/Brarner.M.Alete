package species.platyhelminthes.proseriata.monocelididae;
...
/**
 * Signal Processing for Family: Monocelididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/monocelididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18220; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata/monocelididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, "Monocelididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("monocelididae_audio", "species.platyhelminthes.proseriata.monocelididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("monocelididae_data", "species.platyhelminthes.proseriata.monocelididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("monocelididae_graphics", "species.platyhelminthes.proseriata.monocelididae.graphics.spectrum", sb.toString());
        }
    }
}