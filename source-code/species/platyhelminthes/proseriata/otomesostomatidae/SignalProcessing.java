package species.platyhelminthes.proseriata.otomesostomatidae;
...
/**
 * Signal Processing for Family: Otomesostomatidae
 * <p>Phylum: Platyhelminthes | Class: Proseriata | Order: Lithophora</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/proseriata/otomesostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18222; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/proseriata/otomesostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Proseriata"); ps.setString(3, "Otomesostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("otomesostomatidae_audio", "species.platyhelminthes.proseriata.otomesostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("otomesostomatidae_data", "species.platyhelminthes.proseriata.otomesostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("otomesostomatidae_graphics", "species.platyhelminthes.proseriata.otomesostomatidae.graphics.spectrum", sb.toString());
        }
    }
}