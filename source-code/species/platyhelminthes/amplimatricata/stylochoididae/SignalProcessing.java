package species.platyhelminthes.amplimatricata.stylochoididae;
...
/**
 * Signal Processing for Family: Stylochoididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/stylochoididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17893; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata/stylochoididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, "Stylochoididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("stylochoididae_audio", "species.platyhelminthes.amplimatricata.stylochoididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("stylochoididae_data", "species.platyhelminthes.amplimatricata.stylochoididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("stylochoididae_graphics", "species.platyhelminthes.amplimatricata.stylochoididae.graphics.spectrum", sb.toString());
        }
    }
}