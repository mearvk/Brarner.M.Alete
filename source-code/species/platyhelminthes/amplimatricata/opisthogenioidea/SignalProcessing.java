package species.platyhelminthes.amplimatricata.opisthogenioidea;
...
/**
 * Signal Processing for Family: Opisthogenioidea
 * <p>Phylum: Platyhelminthes | Class: Amplimatricata | Order: Cotylea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/opisthogenioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17882; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata/opisthogenioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, "Opisthogenioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("opisthogenioidea_audio", "species.platyhelminthes.amplimatricata.opisthogenioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("opisthogenioidea_data", "species.platyhelminthes.amplimatricata.opisthogenioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("opisthogenioidea_graphics", "species.platyhelminthes.amplimatricata.opisthogenioidea.graphics.spectrum", sb.toString());
        }
    }
}