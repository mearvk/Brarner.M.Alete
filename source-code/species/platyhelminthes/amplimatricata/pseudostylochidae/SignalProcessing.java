package species.platyhelminthes.amplimatricata.pseudostylochidae;
...
/**
 * Signal Processing for Family: Pseudostylochidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/pseudostylochidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17873; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata/pseudostylochidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, "Pseudostylochidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudostylochidae_audio", "species.platyhelminthes.amplimatricata.pseudostylochidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudostylochidae_data", "species.platyhelminthes.amplimatricata.pseudostylochidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudostylochidae_graphics", "species.platyhelminthes.amplimatricata.pseudostylochidae.graphics.spectrum", sb.toString());
        }
    }
}