package species.platyhelminthes.amplimatricata;
...
/**
 * Signal Processing for Phylum: Platyhelminthes, Class: Amplimatricata
 * <p>Families: 55</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17839; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_amplimatricata_audio", "species.platyhelminthes.amplimatricata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_amplimatricata_data", "species.platyhelminthes.amplimatricata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_amplimatricata_graphics", "species.platyhelminthes.amplimatricata.graphics.spectrum", sb.toString());
        }
    }
}