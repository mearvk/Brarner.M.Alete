package species.platyhelminthes.amplimatricata.gnesiocerotidae;
...
/**
 * Signal Processing for Family: Gnesiocerotidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/gnesiocerotidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17863; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata/gnesiocerotidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, "Gnesiocerotidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gnesiocerotidae_audio", "species.platyhelminthes.amplimatricata.gnesiocerotidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gnesiocerotidae_data", "species.platyhelminthes.amplimatricata.gnesiocerotidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gnesiocerotidae_graphics", "species.platyhelminthes.amplimatricata.gnesiocerotidae.graphics.spectrum", sb.toString());
        }
    }
}