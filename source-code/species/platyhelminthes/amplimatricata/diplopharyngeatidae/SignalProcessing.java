package species.platyhelminthes.amplimatricata.diplopharyngeatidae;
...
/**
 * Signal Processing for Family: Diplopharyngeatidae
 * <p>Phylum: Platyhelminthes | Class: Amplimatricata | Order: Acotylea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/amplimatricata/diplopharyngeatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17842; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/amplimatricata/diplopharyngeatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Amplimatricata"); ps.setString(3, "Diplopharyngeatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("diplopharyngeatidae_audio", "species.platyhelminthes.amplimatricata.diplopharyngeatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("diplopharyngeatidae_data", "species.platyhelminthes.amplimatricata.diplopharyngeatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("diplopharyngeatidae_graphics", "species.platyhelminthes.amplimatricata.diplopharyngeatidae.graphics.spectrum", sb.toString());
        }
    }
}