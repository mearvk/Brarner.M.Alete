package species.platyhelminthes.rhabdocoela.temnocephalidae;
...
/**
 * Signal Processing for Family: Temnocephalidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/temnocephalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18247; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela/temnocephalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, "Temnocephalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("temnocephalidae_audio", "species.platyhelminthes.rhabdocoela.temnocephalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("temnocephalidae_data", "species.platyhelminthes.rhabdocoela.temnocephalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("temnocephalidae_graphics", "species.platyhelminthes.rhabdocoela.temnocephalidae.graphics.spectrum", sb.toString());
        }
    }
}