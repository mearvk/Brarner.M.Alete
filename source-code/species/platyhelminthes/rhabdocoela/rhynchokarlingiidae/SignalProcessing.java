package species.platyhelminthes.rhabdocoela.rhynchokarlingiidae;
...
/**
 * Signal Processing for Family: Rhynchokarlingiidae
 * <p>Phylum: Platyhelminthes | Class: Rhabdocoela | Order: Kalyptorhynchia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/rhynchokarlingiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18264; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela/rhynchokarlingiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, "Rhynchokarlingiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhynchokarlingiidae_audio", "species.platyhelminthes.rhabdocoela.rhynchokarlingiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhynchokarlingiidae_data", "species.platyhelminthes.rhabdocoela.rhynchokarlingiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhynchokarlingiidae_graphics", "species.platyhelminthes.rhabdocoela.rhynchokarlingiidae.graphics.spectrum", sb.toString());
        }
    }
}