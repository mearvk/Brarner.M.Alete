package species.platyhelminthes.rhabdocoela.actinodactylellidae;
...
/**
 * Signal Processing for Family: Actinodactylellidae
 * <p>Phylum: Platyhelminthes | Class: Rhabdocoela | Order: Dalytyphloplanida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/actinodactylellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18245; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela/actinodactylellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, "Actinodactylellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("actinodactylellidae_audio", "species.platyhelminthes.rhabdocoela.actinodactylellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("actinodactylellidae_data", "species.platyhelminthes.rhabdocoela.actinodactylellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("actinodactylellidae_graphics", "species.platyhelminthes.rhabdocoela.actinodactylellidae.graphics.spectrum", sb.toString());
        }
    }
}