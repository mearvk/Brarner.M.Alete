package species.platyhelminthes.rhabdocoela.umagillidae;
...
/**
 * Signal Processing for Family: Umagillidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/umagillidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18241; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela/umagillidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, "Umagillidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("umagillidae_audio", "species.platyhelminthes.rhabdocoela.umagillidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("umagillidae_data", "species.platyhelminthes.rhabdocoela.umagillidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("umagillidae_graphics", "species.platyhelminthes.rhabdocoela.umagillidae.graphics.spectrum", sb.toString());
        }
    }
}