package species.platyhelminthes.rhabdocoela.pterastericolidae;
...
/**
 * Signal Processing for Family: Pterastericolidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/pterastericolidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18237; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela/pterastericolidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, "Pterastericolidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pterastericolidae_audio", "species.platyhelminthes.rhabdocoela.pterastericolidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pterastericolidae_data", "species.platyhelminthes.rhabdocoela.pterastericolidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pterastericolidae_graphics", "species.platyhelminthes.rhabdocoela.pterastericolidae.graphics.spectrum", sb.toString());
        }
    }
}