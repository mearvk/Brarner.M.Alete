package species.platyhelminthes.rhabdocoela;
...
/**
 * Signal Processing for Phylum: Platyhelminthes, Class: Rhabdocoela
 * <p>Families: 38</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/rhabdocoela/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18227; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/rhabdocoela";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Rhabdocoela"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_rhabdocoela_audio", "species.platyhelminthes.rhabdocoela.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_rhabdocoela_data", "species.platyhelminthes.rhabdocoela.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_rhabdocoela_graphics", "species.platyhelminthes.rhabdocoela.graphics.spectrum", sb.toString());
        }
    }
}