package species.platyhelminthes.gnosonesimora.gnosonesimidae;
...
/**
 * Signal Processing for Family: Gnosonesimidae
 * <p>Phylum: Platyhelminthes | Class: Gnosonesimora | Order: Gnosonesimida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/gnosonesimora/gnosonesimidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/gnosonesimora/gnosonesimidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Gnosonesimora"); ps.setString(3, "Gnosonesimidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gnosonesimidae_audio", "species.platyhelminthes.gnosonesimora.gnosonesimidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gnosonesimidae_data", "species.platyhelminthes.gnosonesimora.gnosonesimidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gnosonesimidae_graphics", "species.platyhelminthes.gnosonesimora.gnosonesimidae.graphics.spectrum", sb.toString());
        }
    }
}