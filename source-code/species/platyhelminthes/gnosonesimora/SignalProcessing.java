package species.platyhelminthes.gnosonesimora;
...
/**
 * Signal Processing for Phylum: Platyhelminthes, Class: Gnosonesimora
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/gnosonesimora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18266; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/gnosonesimora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Gnosonesimora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_gnosonesimora_audio", "species.platyhelminthes.gnosonesimora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_gnosonesimora_data", "species.platyhelminthes.gnosonesimora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_gnosonesimora_graphics", "species.platyhelminthes.gnosonesimora.graphics.spectrum", sb.toString());
        }
    }
}