package species.platyhelminthes;
...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Platyhelminthes
 * <p>Classes: 10 | Families: 431</p>
 * <p>Taxonomy classes in this phylum:</p>
 * <ul>
 *   Amplimatricata
 *   Euneoophora
 *   Acentrosomata
 ...
 *   Gnosonesimora
 * </ul>
 * <p>Installer Tax ID: MEARVK-LLC-2026</p>
 * <p>Brand: Brarner.M.Alete / MEARVK LLC</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10431; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
             PreparedStatement ps = conn.prepareStatement(
                 "INSERT INTO species_experiments (phylum, experiment_name, experiment_data, installer_tax_id) VALUES (?, ?, ?, 'MEARVK-LLC-2026')")) {
            ps.setString(1, "Platyhelminthes"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    private static void output(String filename, String expName, String content) throws Exception {
        ...
        if ("database".equals(dataOutput) || "both".equals(dataOutput)) writeToDatabase("species_experiments", expName, content);
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_platyhelminthes_audio", "species.platyhelminthes.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_platyhelminthes_data", "species.platyhelminthes.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_platyhelminthes_graphics", "species.platyhelminthes.graphics.spectrum", sb.toString());
        }
    }
}