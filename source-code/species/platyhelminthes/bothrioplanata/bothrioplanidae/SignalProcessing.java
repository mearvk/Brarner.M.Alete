package species.platyhelminthes.bothrioplanata.bothrioplanidae;
...
/**
 * Signal Processing for Family: Bothrioplanidae
 * <p>Phylum: Platyhelminthes | Class: Bothrioplanata | Order: Bothrioplanida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/bothrioplanata/bothrioplanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17925; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/bothrioplanata/bothrioplanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Bothrioplanata"); ps.setString(3, "Bothrioplanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bothrioplanidae_audio", "species.platyhelminthes.bothrioplanata.bothrioplanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bothrioplanidae_data", "species.platyhelminthes.bothrioplanata.bothrioplanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bothrioplanidae_graphics", "species.platyhelminthes.bothrioplanata.bothrioplanidae.graphics.spectrum", sb.toString());
        }
    }
}