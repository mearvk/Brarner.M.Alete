package species.platyhelminthes.bothrioplanata;
...
/**
 * Signal Processing for Phylum: Platyhelminthes, Class: Bothrioplanata
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/bothrioplanata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17924; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/bothrioplanata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Bothrioplanata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_bothrioplanata_audio", "species.platyhelminthes.bothrioplanata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_bothrioplanata_data", "species.platyhelminthes.bothrioplanata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyhelminthes_bothrioplanata_graphics", "species.platyhelminthes.bothrioplanata.graphics.spectrum", sb.toString());
        }
    }
}