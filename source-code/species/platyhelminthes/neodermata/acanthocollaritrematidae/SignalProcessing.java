package species.platyhelminthes.neodermata.acanthocollaritrematidae;
...
/**
 * Signal Processing for Family: Acanthocollaritrematidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Plagiorchiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/acanthocollaritrematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18071; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/acanthocollaritrematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Acanthocollaritrematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocollaritrematidae_audio", "species.platyhelminthes.neodermata.acanthocollaritrematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocollaritrematidae_data", "species.platyhelminthes.neodermata.acanthocollaritrematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocollaritrematidae_graphics", "species.platyhelminthes.neodermata.acanthocollaritrematidae.graphics.spectrum", sb.toString());
        }
    }
}