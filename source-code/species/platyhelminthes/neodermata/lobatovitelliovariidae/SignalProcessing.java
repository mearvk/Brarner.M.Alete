package species.platyhelminthes.neodermata.lobatovitelliovariidae;
...
/**
 * Signal Processing for Family: Lobatovitelliovariidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Hemiurata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/lobatovitelliovariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18135; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/lobatovitelliovariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Lobatovitelliovariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lobatovitelliovariidae_audio", "species.platyhelminthes.neodermata.lobatovitelliovariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lobatovitelliovariidae_data", "species.platyhelminthes.neodermata.lobatovitelliovariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lobatovitelliovariidae_graphics", "species.platyhelminthes.neodermata.lobatovitelliovariidae.graphics.spectrum", sb.toString());
        }
    }
}