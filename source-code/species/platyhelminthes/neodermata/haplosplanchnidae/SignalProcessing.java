package species.platyhelminthes.neodermata.haplosplanchnidae;
...
/**
 * Signal Processing for Family: Haplosplanchnidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Echinostomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/haplosplanchnidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18112; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/haplosplanchnidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Haplosplanchnidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("haplosplanchnidae_audio", "species.platyhelminthes.neodermata.haplosplanchnidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("haplosplanchnidae_data", "species.platyhelminthes.neodermata.haplosplanchnidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("haplosplanchnidae_graphics", "species.platyhelminthes.neodermata.haplosplanchnidae.graphics.spectrum", sb.toString());
        }
    }
}