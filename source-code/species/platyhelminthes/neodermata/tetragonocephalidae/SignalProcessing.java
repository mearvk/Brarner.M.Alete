package species.platyhelminthes.neodermata.tetragonocephalidae;
...
/**
 * Signal Processing for Family: Tetragonocephalidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Lecanicephalidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/tetragonocephalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17965; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/tetragonocephalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Tetragonocephalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tetragonocephalidae_audio", "species.platyhelminthes.neodermata.tetragonocephalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tetragonocephalidae_data", "species.platyhelminthes.neodermata.tetragonocephalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tetragonocephalidae_graphics", "species.platyhelminthes.neodermata.tetragonocephalidae.graphics.spectrum", sb.toString());
        }
    }
}