package species.platyhelminthes.neodermata.acanthocolpidae;
...
/**
 * Signal Processing for Family: Acanthocolpidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Acanthocolpiata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/acanthocolpidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18088; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/acanthocolpidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Acanthocolpidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocolpidae_audio", "species.platyhelminthes.neodermata.acanthocolpidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocolpidae_data", "species.platyhelminthes.neodermata.acanthocolpidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocolpidae_graphics", "species.platyhelminthes.neodermata.acanthocolpidae.graphics.spectrum", sb.toString());
        }
    }
}