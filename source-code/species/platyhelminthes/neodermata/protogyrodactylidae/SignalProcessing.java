package species.platyhelminthes.neodermata.protogyrodactylidae;
...
/**
 * Signal Processing for Family: Protogyrodactylidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Monopisthocotylea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/protogyrodactylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17979; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/protogyrodactylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Protogyrodactylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protogyrodactylidae_audio", "species.platyhelminthes.neodermata.protogyrodactylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protogyrodactylidae_data", "species.platyhelminthes.neodermata.protogyrodactylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protogyrodactylidae_graphics", "species.platyhelminthes.neodermata.protogyrodactylidae.graphics.spectrum", sb.toString());
        }
    }
}