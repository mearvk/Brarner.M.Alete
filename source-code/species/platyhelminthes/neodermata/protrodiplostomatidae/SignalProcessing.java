package species.platyhelminthes.neodermata.protrodiplostomatidae;
...
/**
 * Signal Processing for Family: Protrodiplostomatidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Diplostomida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/protrodiplostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18057; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/protrodiplostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Protrodiplostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protrodiplostomatidae_audio", "species.platyhelminthes.neodermata.protrodiplostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protrodiplostomatidae_data", "species.platyhelminthes.neodermata.protrodiplostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protrodiplostomatidae_graphics", "species.platyhelminthes.neodermata.protrodiplostomatidae.graphics.spectrum", sb.toString());
        }
    }
}