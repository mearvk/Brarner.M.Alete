package species.platyhelminthes.neodermata.progynotaeniidae;
...
/**
 * Signal Processing for Family: Progynotaeniidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Cyclophyllidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/progynotaeniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17951; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/progynotaeniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Progynotaeniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("progynotaeniidae_audio", "species.platyhelminthes.neodermata.progynotaeniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("progynotaeniidae_data", "species.platyhelminthes.neodermata.progynotaeniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("progynotaeniidae_graphics", "species.platyhelminthes.neodermata.progynotaeniidae.graphics.spectrum", sb.toString());
        }
    }
}