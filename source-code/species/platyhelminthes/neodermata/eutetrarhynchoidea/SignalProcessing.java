package species.platyhelminthes.neodermata.eutetrarhynchoidea;
...
/**
 * Signal Processing for Family: Eutetrarhynchoidea
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Trypanobatoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/eutetrarhynchoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18029; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/eutetrarhynchoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Eutetrarhynchoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eutetrarhynchoidea_audio", "species.platyhelminthes.neodermata.eutetrarhynchoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eutetrarhynchoidea_data", "species.platyhelminthes.neodermata.eutetrarhynchoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eutetrarhynchoidea_graphics", "species.platyhelminthes.neodermata.eutetrarhynchoidea.graphics.spectrum", sb.toString());
        }
    }
}