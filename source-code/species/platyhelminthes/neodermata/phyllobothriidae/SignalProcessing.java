package species.platyhelminthes.neodermata.phyllobothriidae;
...
/**
 * Signal Processing for Family: Phyllobothriidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Phyllobothriidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/phyllobothriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17986; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/phyllobothriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Phyllobothriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phyllobothriidae_audio", "species.platyhelminthes.neodermata.phyllobothriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phyllobothriidae_data", "species.platyhelminthes.neodermata.phyllobothriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phyllobothriidae_graphics", "species.platyhelminthes.neodermata.phyllobothriidae.graphics.spectrum", sb.toString());
        }
    }
}