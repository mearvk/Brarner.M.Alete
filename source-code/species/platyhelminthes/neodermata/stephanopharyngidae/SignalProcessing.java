package species.platyhelminthes.neodermata.stephanopharyngidae;
...
/**
 * Signal Processing for Family: Stephanopharyngidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Paramphistomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/stephanopharyngidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18170; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/stephanopharyngidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Stephanopharyngidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("stephanopharyngidae_audio", "species.platyhelminthes.neodermata.stephanopharyngidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("stephanopharyngidae_data", "species.platyhelminthes.neodermata.stephanopharyngidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("stephanopharyngidae_graphics", "species.platyhelminthes.neodermata.stephanopharyngidae.graphics.spectrum", sb.toString());
        }
    }
}