package species.platyhelminthes.neodermata.lacistorhynchoidea;
...
/**
 * Signal Processing for Family: Lacistorhynchoidea
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Trypanoselachoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/lacistorhynchoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18038; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/lacistorhynchoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Lacistorhynchoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lacistorhynchoidea_audio", "species.platyhelminthes.neodermata.lacistorhynchoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lacistorhynchoidea_data", "species.platyhelminthes.neodermata.lacistorhynchoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lacistorhynchoidea_graphics", "species.platyhelminthes.neodermata.lacistorhynchoidea.graphics.spectrum", sb.toString());
        }
    }
}