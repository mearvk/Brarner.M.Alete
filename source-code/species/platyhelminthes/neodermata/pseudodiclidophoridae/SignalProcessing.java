package species.platyhelminthes.neodermata.pseudodiclidophoridae;
...
/**
 * Signal Processing for Family: Pseudodiclidophoridae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Polyopisthocotylea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/pseudodiclidophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18012; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/pseudodiclidophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Pseudodiclidophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudodiclidophoridae_audio", "species.platyhelminthes.neodermata.pseudodiclidophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudodiclidophoridae_data", "species.platyhelminthes.neodermata.pseudodiclidophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudodiclidophoridae_graphics", "species.platyhelminthes.neodermata.pseudodiclidophoridae.graphics.spectrum", sb.toString());
        }
    }
}