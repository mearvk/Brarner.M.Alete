package species.platyhelminthes.neodermata.rhoptrobothriidae;
...
/**
 * Signal Processing for Family: Rhoptrobothriidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Tetraphyllidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/rhoptrobothriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18027; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/rhoptrobothriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Rhoptrobothriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhoptrobothriidae_audio", "species.platyhelminthes.neodermata.rhoptrobothriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhoptrobothriidae_data", "species.platyhelminthes.neodermata.rhoptrobothriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhoptrobothriidae_graphics", "species.platyhelminthes.neodermata.rhoptrobothriidae.graphics.spectrum", sb.toString());
        }
    }
}