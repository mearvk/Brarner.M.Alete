package species.platyhelminthes.neodermata.caryophyllaeidae;
...
/**
 * Signal Processing for Family: Caryophyllaeidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Caryophyllidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/caryophyllaeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17933; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/caryophyllaeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Caryophyllaeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("caryophyllaeidae_audio", "species.platyhelminthes.neodermata.caryophyllaeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("caryophyllaeidae_data", "species.platyhelminthes.neodermata.caryophyllaeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("caryophyllaeidae_graphics", "species.platyhelminthes.neodermata.caryophyllaeidae.graphics.spectrum", sb.toString());
        }
    }
}