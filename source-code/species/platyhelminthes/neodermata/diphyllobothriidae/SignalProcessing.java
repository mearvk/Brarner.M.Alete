package species.platyhelminthes.neodermata.diphyllobothriidae;
...
/**
 * Signal Processing for Family: Diphyllobothriidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Diphyllobothriidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/diphyllobothriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17955; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/diphyllobothriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Diphyllobothriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("diphyllobothriidae_audio", "species.platyhelminthes.neodermata.diphyllobothriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("diphyllobothriidae_data", "species.platyhelminthes.neodermata.diphyllobothriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("diphyllobothriidae_graphics", "species.platyhelminthes.neodermata.diphyllobothriidae.graphics.spectrum", sb.toString());
        }
    }
}