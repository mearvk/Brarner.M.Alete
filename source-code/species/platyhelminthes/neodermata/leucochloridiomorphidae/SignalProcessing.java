package species.platyhelminthes.neodermata.leucochloridiomorphidae;
...
/**
 * Signal Processing for Family: Leucochloridiomorphidae
 * <p>Phylum: Platyhelminthes | Class: Neodermata | Order: Brachylaimata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/neodermata/leucochloridiomorphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18066; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/neodermata/leucochloridiomorphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Neodermata"); ps.setString(3, "Leucochloridiomorphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leucochloridiomorphidae_audio", "species.platyhelminthes.neodermata.leucochloridiomorphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leucochloridiomorphidae_data", "species.platyhelminthes.neodermata.leucochloridiomorphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leucochloridiomorphidae_graphics", "species.platyhelminthes.neodermata.leucochloridiomorphidae.graphics.spectrum", sb.toString());
        }
    }
}