package species.platyhelminthes.adiaphanida.centrovarioplanidae;
...
/**
 * Signal Processing for Family: Centrovarioplanidae
 * <p>Phylum: Platyhelminthes | Class: Adiaphanida | Order: Maricola</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/centrovarioplanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17919; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/centrovarioplanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Centrovarioplanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("centrovarioplanidae_audio", "species.platyhelminthes.adiaphanida.centrovarioplanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("centrovarioplanidae_data", "species.platyhelminthes.adiaphanida.centrovarioplanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("centrovarioplanidae_graphics", "species.platyhelminthes.adiaphanida.centrovarioplanidae.graphics.spectrum", sb.toString());
        }
    }
}