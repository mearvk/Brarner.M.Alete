package species.platyhelminthes.adiaphanida.dendrocoelidae;
...
/**
 * Signal Processing for Family: Dendrocoelidae
 * <p>Phylum: Platyhelminthes | Class: Adiaphanida | Order: Continenticola</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/dendrocoelidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17912; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/dendrocoelidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Dendrocoelidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendrocoelidae_audio", "species.platyhelminthes.adiaphanida.dendrocoelidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendrocoelidae_data", "species.platyhelminthes.adiaphanida.dendrocoelidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendrocoelidae_graphics", "species.platyhelminthes.adiaphanida.dendrocoelidae.graphics.spectrum", sb.toString());
        }
    }
}