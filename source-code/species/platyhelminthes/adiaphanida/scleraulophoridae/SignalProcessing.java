package species.platyhelminthes.adiaphanida.scleraulophoridae;
...
/**
 * Signal Processing for Family: Scleraulophoridae
 * <p>Phylum: Platyhelminthes | Class: Adiaphanida | Order: Prolecithophora</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/scleraulophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17905; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/scleraulophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Scleraulophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scleraulophoridae_audio", "species.platyhelminthes.adiaphanida.scleraulophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scleraulophoridae_data", "species.platyhelminthes.adiaphanida.scleraulophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scleraulophoridae_graphics", "species.platyhelminthes.adiaphanida.scleraulophoridae.graphics.spectrum", sb.toString());
        }
    }
}