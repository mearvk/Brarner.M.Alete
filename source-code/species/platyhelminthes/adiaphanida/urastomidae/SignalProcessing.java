package species.platyhelminthes.adiaphanida.urastomidae;
...
/**
 * Signal Processing for Family: Urastomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/urastomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17899; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/urastomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Urastomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("urastomidae_audio", "species.platyhelminthes.adiaphanida.urastomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("urastomidae_data", "species.platyhelminthes.adiaphanida.urastomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("urastomidae_graphics", "species.platyhelminthes.adiaphanida.urastomidae.graphics.spectrum", sb.toString());
        }
    }
}