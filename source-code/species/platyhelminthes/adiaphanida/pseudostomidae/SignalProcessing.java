package species.platyhelminthes.adiaphanida.pseudostomidae;
...
/**
 * Signal Processing for Family: Pseudostomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/pseudostomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17904; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/pseudostomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Pseudostomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudostomidae_audio", "species.platyhelminthes.adiaphanida.pseudostomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudostomidae_data", "species.platyhelminthes.adiaphanida.pseudostomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudostomidae_graphics", "species.platyhelminthes.adiaphanida.pseudostomidae.graphics.spectrum", sb.toString());
        }
    }
}