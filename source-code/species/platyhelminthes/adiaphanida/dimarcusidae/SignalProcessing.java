package species.platyhelminthes.adiaphanida.dimarcusidae;
...
/**
 * Signal Processing for Family: Dimarcusidae
 * <p>Phylum: Platyhelminthes | Class: Adiaphanida | Order: Cavernicola</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/platyhelminthes/adiaphanida/dimarcusidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17907; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/platyhelminthes/adiaphanida/dimarcusidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Platyhelminthes"); ps.setString(2, "Adiaphanida"); ps.setString(3, "Dimarcusidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dimarcusidae_audio", "species.platyhelminthes.adiaphanida.dimarcusidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dimarcusidae_data", "species.platyhelminthes.adiaphanida.dimarcusidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dimarcusidae_graphics", "species.platyhelminthes.adiaphanida.dimarcusidae.graphics.spectrum", sb.toString());
        }
    }
}