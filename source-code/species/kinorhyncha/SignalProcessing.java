...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Kinorhyncha
 * <p>Classes: 0 | Families: 10</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/kinorhyncha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10411; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/kinorhyncha";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Kinorhyncha"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_kinorhyncha_audio", "species.kinorhyncha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_kinorhyncha_data", "species.kinorhyncha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_kinorhyncha_graphics", "species.kinorhyncha.graphics.spectrum", sb.toString());
        }
    }
}