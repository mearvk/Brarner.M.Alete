package species.gnathostomulida;
...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Gnathostomulida
 * <p>Classes: 0 | Families: 12</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/gnathostomulida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10425; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/gnathostomulida";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Gnathostomulida"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_gnathostomulida_audio", "species.gnathostomulida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_gnathostomulida_data", "species.gnathostomulida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_gnathostomulida_graphics", "species.gnathostomulida.graphics.spectrum", sb.toString());
        }
    }
}