...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Orthonectida
 * <p>Classes: 0 | Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/orthonectida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10429; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/orthonectida";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Orthonectida"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_orthonectida_audio", "species.orthonectida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_orthonectida_data", "species.orthonectida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_orthonectida_graphics", "species.orthonectida.graphics.spectrum", sb.toString());
        }
    }
}