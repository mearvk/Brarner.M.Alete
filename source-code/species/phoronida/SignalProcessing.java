...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Phoronida
 * <p>Classes: 0 | Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/phoronida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10430; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/phoronida";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Phoronida"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_phoronida_audio", "species.phoronida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_phoronida_data", "species.phoronida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_phoronida_graphics", "species.phoronida.graphics.spectrum", sb.toString());
        }
    }
}