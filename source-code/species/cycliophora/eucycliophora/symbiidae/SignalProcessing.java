package species.cycliophora.eucycliophora.symbiidae;
...
/**
 * Signal Processing for Family: Symbiidae
 * <p>Phylum: Cycliophora | Class: Eucycliophora | Order: Symbiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cycliophora/eucycliophora/symbiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16895; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cycliophora/eucycliophora/symbiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cycliophora"); ps.setString(2, "Eucycliophora"); ps.setString(3, "Symbiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("symbiidae_audio", "species.cycliophora.eucycliophora.symbiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("symbiidae_data", "species.cycliophora.eucycliophora.symbiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("symbiidae_graphics", "species.cycliophora.eucycliophora.symbiidae.graphics.spectrum", sb.toString());
        }
    }
}