package species.cycliophora.eucycliophora;
...
/**
 * Signal Processing for Phylum: Cycliophora, Class: Eucycliophora
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cycliophora/eucycliophora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16894; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cycliophora/eucycliophora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cycliophora"); ps.setString(2, "Eucycliophora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cycliophora_eucycliophora_audio", "species.cycliophora.eucycliophora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cycliophora_eucycliophora_data", "species.cycliophora.eucycliophora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cycliophora_eucycliophora_graphics", "species.cycliophora.eucycliophora.graphics.spectrum", sb.toString());
        }
    }
}