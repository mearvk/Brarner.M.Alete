package species.chaetognatha.archisagittoidea;
...
/**
 * Signal Processing for Phylum: Chaetognatha, Class: Archisagittoidea
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/archisagittoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12822; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/archisagittoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Archisagittoidea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chaetognatha_archisagittoidea_audio", "species.chaetognatha.archisagittoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chaetognatha_archisagittoidea_data", "species.chaetognatha.archisagittoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chaetognatha_archisagittoidea_graphics", "species.chaetognatha.archisagittoidea.graphics.spectrum", sb.toString());
        }
    }
}