package species.chaetognatha.archisagittoidea.amiskwiidae;
...
/**
 * Signal Processing for Family: Amiskwiidae
 * <p>Phylum: Chaetognatha | Class: Archisagittoidea | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/archisagittoidea/amiskwiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12823; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/archisagittoidea/amiskwiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Archisagittoidea"); ps.setString(3, "Amiskwiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("amiskwiidae_audio", "species.chaetognatha.archisagittoidea.amiskwiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("amiskwiidae_data", "species.chaetognatha.archisagittoidea.amiskwiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("amiskwiidae_graphics", "species.chaetognatha.archisagittoidea.amiskwiidae.graphics.spectrum", sb.toString());
        }
    }
}