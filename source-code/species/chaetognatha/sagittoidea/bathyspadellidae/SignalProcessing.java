package species.chaetognatha.sagittoidea.bathyspadellidae;
...
/**
 * Signal Processing for Family: Bathyspadellidae
 * <p>Phylum: Chaetognatha | Class: Sagittoidea | Order: Phragmophora</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/bathyspadellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12829; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/bathyspadellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Bathyspadellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathyspadellidae_audio", "species.chaetognatha.sagittoidea.bathyspadellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathyspadellidae_data", "species.chaetognatha.sagittoidea.bathyspadellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathyspadellidae_graphics", "species.chaetognatha.sagittoidea.bathyspadellidae.graphics.spectrum", sb.toString());
        }
    }
}