package species.chaetognatha.sagittoidea;
...
/**
 * Signal Processing for Phylum: Chaetognatha, Class: Sagittoidea
 * <p>Families: 8</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12824; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chaetognatha_sagittoidea_audio", "species.chaetognatha.sagittoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chaetognatha_sagittoidea_data", "species.chaetognatha.sagittoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chaetognatha_sagittoidea_graphics", "species.chaetognatha.sagittoidea.graphics.spectrum", sb.toString());
        }
    }
}