package species.chaetognatha.sagittoidea.sagittidae;
...
/**
 * Signal Processing for Family: Sagittidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/sagittidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12827; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/sagittidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Sagittidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sagittidae_audio", "species.chaetognatha.sagittoidea.sagittidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sagittidae_data", "species.chaetognatha.sagittoidea.sagittidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sagittidae_graphics", "species.chaetognatha.sagittoidea.sagittidae.graphics.spectrum", sb.toString());
        }
    }
}