package species.chaetognatha.sagittoidea.krohnittidae;
...
/**
 * Signal Processing for Family: Krohnittidae
 * <p>Phylum: Chaetognatha | Class: Sagittoidea | Order: Flabellodontina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/krohnittidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12828; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/krohnittidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Krohnittidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("krohnittidae_audio", "species.chaetognatha.sagittoidea.krohnittidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("krohnittidae_data", "species.chaetognatha.sagittoidea.krohnittidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("krohnittidae_graphics", "species.chaetognatha.sagittoidea.krohnittidae.graphics.spectrum", sb.toString());
        }
    }
}