package species.chaetognatha.sagittoidea.pterosagittidae;
...
/**
 * Signal Processing for Family: Pterosagittidae
 * <p>Phylum: Chaetognatha | Class: Sagittoidea | Order: Ctinodontina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/pterosagittidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12826; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/pterosagittidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Pterosagittidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pterosagittidae_audio", "species.chaetognatha.sagittoidea.pterosagittidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pterosagittidae_data", "species.chaetognatha.sagittoidea.pterosagittidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pterosagittidae_graphics", "species.chaetognatha.sagittoidea.pterosagittidae.graphics.spectrum", sb.toString());
        }
    }
}