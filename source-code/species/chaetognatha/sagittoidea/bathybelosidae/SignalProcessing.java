package species.chaetognatha.sagittoidea.bathybelosidae;
...
/**
 * Signal Processing for Family: Bathybelosidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/bathybelosidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12825; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/bathybelosidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Bathybelosidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathybelosidae_audio", "species.chaetognatha.sagittoidea.bathybelosidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathybelosidae_data", "species.chaetognatha.sagittoidea.bathybelosidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathybelosidae_graphics", "species.chaetognatha.sagittoidea.bathybelosidae.graphics.spectrum", sb.toString());
        }
    }
}