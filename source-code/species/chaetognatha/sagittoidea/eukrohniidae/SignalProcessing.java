package species.chaetognatha.sagittoidea.eukrohniidae;
...
/**
 * Signal Processing for Family: Eukrohniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chaetognatha/sagittoidea/eukrohniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12830; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chaetognatha/sagittoidea/eukrohniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chaetognatha"); ps.setString(2, "Sagittoidea"); ps.setString(3, "Eukrohniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eukrohniidae_audio", "species.chaetognatha.sagittoidea.eukrohniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eukrohniidae_data", "species.chaetognatha.sagittoidea.eukrohniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eukrohniidae_graphics", "species.chaetognatha.sagittoidea.eukrohniidae.graphics.spectrum", sb.toString());
        }
    }
}