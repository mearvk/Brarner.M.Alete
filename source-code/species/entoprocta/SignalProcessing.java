...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Entoprocta
 * <p>Classes: 0 | Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/entoprocta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10423; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/entoprocta";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Entoprocta"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_entoprocta_audio", "species.entoprocta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_entoprocta_data", "species.entoprocta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_entoprocta_graphics", "species.entoprocta.graphics.spectrum", sb.toString());
        }
    }
}