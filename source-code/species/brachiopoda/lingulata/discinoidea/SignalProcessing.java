package species.brachiopoda.lingulata.discinoidea;
...
/**
 * Signal Processing for Family: Discinoidea
 * <p>Phylum: Brachiopoda | Class: Lingulata | Order: Lingulida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/lingulata/discinoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16727; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/lingulata/discinoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Lingulata"); ps.setString(3, "Discinoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("discinoidea_audio", "species.brachiopoda.lingulata.discinoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("discinoidea_data", "species.brachiopoda.lingulata.discinoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("discinoidea_graphics", "species.brachiopoda.lingulata.discinoidea.graphics.spectrum", sb.toString());
        }
    }
}