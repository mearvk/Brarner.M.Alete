package species.brachiopoda.lingulata.discinidae;
...
/**
 * Signal Processing for Family: Discinidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/lingulata/discinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16728; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/lingulata/discinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Lingulata"); ps.setString(3, "Discinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("discinidae_audio", "species.brachiopoda.lingulata.discinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("discinidae_data", "species.brachiopoda.lingulata.discinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("discinidae_graphics", "species.brachiopoda.lingulata.discinidae.graphics.spectrum", sb.toString());
        }
    }
}