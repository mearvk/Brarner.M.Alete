package species.brachiopoda.lingulata;
...
/**
 * Signal Processing for Phylum: Brachiopoda, Class: Lingulata
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/lingulata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16726; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/lingulata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Lingulata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brachiopoda_lingulata_audio", "species.brachiopoda.lingulata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brachiopoda_lingulata_data", "species.brachiopoda.lingulata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brachiopoda_lingulata_graphics", "species.brachiopoda.lingulata.graphics.spectrum", sb.toString());
        }
    }
}