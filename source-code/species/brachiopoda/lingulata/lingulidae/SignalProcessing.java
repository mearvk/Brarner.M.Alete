package species.brachiopoda.lingulata.lingulidae;
...
/**
 * Signal Processing for Family: Lingulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/lingulata/lingulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16730; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/lingulata/lingulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Lingulata"); ps.setString(3, "Lingulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lingulidae_audio", "species.brachiopoda.lingulata.lingulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lingulidae_data", "species.brachiopoda.lingulata.lingulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lingulidae_graphics", "species.brachiopoda.lingulata.lingulidae.graphics.spectrum", sb.toString());
        }
    }
}