package species.brachiopoda.rhynchonellata.terebratellacea;
...
/**
 * Signal Processing for Family: Terebratellacea
 * <p>Phylum: Brachiopoda | Class: Rhynchonellata | Order: Terebratellidina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/terebratellacea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16737; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/terebratellacea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Terebratellacea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("terebratellacea_audio", "species.brachiopoda.rhynchonellata.terebratellacea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("terebratellacea_data", "species.brachiopoda.rhynchonellata.terebratellacea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("terebratellacea_graphics", "species.brachiopoda.rhynchonellata.terebratellacea.graphics.spectrum", sb.toString());
        }
    }
}