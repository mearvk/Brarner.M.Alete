package species.brachiopoda.rhynchonellata.frieleiidae;
...
/**
 * Signal Processing for Family: Frieleiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/frieleiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16734; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/frieleiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Frieleiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("frieleiidae_audio", "species.brachiopoda.rhynchonellata.frieleiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("frieleiidae_data", "species.brachiopoda.rhynchonellata.frieleiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("frieleiidae_graphics", "species.brachiopoda.rhynchonellata.frieleiidae.graphics.spectrum", sb.toString());
        }
    }
}