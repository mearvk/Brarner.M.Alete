package species.brachiopoda.rhynchonellata.dyscolioidea;
...
/**
 * Signal Processing for Family: Dyscolioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/dyscolioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16749; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/dyscolioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Dyscolioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dyscolioidea_audio", "species.brachiopoda.rhynchonellata.dyscolioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dyscolioidea_data", "species.brachiopoda.rhynchonellata.dyscolioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dyscolioidea_graphics", "species.brachiopoda.rhynchonellata.dyscolioidea.graphics.spectrum", sb.toString());
        }
    }
}