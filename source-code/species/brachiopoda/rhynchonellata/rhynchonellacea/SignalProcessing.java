package species.brachiopoda.rhynchonellata.rhynchonellacea;
...
/**
 * Signal Processing for Family: Rhynchonellacea
 * <p>Phylum: Brachiopoda | Class: Rhynchonellata | Order: Rhynchonellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/rhynchonellacea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16736; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/rhynchonellacea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Rhynchonellacea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhynchonellacea_audio", "species.brachiopoda.rhynchonellata.rhynchonellacea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhynchonellacea_data", "species.brachiopoda.rhynchonellata.rhynchonellacea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhynchonellacea_graphics", "species.brachiopoda.rhynchonellata.rhynchonellacea.graphics.spectrum", sb.toString());
        }
    }
}