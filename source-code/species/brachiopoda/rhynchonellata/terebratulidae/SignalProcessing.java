package species.brachiopoda.rhynchonellata.terebratulidae;
...
/**
 * Signal Processing for Family: Terebratulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/terebratulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16752; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/terebratulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Terebratulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("terebratulidae_audio", "species.brachiopoda.rhynchonellata.terebratulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("terebratulidae_data", "species.brachiopoda.rhynchonellata.terebratulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("terebratulidae_graphics", "species.brachiopoda.rhynchonellata.terebratulidae.graphics.spectrum", sb.toString());
        }
    }
}