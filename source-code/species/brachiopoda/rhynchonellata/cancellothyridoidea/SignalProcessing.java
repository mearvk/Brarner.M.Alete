package species.brachiopoda.rhynchonellata.cancellothyridoidea;
...
/**
 * Signal Processing for Family: Cancellothyridoidea
 * <p>Phylum: Brachiopoda | Class: Rhynchonellata | Order: Terebratulidina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/cancellothyridoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16745; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/cancellothyridoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Cancellothyridoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cancellothyridoidea_audio", "species.brachiopoda.rhynchonellata.cancellothyridoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cancellothyridoidea_data", "species.brachiopoda.rhynchonellata.cancellothyridoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cancellothyridoidea_graphics", "species.brachiopoda.rhynchonellata.cancellothyridoidea.graphics.spectrum", sb.toString());
        }
    }
}