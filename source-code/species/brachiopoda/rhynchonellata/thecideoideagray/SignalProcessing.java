package species.brachiopoda.rhynchonellata.thecideoideagray;
...
/**
 * Signal Processing for Family: Thecideoidea Gray, 1840
 * <p>Phylum: Brachiopoda | Class: Rhynchonellata | Order: Thecideida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/thecideoideagray/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16753; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/thecideoideagray";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Thecideoidea Gray, 1840"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thecideoideagray_audio", "species.brachiopoda.rhynchonellata.thecideoideagray.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thecideoideagray_data", "species.brachiopoda.rhynchonellata.thecideoideagray.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thecideoideagray_graphics", "species.brachiopoda.rhynchonellata.thecideoideagray.graphics.spectrum", sb.toString());
        }
    }
}