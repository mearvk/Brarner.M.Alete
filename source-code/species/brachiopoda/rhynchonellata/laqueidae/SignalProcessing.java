package species.brachiopoda.rhynchonellata.laqueidae;
...
/**
 * Signal Processing for Family: Laqueidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/laqueidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16740; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata/laqueidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, "Laqueidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("laqueidae_audio", "species.brachiopoda.rhynchonellata.laqueidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("laqueidae_data", "species.brachiopoda.rhynchonellata.laqueidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("laqueidae_graphics", "species.brachiopoda.rhynchonellata.laqueidae.graphics.spectrum", sb.toString());
        }
    }
}