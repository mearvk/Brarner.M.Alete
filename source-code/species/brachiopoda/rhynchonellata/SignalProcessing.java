package species.brachiopoda.rhynchonellata;
...
/**
 * Signal Processing for Phylum: Brachiopoda, Class: Rhynchonellata
 * <p>Families: 24</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/rhynchonellata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16731; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/rhynchonellata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Rhynchonellata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brachiopoda_rhynchonellata_audio", "species.brachiopoda.rhynchonellata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brachiopoda_rhynchonellata_data", "species.brachiopoda.rhynchonellata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brachiopoda_rhynchonellata_graphics", "species.brachiopoda.rhynchonellata.graphics.spectrum", sb.toString());
        }
    }
}