package species.brachiopoda.craniata.cranioidea;
...
/**
 * Signal Processing for Family: Cranioidea
 * <p>Phylum: Brachiopoda | Class: Craniata | Order: Craniida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/brachiopoda/craniata/cranioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16724; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/brachiopoda/craniata/cranioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Brachiopoda"); ps.setString(2, "Craniata"); ps.setString(3, "Cranioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cranioidea_audio", "species.brachiopoda.craniata.cranioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cranioidea_data", "species.brachiopoda.craniata.cranioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cranioidea_graphics", "species.brachiopoda.craniata.cranioidea.graphics.spectrum", sb.toString());
        }
    }
}