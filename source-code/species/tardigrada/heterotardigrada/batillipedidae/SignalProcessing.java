package species.tardigrada.heterotardigrada.batillipedidae;
...
/**
 * Signal Processing for Family: Batillipedidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/heterotardigrada/batillipedidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16518; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/heterotardigrada/batillipedidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Heterotardigrada"); ps.setString(3, "Batillipedidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("batillipedidae_audio", "species.tardigrada.heterotardigrada.batillipedidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("batillipedidae_data", "species.tardigrada.heterotardigrada.batillipedidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("batillipedidae_graphics", "species.tardigrada.heterotardigrada.batillipedidae.graphics.spectrum", sb.toString());
        }
    }
}