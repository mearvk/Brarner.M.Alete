package species.tardigrada.heterotardigrada.echiniscoididae;
...
/**
 * Signal Processing for Family: Echiniscoididae
 * <p>Phylum: Tardigrada | Class: Heterotardigrada | Order: Echiniscoidea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/heterotardigrada/echiniscoididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16529; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/heterotardigrada/echiniscoididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Heterotardigrada"); ps.setString(3, "Echiniscoididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("echiniscoididae_audio", "species.tardigrada.heterotardigrada.echiniscoididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("echiniscoididae_data", "species.tardigrada.heterotardigrada.echiniscoididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("echiniscoididae_graphics", "species.tardigrada.heterotardigrada.echiniscoididae.graphics.spectrum", sb.toString());
        }
    }
}