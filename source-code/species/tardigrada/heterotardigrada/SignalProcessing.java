package species.tardigrada.heterotardigrada;
...
/**
 * Signal Processing for Phylum: Tardigrada, Class: Heterotardigrada
 * <p>Families: 15</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/heterotardigrada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16515; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/heterotardigrada";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Heterotardigrada"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tardigrada_heterotardigrada_audio", "species.tardigrada.heterotardigrada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tardigrada_heterotardigrada_data", "species.tardigrada.heterotardigrada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tardigrada_heterotardigrada_graphics", "species.tardigrada.heterotardigrada.graphics.spectrum", sb.toString());
        }
    }
}