package species.tardigrada.heterotardigrada.halechiniscidae;
...
/**
 * Signal Processing for Family: Halechiniscidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/heterotardigrada/halechiniscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16520; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/heterotardigrada/halechiniscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Heterotardigrada"); ps.setString(3, "Halechiniscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("halechiniscidae_audio", "species.tardigrada.heterotardigrada.halechiniscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("halechiniscidae_data", "species.tardigrada.heterotardigrada.halechiniscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("halechiniscidae_graphics", "species.tardigrada.heterotardigrada.halechiniscidae.graphics.spectrum", sb.toString());
        }
    }
}