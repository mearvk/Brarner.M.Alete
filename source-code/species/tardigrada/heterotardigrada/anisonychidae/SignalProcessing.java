package species.tardigrada.heterotardigrada.anisonychidae;
...
/**
 * Signal Processing for Family: Anisonychidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/heterotardigrada/anisonychidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16516; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/heterotardigrada/anisonychidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Heterotardigrada"); ps.setString(3, "Anisonychidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anisonychidae_audio", "species.tardigrada.heterotardigrada.anisonychidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anisonychidae_data", "species.tardigrada.heterotardigrada.anisonychidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anisonychidae_graphics", "species.tardigrada.heterotardigrada.anisonychidae.graphics.spectrum", sb.toString());
        }
    }
}