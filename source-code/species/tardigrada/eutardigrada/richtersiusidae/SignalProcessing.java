package species.tardigrada.eutardigrada.richtersiusidae;
...
/**
 * Signal Processing for Family: Richtersiusidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/eutardigrada/richtersiusidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16514; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/eutardigrada/richtersiusidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Eutardigrada"); ps.setString(3, "Richtersiusidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("richtersiusidae_audio", "species.tardigrada.eutardigrada.richtersiusidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("richtersiusidae_data", "species.tardigrada.eutardigrada.richtersiusidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("richtersiusidae_graphics", "species.tardigrada.eutardigrada.richtersiusidae.graphics.spectrum", sb.toString());
        }
    }
}