package species.tardigrada.eutardigrada.doryphoribiidae;
...
/**
 * Signal Processing for Family: Doryphoribiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/eutardigrada/doryphoribiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16505; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/eutardigrada/doryphoribiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Eutardigrada"); ps.setString(3, "Doryphoribiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("doryphoribiidae_audio", "species.tardigrada.eutardigrada.doryphoribiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("doryphoribiidae_data", "species.tardigrada.eutardigrada.doryphoribiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("doryphoribiidae_graphics", "species.tardigrada.eutardigrada.doryphoribiidae.graphics.spectrum", sb.toString());
        }
    }
}