package species.tardigrada.eutardigrada.halobiotidae;
...
/**
 * Signal Processing for Family: Halobiotidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/eutardigrada/halobiotidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16506; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/eutardigrada/halobiotidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Eutardigrada"); ps.setString(3, "Halobiotidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("halobiotidae_audio", "species.tardigrada.eutardigrada.halobiotidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("halobiotidae_data", "species.tardigrada.eutardigrada.halobiotidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("halobiotidae_graphics", "species.tardigrada.eutardigrada.halobiotidae.graphics.spectrum", sb.toString());
        }
    }
}