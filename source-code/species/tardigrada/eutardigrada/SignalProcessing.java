package species.tardigrada.eutardigrada;
...
/**
 * Signal Processing for Phylum: Tardigrada, Class: Eutardigrada
 * <p>Families: 21</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/eutardigrada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16493; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/eutardigrada";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Eutardigrada"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tardigrada_eutardigrada_audio", "species.tardigrada.eutardigrada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tardigrada_eutardigrada_data", "species.tardigrada.eutardigrada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tardigrada_eutardigrada_graphics", "species.tardigrada.eutardigrada.graphics.spectrum", sb.toString());
        }
    }
}