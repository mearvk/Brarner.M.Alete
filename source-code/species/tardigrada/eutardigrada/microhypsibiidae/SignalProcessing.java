package species.tardigrada.eutardigrada.microhypsibiidae;
...
/**
 * Signal Processing for Family: Microhypsibiidae
 * <p>Phylum: Tardigrada | Class: Eutardigrada | Order: Parachela</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/eutardigrada/microhypsibiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16502; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/eutardigrada/microhypsibiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Eutardigrada"); ps.setString(3, "Microhypsibiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("microhypsibiidae_audio", "species.tardigrada.eutardigrada.microhypsibiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("microhypsibiidae_data", "species.tardigrada.eutardigrada.microhypsibiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("microhypsibiidae_graphics", "species.tardigrada.eutardigrada.microhypsibiidae.graphics.spectrum", sb.toString());
        }
    }
}