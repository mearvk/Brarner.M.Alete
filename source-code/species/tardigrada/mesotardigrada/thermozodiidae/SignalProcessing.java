package species.tardigrada.mesotardigrada.thermozodiidae;
...
/**
 * Signal Processing for Family: Thermozodiidae
 * <p>Phylum: Tardigrada | Class: Mesotardigrada | Order: Thermozodia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/mesotardigrada/thermozodiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16532; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/mesotardigrada/thermozodiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Mesotardigrada"); ps.setString(3, "Thermozodiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thermozodiidae_audio", "species.tardigrada.mesotardigrada.thermozodiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thermozodiidae_data", "species.tardigrada.mesotardigrada.thermozodiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thermozodiidae_graphics", "species.tardigrada.mesotardigrada.thermozodiidae.graphics.spectrum", sb.toString());
        }
    }
}