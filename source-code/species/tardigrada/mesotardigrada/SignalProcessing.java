package species.tardigrada.mesotardigrada;
...
/**
 * Signal Processing for Phylum: Tardigrada, Class: Mesotardigrada
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/tardigrada/mesotardigrada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16531; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/tardigrada/mesotardigrada";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tardigrada"); ps.setString(2, "Mesotardigrada"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tardigrada_mesotardigrada_audio", "species.tardigrada.mesotardigrada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tardigrada_mesotardigrada_data", "species.tardigrada.mesotardigrada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tardigrada_mesotardigrada_graphics", "species.tardigrada.mesotardigrada.graphics.spectrum", sb.toString());
        }
    }
}