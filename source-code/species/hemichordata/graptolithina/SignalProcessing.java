package species.hemichordata.graptolithina;
...
/**
 * Signal Processing for Phylum: Hemichordata, Class: Graptolithina
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/graptolithina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12820; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/graptolithina";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Graptolithina"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hemichordata_graptolithina_audio", "species.hemichordata.graptolithina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hemichordata_graptolithina_data", "species.hemichordata.graptolithina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hemichordata_graptolithina_graphics", "species.hemichordata.graptolithina.graphics.spectrum", sb.toString());
        }
    }
}