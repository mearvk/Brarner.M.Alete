package species.hemichordata.graptolithina.rhabdopleuridae;
...
/**
 * Signal Processing for Family: Rhabdopleuridae
 * <p>Phylum: Hemichordata | Class: Graptolithina | Order: Rhabdopleurida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/graptolithina/rhabdopleuridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12821; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/graptolithina/rhabdopleuridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Graptolithina"); ps.setString(3, "Rhabdopleuridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhabdopleuridae_audio", "species.hemichordata.graptolithina.rhabdopleuridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhabdopleuridae_data", "species.hemichordata.graptolithina.rhabdopleuridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhabdopleuridae_graphics", "species.hemichordata.graptolithina.rhabdopleuridae.graphics.spectrum", sb.toString());
        }
    }
}