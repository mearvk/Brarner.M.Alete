package species.hemichordata.cephalodiscida;
...
/**
 * Signal Processing for Phylum: Hemichordata, Class: Cephalodiscida
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/cephalodiscida/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12817; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/cephalodiscida";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Cephalodiscida"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hemichordata_cephalodiscida_audio", "species.hemichordata.cephalodiscida.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hemichordata_cephalodiscida_data", "species.hemichordata.cephalodiscida.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hemichordata_cephalodiscida_graphics", "species.hemichordata.cephalodiscida.graphics.spectrum", sb.toString());
        }
    }
}