package species.hemichordata.cephalodiscida.cephalodiscidae;
...
/**
 * Signal Processing for Family: Cephalodiscidae
 * <p>Phylum: Hemichordata | Class: Cephalodiscida | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/cephalodiscida/cephalodiscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12819; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/cephalodiscida/cephalodiscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Cephalodiscida"); ps.setString(3, "Cephalodiscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cephalodiscidae_audio", "species.hemichordata.cephalodiscida.cephalodiscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cephalodiscidae_data", "species.hemichordata.cephalodiscida.cephalodiscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cephalodiscidae_graphics", "species.hemichordata.cephalodiscida.cephalodiscidae.graphics.spectrum", sb.toString());
        }
    }
}