package species.hemichordata.cephalodiscida.atubariidae;
...
/**
 * Signal Processing for Family: Atubariidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/cephalodiscida/atubariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12818; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/cephalodiscida/atubariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Cephalodiscida"); ps.setString(3, "Atubariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("atubariidae_audio", "species.hemichordata.cephalodiscida.atubariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("atubariidae_data", "species.hemichordata.cephalodiscida.atubariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("atubariidae_graphics", "species.hemichordata.cephalodiscida.atubariidae.graphics.spectrum", sb.toString());
        }
    }
}