package species.hemichordata.enteropneusta.torquaratoridae;
...
/**
 * Signal Processing for Family: Torquaratoridae
 * <p>Phylum: Hemichordata | Class: Enteropneusta | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/enteropneusta/torquaratoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12816; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/enteropneusta/torquaratoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Enteropneusta"); ps.setString(3, "Torquaratoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("torquaratoridae_audio", "species.hemichordata.enteropneusta.torquaratoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("torquaratoridae_data", "species.hemichordata.enteropneusta.torquaratoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("torquaratoridae_graphics", "species.hemichordata.enteropneusta.torquaratoridae.graphics.spectrum", sb.toString());
        }
    }
}