package species.hemichordata.enteropneusta.harrimaniidae;
...
/**
 * Signal Processing for Family: Harrimaniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/enteropneusta/harrimaniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12813; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/enteropneusta/harrimaniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Enteropneusta"); ps.setString(3, "Harrimaniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("harrimaniidae_audio", "species.hemichordata.enteropneusta.harrimaniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("harrimaniidae_data", "species.hemichordata.enteropneusta.harrimaniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("harrimaniidae_graphics", "species.hemichordata.enteropneusta.harrimaniidae.graphics.spectrum", sb.toString());
        }
    }
}