package species.hemichordata.enteropneusta.spengelidae;
...
/**
 * Signal Processing for Family: Spengelidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/enteropneusta/spengelidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12815; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/enteropneusta/spengelidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Enteropneusta"); ps.setString(3, "Spengelidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spengelidae_audio", "species.hemichordata.enteropneusta.spengelidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spengelidae_data", "species.hemichordata.enteropneusta.spengelidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spengelidae_graphics", "species.hemichordata.enteropneusta.spengelidae.graphics.spectrum", sb.toString());
        }
    }
}