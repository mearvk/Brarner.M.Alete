package species.hemichordata.enteropneusta.ptychoderidae;
...
/**
 * Signal Processing for Family: Ptychoderidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/hemichordata/enteropneusta/ptychoderidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12814; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/hemichordata/enteropneusta/ptychoderidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Hemichordata"); ps.setString(2, "Enteropneusta"); ps.setString(3, "Ptychoderidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ptychoderidae_audio", "species.hemichordata.enteropneusta.ptychoderidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ptychoderidae_data", "species.hemichordata.enteropneusta.ptychoderidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ptychoderidae_graphics", "species.hemichordata.enteropneusta.ptychoderidae.graphics.spectrum", sb.toString());
        }
    }
}