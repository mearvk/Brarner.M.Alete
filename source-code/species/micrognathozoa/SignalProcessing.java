package species.micrognathozoa;
...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Micrognathozoa
 * <p>Classes: 1 | Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/micrognathozoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10426; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/micrognathozoa";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Micrognathozoa"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_micrognathozoa_audio", "species.micrognathozoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_micrognathozoa_data", "species.micrognathozoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_micrognathozoa_graphics", "species.micrognathozoa.graphics.spectrum", sb.toString());
        }
    }
}