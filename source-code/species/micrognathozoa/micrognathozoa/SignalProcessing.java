package species.micrognathozoa.micrognathozoa;
...
/**
 * Signal Processing for Phylum: Micrognathozoa, Class: Micrognathozoa
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/micrognathozoa/micrognathozoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16896; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/micrognathozoa/micrognathozoa";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Micrognathozoa"); ps.setString(2, "Micrognathozoa"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("micrognathozoa_micrognathozoa_audio", "species.micrognathozoa.micrognathozoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("micrognathozoa_micrognathozoa_data", "species.micrognathozoa.micrognathozoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("micrognathozoa_micrognathozoa_graphics", "species.micrognathozoa.micrognathozoa.graphics.spectrum", sb.toString());
        }
    }
}