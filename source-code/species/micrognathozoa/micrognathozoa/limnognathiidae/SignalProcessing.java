package species.micrognathozoa.micrognathozoa.limnognathiidae;
...
/**
 * Signal Processing for Family: Limnognathiidae
 * <p>Phylum: Micrognathozoa | Class: Micrognathozoa | Order: Limnognathida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/micrognathozoa/micrognathozoa/limnognathiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16897; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/micrognathozoa/micrognathozoa/limnognathiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Micrognathozoa"); ps.setString(2, "Micrognathozoa"); ps.setString(3, "Limnognathiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("limnognathiidae_audio", "species.micrognathozoa.micrognathozoa.limnognathiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("limnognathiidae_data", "species.micrognathozoa.micrognathozoa.limnognathiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("limnognathiidae_graphics", "species.micrognathozoa.micrognathozoa.limnognathiidae.graphics.spectrum", sb.toString());
        }
    }
}