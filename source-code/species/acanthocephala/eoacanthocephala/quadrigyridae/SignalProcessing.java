package species.acanthocephala.eoacanthocephala.quadrigyridae;
...
/**
 * Signal Processing for Family: Quadrigyridae
 * <p>Phylum: Acanthocephala | Class: Eoacanthocephala | Order: Gyracanthocephala</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/eoacanthocephala/quadrigyridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16539; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/eoacanthocephala/quadrigyridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Eoacanthocephala"); ps.setString(3, "Quadrigyridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("quadrigyridae_audio", "species.acanthocephala.eoacanthocephala.quadrigyridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("quadrigyridae_data", "species.acanthocephala.eoacanthocephala.quadrigyridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("quadrigyridae_graphics", "species.acanthocephala.eoacanthocephala.quadrigyridae.graphics.spectrum", sb.toString());
        }
    }
}