package species.acanthocephala.eoacanthocephala.dendronucleatidae;
...
/**
 * Signal Processing for Family: Dendronucleatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/eoacanthocephala/dendronucleatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16540; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/eoacanthocephala/dendronucleatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Eoacanthocephala"); ps.setString(3, "Dendronucleatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendronucleatidae_audio", "species.acanthocephala.eoacanthocephala.dendronucleatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendronucleatidae_data", "species.acanthocephala.eoacanthocephala.dendronucleatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendronucleatidae_graphics", "species.acanthocephala.eoacanthocephala.dendronucleatidae.graphics.spectrum", sb.toString());
        }
    }
}