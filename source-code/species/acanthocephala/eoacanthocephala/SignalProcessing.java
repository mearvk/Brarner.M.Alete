package species.acanthocephala.eoacanthocephala;
...
/**
 * Signal Processing for Phylum: Acanthocephala, Class: Eoacanthocephala
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/eoacanthocephala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16538; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/eoacanthocephala";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Eoacanthocephala"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocephala_eoacanthocephala_audio", "species.acanthocephala.eoacanthocephala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocephala_eoacanthocephala_data", "species.acanthocephala.eoacanthocephala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocephala_eoacanthocephala_graphics", "species.acanthocephala.eoacanthocephala.graphics.spectrum", sb.toString());
        }
    }
}