package species.acanthocephala.eoacanthocephala.neoechinorhynchidae;
...
/**
 * Signal Processing for Family: Neoechinorhynchidae
 * <p>Phylum: Acanthocephala | Class: Eoacanthocephala | Order: Neoechinorhynchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/eoacanthocephala/neoechinorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16541; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/eoacanthocephala/neoechinorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Eoacanthocephala"); ps.setString(3, "Neoechinorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neoechinorhynchidae_audio", "species.acanthocephala.eoacanthocephala.neoechinorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neoechinorhynchidae_data", "species.acanthocephala.eoacanthocephala.neoechinorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neoechinorhynchidae_graphics", "species.acanthocephala.eoacanthocephala.neoechinorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}