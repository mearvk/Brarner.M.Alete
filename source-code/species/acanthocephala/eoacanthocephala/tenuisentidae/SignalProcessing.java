package species.acanthocephala.eoacanthocephala.tenuisentidae;
...
/**
 * Signal Processing for Family: Tenuisentidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/eoacanthocephala/tenuisentidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16542; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/eoacanthocephala/tenuisentidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Eoacanthocephala"); ps.setString(3, "Tenuisentidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tenuisentidae_audio", "species.acanthocephala.eoacanthocephala.tenuisentidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tenuisentidae_data", "species.acanthocephala.eoacanthocephala.tenuisentidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tenuisentidae_graphics", "species.acanthocephala.eoacanthocephala.tenuisentidae.graphics.spectrum", sb.toString());
        }
    }
}