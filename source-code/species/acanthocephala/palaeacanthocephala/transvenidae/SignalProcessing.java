package species.acanthocephala.palaeacanthocephala.transvenidae;
...
/**
 * Signal Processing for Family: Transvenidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/transvenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16556; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala/transvenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, "Transvenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("transvenidae_audio", "species.acanthocephala.palaeacanthocephala.transvenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("transvenidae_data", "species.acanthocephala.palaeacanthocephala.transvenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("transvenidae_graphics", "species.acanthocephala.palaeacanthocephala.transvenidae.graphics.spectrum", sb.toString());
        }
    }
}