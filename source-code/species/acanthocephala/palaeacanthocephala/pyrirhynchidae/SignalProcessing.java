package species.acanthocephala.palaeacanthocephala.pyrirhynchidae;
...
/**
 * Signal Processing for Family: Pyrirhynchidae
 * <p>Phylum: Acanthocephala | Class: Palaeacanthocephala | Order: Heteramorphida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/pyrirhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16557; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala/pyrirhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, "Pyrirhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pyrirhynchidae_audio", "species.acanthocephala.palaeacanthocephala.pyrirhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pyrirhynchidae_data", "species.acanthocephala.palaeacanthocephala.pyrirhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pyrirhynchidae_graphics", "species.acanthocephala.palaeacanthocephala.pyrirhynchidae.graphics.spectrum", sb.toString());
        }
    }
}