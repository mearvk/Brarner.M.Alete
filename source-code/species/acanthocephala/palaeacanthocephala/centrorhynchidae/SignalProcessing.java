package species.acanthocephala.palaeacanthocephala.centrorhynchidae;
...
/**
 * Signal Processing for Family: Centrorhynchidae
 * <p>Phylum: Acanthocephala | Class: Palaeacanthocephala | Order: Polymorphida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/centrorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16558; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala/centrorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, "Centrorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("centrorhynchidae_audio", "species.acanthocephala.palaeacanthocephala.centrorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("centrorhynchidae_data", "species.acanthocephala.palaeacanthocephala.centrorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("centrorhynchidae_graphics", "species.acanthocephala.palaeacanthocephala.centrorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}