package species.acanthocephala.palaeacanthocephala.illiosentidae;
...
/**
 * Signal Processing for Family: Illiosentidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/illiosentidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16551; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala/illiosentidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, "Illiosentidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("illiosentidae_audio", "species.acanthocephala.palaeacanthocephala.illiosentidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("illiosentidae_data", "species.acanthocephala.palaeacanthocephala.illiosentidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("illiosentidae_graphics", "species.acanthocephala.palaeacanthocephala.illiosentidae.graphics.spectrum", sb.toString());
        }
    }
}