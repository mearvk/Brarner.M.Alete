package species.acanthocephala.palaeacanthocephala;
...
/**
 * Signal Processing for Phylum: Acanthocephala, Class: Palaeacanthocephala
 * <p>Families: 17</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16543; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
             PreparedStatement ps = conn.prepareStatement(
                 "INSERT INTO species_experiments (phylum, class_name, experiment_name, experiment_data, installer_tax_id) VALUES (?, ?, ?, ?, 'MEARVK-LLC-2026')")) {
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocephala_palaeacanthocephala_audio", "species.acanthocephala.palaeacanthocephala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocephala_palaeacanthocephala_data", "species.acanthocephala.palaeacanthocephala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocephala_palaeacanthocephala_graphics", "species.acanthocephala.palaeacanthocephala.graphics.spectrum", sb.toString());
        }
    }
}