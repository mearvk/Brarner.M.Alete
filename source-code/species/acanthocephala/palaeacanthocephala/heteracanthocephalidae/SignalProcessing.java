package species.acanthocephala.palaeacanthocephala.heteracanthocephalidae;
...
/**
 * Signal Processing for Family: Heteracanthocephalidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/palaeacanthocephala/heteracanthocephalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16550; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/palaeacanthocephala/heteracanthocephalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Palaeacanthocephala"); ps.setString(3, "Heteracanthocephalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heteracanthocephalidae_audio", "species.acanthocephala.palaeacanthocephala.heteracanthocephalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heteracanthocephalidae_data", "species.acanthocephala.palaeacanthocephala.heteracanthocephalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heteracanthocephalidae_graphics", "species.acanthocephala.palaeacanthocephala.heteracanthocephalidae.graphics.spectrum", sb.toString());
        }
    }
}