package species.acanthocephala.archiacanthocephala.oligacanthorhynchidae;
...
/**
 * Signal Processing for Family: Oligacanthorhynchidae
 * <p>Phylum: Acanthocephala | Class: Archiacanthocephala | Order: Oligacanthorhynchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/archiacanthocephala/oligacanthorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16537; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/archiacanthocephala/oligacanthorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Archiacanthocephala"); ps.setString(3, "Oligacanthorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("oligacanthorhynchidae_audio", "species.acanthocephala.archiacanthocephala.oligacanthorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("oligacanthorhynchidae_data", "species.acanthocephala.archiacanthocephala.oligacanthorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("oligacanthorhynchidae_graphics", "species.acanthocephala.archiacanthocephala.oligacanthorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}