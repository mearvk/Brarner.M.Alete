package species.acanthocephala.archiacanthocephala;
...
/**
 * Signal Processing for Phylum: Acanthocephala, Class: Archiacanthocephala
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/archiacanthocephala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16533; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/archiacanthocephala";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Archiacanthocephala"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocephala_archiacanthocephala_audio", "species.acanthocephala.archiacanthocephala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocephala_archiacanthocephala_data", "species.acanthocephala.archiacanthocephala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocephala_archiacanthocephala_graphics", "species.acanthocephala.archiacanthocephala.graphics.spectrum", sb.toString());
        }
    }
}