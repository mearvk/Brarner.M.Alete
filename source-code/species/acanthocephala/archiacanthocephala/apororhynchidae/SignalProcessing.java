package species.acanthocephala.archiacanthocephala.apororhynchidae;
...
/**
 * Signal Processing for Family: Apororhynchidae
 * <p>Phylum: Acanthocephala | Class: Archiacanthocephala | Order: Apororhynchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/archiacanthocephala/apororhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16534; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/archiacanthocephala/apororhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Archiacanthocephala"); ps.setString(3, "Apororhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("apororhynchidae_audio", "species.acanthocephala.archiacanthocephala.apororhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("apororhynchidae_data", "species.acanthocephala.archiacanthocephala.apororhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("apororhynchidae_graphics", "species.acanthocephala.archiacanthocephala.apororhynchidae.graphics.spectrum", sb.toString());
        }
    }
}