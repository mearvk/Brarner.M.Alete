package species.acanthocephala.archiacanthocephala.moniliformidae;
...
/**
 * Signal Processing for Family: Moniliformidae
 * <p>Phylum: Acanthocephala | Class: Archiacanthocephala | Order: Moniliformida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/archiacanthocephala/moniliformidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16536; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/archiacanthocephala/moniliformidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Archiacanthocephala"); ps.setString(3, "Moniliformidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("moniliformidae_audio", "species.acanthocephala.archiacanthocephala.moniliformidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("moniliformidae_data", "species.acanthocephala.archiacanthocephala.moniliformidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("moniliformidae_graphics", "species.acanthocephala.archiacanthocephala.moniliformidae.graphics.spectrum", sb.toString());
        }
    }
}