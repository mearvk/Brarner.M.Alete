package species.acanthocephala.archiacanthocephala.giganthorhynchidae;
...
/**
 * Signal Processing for Family: Giganthorhynchidae
 * <p>Phylum: Acanthocephala | Class: Archiacanthocephala | Order: Gigantorhynchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/archiacanthocephala/giganthorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16535; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/archiacanthocephala/giganthorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Archiacanthocephala"); ps.setString(3, "Giganthorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("giganthorhynchidae_audio", "species.acanthocephala.archiacanthocephala.giganthorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("giganthorhynchidae_data", "species.acanthocephala.archiacanthocephala.giganthorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("giganthorhynchidae_graphics", "species.acanthocephala.archiacanthocephala.giganthorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}