package species.acanthocephala.polyacanthocephala;
...
/**
 * Signal Processing for Phylum: Acanthocephala, Class: Polyacanthocephala
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/polyacanthocephala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16561; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/polyacanthocephala";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Polyacanthocephala"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthocephala_polyacanthocephala_audio", "species.acanthocephala.polyacanthocephala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthocephala_polyacanthocephala_data", "species.acanthocephala.polyacanthocephala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthocephala_polyacanthocephala_graphics", "species.acanthocephala.polyacanthocephala.graphics.spectrum", sb.toString());
        }
    }
}