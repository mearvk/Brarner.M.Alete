package species.acanthocephala.polyacanthocephala.polyacanthorhynchidae;
...
/**
 * Signal Processing for Family: Polyacanthorhynchidae
 * <p>Phylum: Acanthocephala | Class: Polyacanthocephala | Order: Polyacanthorhynchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/acanthocephala/polyacanthocephala/polyacanthorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16562; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/acanthocephala/polyacanthocephala/polyacanthorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Acanthocephala"); ps.setString(2, "Polyacanthocephala"); ps.setString(3, "Polyacanthorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polyacanthorhynchidae_audio", "species.acanthocephala.polyacanthocephala.polyacanthorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polyacanthorhynchidae_data", "species.acanthocephala.polyacanthocephala.polyacanthorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polyacanthorhynchidae_graphics", "species.acanthocephala.polyacanthocephala.polyacanthorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}