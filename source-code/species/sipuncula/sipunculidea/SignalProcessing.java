package species.sipuncula.sipunculidea;
...
/**
 * Signal Processing for Phylum: Sipuncula, Class: Sipunculidea
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/sipunculidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18308; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/sipunculidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Sipunculidea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sipuncula_sipunculidea_audio", "species.sipuncula.sipunculidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sipuncula_sipunculidea_data", "species.sipuncula.sipunculidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sipuncula_sipunculidea_graphics", "species.sipuncula.sipunculidea.graphics.spectrum", sb.toString());
        }
    }
}