package species.sipuncula.sipunculidea.sipunculidae;
...
/**
 * Signal Processing for Family: Sipunculidae
 * <p>Phylum: Sipuncula | Class: Sipunculidea | Order: Sipunculiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/sipunculidea/sipunculidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18312; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/sipunculidea/sipunculidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Sipunculidea"); ps.setString(3, "Sipunculidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sipunculidae_audio", "species.sipuncula.sipunculidea.sipunculidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sipunculidae_data", "species.sipuncula.sipunculidea.sipunculidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sipunculidae_graphics", "species.sipuncula.sipunculidea.sipunculidae.graphics.spectrum", sb.toString());
        }
    }
}