package species.sipuncula.sipunculidea.themistidae;
...
/**
 * Signal Processing for Family: Themistidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/sipunculidea/themistidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18311; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/sipunculidea/themistidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Sipunculidea"); ps.setString(3, "Themistidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("themistidae_audio", "species.sipuncula.sipunculidea.themistidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("themistidae_data", "species.sipuncula.sipunculidea.themistidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("themistidae_graphics", "species.sipuncula.sipunculidea.themistidae.graphics.spectrum", sb.toString());
        }
    }
}