package species.sipuncula.sipunculidea.golfingiidae;
...
/**
 * Signal Processing for Family: Golfingiidae
 * <p>Phylum: Sipuncula | Class: Sipunculidea | Order: Golfingiiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/sipunculidea/golfingiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18309; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/sipunculidea/golfingiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Sipunculidea"); ps.setString(3, "Golfingiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("golfingiidae_audio", "species.sipuncula.sipunculidea.golfingiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("golfingiidae_data", "species.sipuncula.sipunculidea.golfingiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("golfingiidae_graphics", "species.sipuncula.sipunculidea.golfingiidae.graphics.spectrum", sb.toString());
        }
    }
}