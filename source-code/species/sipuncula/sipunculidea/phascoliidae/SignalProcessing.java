package species.sipuncula.sipunculidea.phascoliidae;
...
/**
 * Signal Processing for Family: Phascoliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/sipunculidea/phascoliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18310; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/sipunculidea/phascoliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Sipunculidea"); ps.setString(3, "Phascoliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phascoliidae_audio", "species.sipuncula.sipunculidea.phascoliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phascoliidae_data", "species.sipuncula.sipunculidea.phascoliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phascoliidae_graphics", "species.sipuncula.sipunculidea.phascoliidae.graphics.spectrum", sb.toString());
        }
    }
}