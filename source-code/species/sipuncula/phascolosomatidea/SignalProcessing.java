package species.sipuncula.phascolosomatidea;
...
/**
 * Signal Processing for Phylum: Sipuncula, Class: Phascolosomatidea
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/phascolosomatidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18305; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/phascolosomatidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Phascolosomatidea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sipuncula_phascolosomatidea_audio", "species.sipuncula.phascolosomatidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sipuncula_phascolosomatidea_data", "species.sipuncula.phascolosomatidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sipuncula_phascolosomatidea_graphics", "species.sipuncula.phascolosomatidea.graphics.spectrum", sb.toString());
        }
    }
}