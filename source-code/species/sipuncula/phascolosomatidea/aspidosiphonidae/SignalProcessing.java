package species.sipuncula.phascolosomatidea.aspidosiphonidae;
...
/**
 * Signal Processing for Family: Aspidosiphonidae
 * <p>Phylum: Sipuncula | Class: Phascolosomatidea | Order: Aspidosiphoniformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/phascolosomatidea/aspidosiphonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18306; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/phascolosomatidea/aspidosiphonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Phascolosomatidea"); ps.setString(3, "Aspidosiphonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aspidosiphonidae_audio", "species.sipuncula.phascolosomatidea.aspidosiphonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aspidosiphonidae_data", "species.sipuncula.phascolosomatidea.aspidosiphonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aspidosiphonidae_graphics", "species.sipuncula.phascolosomatidea.aspidosiphonidae.graphics.spectrum", sb.toString());
        }
    }
}