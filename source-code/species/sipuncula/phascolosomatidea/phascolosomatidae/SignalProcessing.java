package species.sipuncula.phascolosomatidea.phascolosomatidae;
...
/**
 * Signal Processing for Family: Phascolosomatidae
 * <p>Phylum: Sipuncula | Class: Phascolosomatidea | Order: Phascolosomatiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/phascolosomatidea/phascolosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18307; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula/phascolosomatidea/phascolosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, "Phascolosomatidea"); ps.setString(3, "Phascolosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phascolosomatidae_audio", "species.sipuncula.phascolosomatidea.phascolosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phascolosomatidae_data", "species.sipuncula.phascolosomatidea.phascolosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phascolosomatidae_graphics", "species.sipuncula.phascolosomatidea.phascolosomatidae.graphics.spectrum", sb.toString());
        }
    }
}