...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Sipuncula
 * <p>Classes: 2 | Families: 6</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/sipuncula/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10434; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/sipuncula";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Sipuncula"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_sipuncula_audio", "species.sipuncula.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_sipuncula_data", "species.sipuncula.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_sipuncula_graphics", "species.sipuncula.graphics.spectrum", sb.toString());
        }
    }
}