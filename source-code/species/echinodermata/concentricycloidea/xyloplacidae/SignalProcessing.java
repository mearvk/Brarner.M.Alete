package species.echinodermata.concentricycloidea.xyloplacidae;
...
/**
 * Signal Processing for Family: Xyloplacidae
 * <p>Phylum: Echinodermata | Class: Concentricycloidea | Order: Peripodida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/concentricycloidea/xyloplacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12699; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/concentricycloidea/xyloplacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Concentricycloidea"); ps.setString(3, "Xyloplacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xyloplacidae_audio", "species.echinodermata.concentricycloidea.xyloplacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xyloplacidae_data", "species.echinodermata.concentricycloidea.xyloplacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xyloplacidae_graphics", "species.echinodermata.concentricycloidea.xyloplacidae.graphics.spectrum", sb.toString());
        }
    }
}