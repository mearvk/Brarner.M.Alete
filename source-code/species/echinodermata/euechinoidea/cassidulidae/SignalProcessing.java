package species.echinodermata.euechinoidea.cassidulidae;
...
/**
 * Signal Processing for Family: Cassidulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/cassidulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12735; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/cassidulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Cassidulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cassidulidae_audio", "species.echinodermata.euechinoidea.cassidulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cassidulidae_data", "species.echinodermata.euechinoidea.cassidulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cassidulidae_graphics", "species.echinodermata.euechinoidea.cassidulidae.graphics.spectrum", sb.toString());
        }
    }
}