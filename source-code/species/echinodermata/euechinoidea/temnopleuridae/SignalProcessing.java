package species.echinodermata.euechinoidea.temnopleuridae;
...
/**
 * Signal Processing for Family: Temnopleuridae
 * <p>Phylum: Echinodermata | Class: Euechinoidea | Order: Temnopleuroida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/temnopleuridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12767; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/temnopleuridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Temnopleuridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("temnopleuridae_audio", "species.echinodermata.euechinoidea.temnopleuridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("temnopleuridae_data", "species.echinodermata.euechinoidea.temnopleuridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("temnopleuridae_graphics", "species.echinodermata.euechinoidea.temnopleuridae.graphics.spectrum", sb.toString());
        }
    }
}