package species.echinodermata.euechinoidea.strongylocentrotidae;
...
/**
 * Signal Processing for Family: Strongylocentrotidae
 * <p>Phylum: Echinodermata | Class: Euechinoidea | Order: Echinoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/strongylocentrotidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12763; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/strongylocentrotidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Strongylocentrotidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("strongylocentrotidae_audio", "species.echinodermata.euechinoidea.strongylocentrotidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("strongylocentrotidae_data", "species.echinodermata.euechinoidea.strongylocentrotidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("strongylocentrotidae_graphics", "species.echinodermata.euechinoidea.strongylocentrotidae.graphics.spectrum", sb.toString());
        }
    }
}