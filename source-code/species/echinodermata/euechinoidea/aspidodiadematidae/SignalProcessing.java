package species.echinodermata.euechinoidea.aspidodiadematidae;
...
/**
 * Signal Processing for Family: Aspidodiadematidae
 * <p>Phylum: Echinodermata | Class: Euechinoidea | Order: Diadematoida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/aspidodiadematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12753; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/aspidodiadematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Aspidodiadematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aspidodiadematidae_audio", "species.echinodermata.euechinoidea.aspidodiadematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aspidodiadematidae_data", "species.echinodermata.euechinoidea.aspidodiadematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aspidodiadematidae_graphics", "species.echinodermata.euechinoidea.aspidodiadematidae.graphics.spectrum", sb.toString());
        }
    }
}