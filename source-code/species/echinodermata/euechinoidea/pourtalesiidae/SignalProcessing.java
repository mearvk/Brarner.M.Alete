package species.echinodermata.euechinoidea.pourtalesiidae;
...
/**
 * Signal Processing for Family: Pourtalesiidae
 * <p>Phylum: Echinodermata | Class: Euechinoidea | Order: Holasterina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/pourtalesiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12746; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/pourtalesiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Pourtalesiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pourtalesiidae_audio", "species.echinodermata.euechinoidea.pourtalesiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pourtalesiidae_data", "species.echinodermata.euechinoidea.pourtalesiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pourtalesiidae_graphics", "species.echinodermata.euechinoidea.pourtalesiidae.graphics.spectrum", sb.toString());
        }
    }
}