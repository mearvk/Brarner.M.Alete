package species.echinodermata.euechinoidea.echinolampadidae;
...
/**
 * Signal Processing for Family: Echinolampadidae
 * <p>Phylum: Echinodermata | Class: Euechinoidea | Order: Cassiduloida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/euechinoidea/echinolampadidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12736; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/euechinoidea/echinolampadidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Euechinoidea"); ps.setString(3, "Echinolampadidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("echinolampadidae_audio", "species.echinodermata.euechinoidea.echinolampadidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("echinolampadidae_data", "species.echinodermata.euechinoidea.echinolampadidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("echinolampadidae_graphics", "species.echinodermata.euechinoidea.echinolampadidae.graphics.spectrum", sb.toString());
        }
    }
}