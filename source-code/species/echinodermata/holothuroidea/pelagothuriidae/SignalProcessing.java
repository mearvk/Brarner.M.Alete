package species.echinodermata.holothuroidea.pelagothuriidae;
...
/**
 * Signal Processing for Family: Pelagothuriidae
 * <p>Phylum: Echinodermata | Class: Holothuroidea | Order: Elasipodida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/holothuroidea/pelagothuriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12799; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/holothuroidea/pelagothuriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Holothuroidea"); ps.setString(3, "Pelagothuriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pelagothuriidae_audio", "species.echinodermata.holothuroidea.pelagothuriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pelagothuriidae_data", "species.echinodermata.holothuroidea.pelagothuriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pelagothuriidae_graphics", "species.echinodermata.holothuroidea.pelagothuriidae.graphics.spectrum", sb.toString());
        }
    }
}