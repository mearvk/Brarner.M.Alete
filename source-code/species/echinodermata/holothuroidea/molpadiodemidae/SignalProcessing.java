package species.echinodermata.holothuroidea.molpadiodemidae;
...
/**
 * Signal Processing for Family: Molpadiodemidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/holothuroidea/molpadiodemidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12807; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/holothuroidea/molpadiodemidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Holothuroidea"); ps.setString(3, "Molpadiodemidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("molpadiodemidae_audio", "species.echinodermata.holothuroidea.molpadiodemidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("molpadiodemidae_data", "species.echinodermata.holothuroidea.molpadiodemidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("molpadiodemidae_graphics", "species.echinodermata.holothuroidea.molpadiodemidae.graphics.spectrum", sb.toString());
        }
    }
}