package species.echinodermata.holothuroidea.vaneyellidae;
...
/**
 * Signal Processing for Family: Vaneyellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/holothuroidea/vaneyellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12795; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/holothuroidea/vaneyellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Holothuroidea"); ps.setString(3, "Vaneyellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("vaneyellidae_audio", "species.echinodermata.holothuroidea.vaneyellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("vaneyellidae_data", "species.echinodermata.holothuroidea.vaneyellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("vaneyellidae_graphics", "species.echinodermata.holothuroidea.vaneyellidae.graphics.spectrum", sb.toString());
        }
    }
}