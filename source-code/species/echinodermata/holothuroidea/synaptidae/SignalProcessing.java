package species.echinodermata.holothuroidea.synaptidae;
...
/**
 * Signal Processing for Family: Synaptidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/holothuroidea/synaptidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12785; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/holothuroidea/synaptidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Holothuroidea"); ps.setString(3, "Synaptidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("synaptidae_audio", "species.echinodermata.holothuroidea.synaptidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("synaptidae_data", "species.echinodermata.holothuroidea.synaptidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("synaptidae_graphics", "species.echinodermata.holothuroidea.synaptidae.graphics.spectrum", sb.toString());
        }
    }
}