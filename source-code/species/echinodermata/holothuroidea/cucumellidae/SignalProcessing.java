package species.echinodermata.holothuroidea.cucumellidae;
...
/**
 * Signal Processing for Family: Cucumellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/holothuroidea/cucumellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12787; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/holothuroidea/cucumellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Holothuroidea"); ps.setString(3, "Cucumellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cucumellidae_audio", "species.echinodermata.holothuroidea.cucumellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cucumellidae_data", "species.echinodermata.holothuroidea.cucumellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cucumellidae_graphics", "species.echinodermata.holothuroidea.cucumellidae.graphics.spectrum", sb.toString());
        }
    }
}