package species.echinodermata.articulata.antedonidae;
...
/**
 * Signal Processing for Family: Antedonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/antedonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12720; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/antedonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Antedonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("antedonidae_audio", "species.echinodermata.articulata.antedonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("antedonidae_data", "species.echinodermata.articulata.antedonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("antedonidae_graphics", "species.echinodermata.articulata.antedonidae.graphics.spectrum", sb.toString());
        }
    }
}