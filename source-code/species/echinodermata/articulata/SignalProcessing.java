package species.echinodermata.articulata;
...
/**
 * Signal Processing for Phylum: Echinodermata, Class: Articulata
 * <p>Families: 15</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12718; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("echinodermata_articulata_audio", "species.echinodermata.articulata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("echinodermata_articulata_data", "species.echinodermata.articulata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("echinodermata_articulata_graphics", "species.echinodermata.articulata.graphics.spectrum", sb.toString());
        }
    }
}