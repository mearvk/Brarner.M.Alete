package species.echinodermata.articulata.charitometridae;
...
/**
 * Signal Processing for Family: Charitometridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/charitometridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12725; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/charitometridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Charitometridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("charitometridae_audio", "species.echinodermata.articulata.charitometridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("charitometridae_data", "species.echinodermata.articulata.charitometridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("charitometridae_graphics", "species.echinodermata.articulata.charitometridae.graphics.spectrum", sb.toString());
        }
    }
}