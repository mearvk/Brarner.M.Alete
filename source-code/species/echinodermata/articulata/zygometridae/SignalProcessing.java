package species.echinodermata.articulata.zygometridae;
...
/**
 * Signal Processing for Family: Zygometridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/zygometridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12733; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/zygometridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Zygometridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("zygometridae_audio", "species.echinodermata.articulata.zygometridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("zygometridae_data", "species.echinodermata.articulata.zygometridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("zygometridae_graphics", "species.echinodermata.articulata.zygometridae.graphics.spectrum", sb.toString());
        }
    }
}