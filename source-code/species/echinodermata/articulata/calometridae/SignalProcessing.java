package species.echinodermata.articulata.calometridae;
...
/**
 * Signal Processing for Family: Calometridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/calometridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12724; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/calometridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Calometridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calometridae_audio", "species.echinodermata.articulata.calometridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calometridae_data", "species.echinodermata.articulata.calometridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calometridae_graphics", "species.echinodermata.articulata.calometridae.graphics.spectrum", sb.toString());
        }
    }
}