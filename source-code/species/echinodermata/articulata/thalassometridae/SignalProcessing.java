package species.echinodermata.articulata.thalassometridae;
...
/**
 * Signal Processing for Family: Thalassometridae
 * <p>Phylum: Echinodermata | Class: Articulata | Order: Oligophreata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/thalassometridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12731; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/thalassometridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Thalassometridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thalassometridae_audio", "species.echinodermata.articulata.thalassometridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thalassometridae_data", "species.echinodermata.articulata.thalassometridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thalassometridae_graphics", "species.echinodermata.articulata.thalassometridae.graphics.spectrum", sb.toString());
        }
    }
}