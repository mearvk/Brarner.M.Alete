package species.echinodermata.articulata.bathycrinidae;
...
/**
 * Signal Processing for Family: Bathycrinidae
 * <p>Phylum: Echinodermata | Class: Articulata | Order: Bourgueticrinida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/bathycrinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12719; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/bathycrinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Bathycrinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathycrinidae_audio", "species.echinodermata.articulata.bathycrinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathycrinidae_data", "species.echinodermata.articulata.bathycrinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathycrinidae_graphics", "species.echinodermata.articulata.bathycrinidae.graphics.spectrum", sb.toString());
        }
    }
}