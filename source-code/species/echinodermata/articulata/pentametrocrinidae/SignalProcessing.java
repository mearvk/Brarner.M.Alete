package species.echinodermata.articulata.pentametrocrinidae;
...
/**
 * Signal Processing for Family: Pentametrocrinidae
 * <p>Phylum: Echinodermata | Class: Articulata | Order: Macrophreata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/articulata/pentametrocrinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12723; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/articulata/pentametrocrinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Articulata"); ps.setString(3, "Pentametrocrinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pentametrocrinidae_audio", "species.echinodermata.articulata.pentametrocrinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pentametrocrinidae_data", "species.echinodermata.articulata.pentametrocrinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pentametrocrinidae_graphics", "species.echinodermata.articulata.pentametrocrinidae.graphics.spectrum", sb.toString());
        }
    }
}