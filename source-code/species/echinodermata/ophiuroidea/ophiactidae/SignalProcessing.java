package species.echinodermata.ophiuroidea.ophiactidae;
...
/**
 * Signal Processing for Family: Ophiactidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/ophiuroidea/ophiactidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12709; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/ophiuroidea/ophiactidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Ophiuroidea"); ps.setString(3, "Ophiactidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ophiactidae_audio", "species.echinodermata.ophiuroidea.ophiactidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ophiactidae_data", "species.echinodermata.ophiuroidea.ophiactidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ophiactidae_graphics", "species.echinodermata.ophiuroidea.ophiactidae.graphics.spectrum", sb.toString());
        }
    }
}