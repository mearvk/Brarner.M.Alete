package species.echinodermata.ophiuroidea.ophiomyxidae;
...
/**
 * Signal Processing for Family: Ophiomyxidae
 * <p>Phylum: Echinodermata | Class: Ophiuroidea | Order: Ophiomyxina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/ophiuroidea/ophiomyxidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12717; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/ophiuroidea/ophiomyxidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Ophiuroidea"); ps.setString(3, "Ophiomyxidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ophiomyxidae_audio", "species.echinodermata.ophiuroidea.ophiomyxidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ophiomyxidae_data", "species.echinodermata.ophiuroidea.ophiomyxidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ophiomyxidae_graphics", "species.echinodermata.ophiuroidea.ophiomyxidae.graphics.spectrum", sb.toString());
        }
    }
}