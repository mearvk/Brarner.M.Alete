package species.echinodermata.ophiuroidea.hemieuryalidae;
...
/**
 * Signal Processing for Family: Hemieuryalidae
 * <p>Phylum: Echinodermata | Class: Ophiuroidea | Order: Laemophiurina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/ophiuroidea/hemieuryalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12711; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/ophiuroidea/hemieuryalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Ophiuroidea"); ps.setString(3, "Hemieuryalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hemieuryalidae_audio", "species.echinodermata.ophiuroidea.hemieuryalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hemieuryalidae_data", "species.echinodermata.ophiuroidea.hemieuryalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hemieuryalidae_graphics", "species.echinodermata.ophiuroidea.hemieuryalidae.graphics.spectrum", sb.toString());
        }
    }
}