package species.echinodermata.ophiuroidea;
...
/**
 * Signal Processing for Phylum: Echinodermata, Class: Ophiuroidea
 * <p>Families: 17</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/ophiuroidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12700; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/ophiuroidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Ophiuroidea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("echinodermata_ophiuroidea_audio", "species.echinodermata.ophiuroidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("echinodermata_ophiuroidea_data", "species.echinodermata.ophiuroidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("echinodermata_ophiuroidea_graphics", "species.echinodermata.ophiuroidea.graphics.spectrum", sb.toString());
        }
    }
}