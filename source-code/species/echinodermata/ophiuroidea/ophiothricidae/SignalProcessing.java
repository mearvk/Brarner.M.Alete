package species.echinodermata.ophiuroidea.ophiothricidae;
...
/**
 * Signal Processing for Family: Ophiothricidae
 * <p>Phylum: Echinodermata | Class: Ophiuroidea | Order: Gnathophiurina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/ophiuroidea/ophiothricidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12710; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/ophiuroidea/ophiothricidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Ophiuroidea"); ps.setString(3, "Ophiothricidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ophiothricidae_audio", "species.echinodermata.ophiuroidea.ophiothricidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ophiothricidae_data", "species.echinodermata.ophiuroidea.ophiothricidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ophiothricidae_graphics", "species.echinodermata.ophiuroidea.ophiothricidae.graphics.spectrum", sb.toString());
        }
    }
}