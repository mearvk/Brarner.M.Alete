package species.echinodermata.asteroidea.archasteridae;
...
/**
 * Signal Processing for Family: Archasteridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/asteroidea/archasteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12683; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/asteroidea/archasteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Asteroidea"); ps.setString(3, "Archasteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("archasteridae_audio", "species.echinodermata.asteroidea.archasteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("archasteridae_data", "species.echinodermata.asteroidea.archasteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("archasteridae_graphics", "species.echinodermata.asteroidea.archasteridae.graphics.spectrum", sb.toString());
        }
    }
}