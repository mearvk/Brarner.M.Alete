package species.echinodermata.asteroidea.zoroasteridae;
...
/**
 * Signal Processing for Family: Zoroasteridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/asteroidea/zoroasteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12672; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/asteroidea/zoroasteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Asteroidea"); ps.setString(3, "Zoroasteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("zoroasteridae_audio", "species.echinodermata.asteroidea.zoroasteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("zoroasteridae_data", "species.echinodermata.asteroidea.zoroasteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("zoroasteridae_graphics", "species.echinodermata.asteroidea.zoroasteridae.graphics.spectrum", sb.toString());
        }
    }
}