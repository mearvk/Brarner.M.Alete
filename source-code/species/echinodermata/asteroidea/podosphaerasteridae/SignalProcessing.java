package species.echinodermata.asteroidea.podosphaerasteridae;
...
/**
 * Signal Processing for Family: Podosphaerasteridae
 * <p>Phylum: Echinodermata | Class: Asteroidea | Order: Valvatida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/asteroidea/podosphaerasteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12695; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/asteroidea/podosphaerasteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Asteroidea"); ps.setString(3, "Podosphaerasteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("podosphaerasteridae_audio", "species.echinodermata.asteroidea.podosphaerasteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("podosphaerasteridae_data", "species.echinodermata.asteroidea.podosphaerasteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("podosphaerasteridae_graphics", "species.echinodermata.asteroidea.podosphaerasteridae.graphics.spectrum", sb.toString());
        }
    }
}