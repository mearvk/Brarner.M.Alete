package species.echinodermata.asteroidea.pseudarchasteridae;
...
/**
 * Signal Processing for Family: Pseudarchasteridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/asteroidea/pseudarchasteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12680; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/asteroidea/pseudarchasteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Asteroidea"); ps.setString(3, "Pseudarchasteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudarchasteridae_audio", "species.echinodermata.asteroidea.pseudarchasteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudarchasteridae_data", "species.echinodermata.asteroidea.pseudarchasteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudarchasteridae_graphics", "species.echinodermata.asteroidea.pseudarchasteridae.graphics.spectrum", sb.toString());
        }
    }
}