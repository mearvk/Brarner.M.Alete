package species.echinodermata.perischoechinoidea.cidaridae;
...
/**
 * Signal Processing for Family: Cidaridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/perischoechinoidea/cidaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12780; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/perischoechinoidea/cidaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Perischoechinoidea"); ps.setString(3, "Cidaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cidaridae_audio", "species.echinodermata.perischoechinoidea.cidaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cidaridae_data", "species.echinodermata.perischoechinoidea.cidaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cidaridae_graphics", "species.echinodermata.perischoechinoidea.cidaridae.graphics.spectrum", sb.toString());
        }
    }
}