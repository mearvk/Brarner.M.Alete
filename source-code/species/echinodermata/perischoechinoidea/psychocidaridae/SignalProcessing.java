package species.echinodermata.perischoechinoidea.psychocidaridae;
...
/**
 * Signal Processing for Family: Psychocidaridae
 * <p>Phylum: Echinodermata | Class: Perischoechinoidea | Order: Cidaroida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/echinodermata/perischoechinoidea/psychocidaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12781; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/echinodermata/perischoechinoidea/psychocidaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Echinodermata"); ps.setString(2, "Perischoechinoidea"); ps.setString(3, "Psychocidaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("psychocidaridae_audio", "species.echinodermata.perischoechinoidea.psychocidaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("psychocidaridae_data", "species.echinodermata.perischoechinoidea.psychocidaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("psychocidaridae_graphics", "species.echinodermata.perischoechinoidea.psychocidaridae.graphics.spectrum", sb.toString());
        }
    }
}