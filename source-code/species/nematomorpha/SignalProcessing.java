...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Nematomorpha
 * <p>Classes: 0 | Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematomorpha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10414; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematomorpha";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematomorpha"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_nematomorpha_audio", "species.nematomorpha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_nematomorpha_data", "species.nematomorpha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_nematomorpha_graphics", "species.nematomorpha.graphics.spectrum", sb.toString());
        }
    }
}