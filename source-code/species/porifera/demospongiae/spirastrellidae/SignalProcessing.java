package species.porifera.demospongiae.spirastrellidae;
...
/**
 * Signal Processing for Family: Spirastrellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/spirastrellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11360; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/spirastrellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Spirastrellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spirastrellidae_audio", "species.porifera.demospongiae.spirastrellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spirastrellidae_data", "species.porifera.demospongiae.spirastrellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spirastrellidae_graphics", "species.porifera.demospongiae.spirastrellidae.graphics.spectrum", sb.toString());
        }
    }
}