package species.porifera.demospongiae.trachycladidae;
...
/**
 * Signal Processing for Family: Trachycladidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/trachycladidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11365; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/trachycladidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Trachycladidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trachycladidae_audio", "species.porifera.demospongiae.trachycladidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trachycladidae_data", "species.porifera.demospongiae.trachycladidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trachycladidae_graphics", "species.porifera.demospongiae.trachycladidae.graphics.spectrum", sb.toString());
        }
    }
}