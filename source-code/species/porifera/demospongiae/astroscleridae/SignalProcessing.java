package species.porifera.demospongiae.astroscleridae;
...
/**
 * Signal Processing for Family: Astroscleridae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Agelasida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/astroscleridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11338; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/astroscleridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Astroscleridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("astroscleridae_audio", "species.porifera.demospongiae.astroscleridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("astroscleridae_data", "species.porifera.demospongiae.astroscleridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("astroscleridae_graphics", "species.porifera.demospongiae.astroscleridae.graphics.spectrum", sb.toString());
        }
    }
}