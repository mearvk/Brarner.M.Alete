package species.porifera.demospongiae.calcifibrospongiidae;
...
/**
 * Signal Processing for Family: Calcifibrospongiidae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Petrosina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/calcifibrospongiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11376; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/calcifibrospongiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Calcifibrospongiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calcifibrospongiidae_audio", "species.porifera.demospongiae.calcifibrospongiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calcifibrospongiidae_data", "species.porifera.demospongiae.calcifibrospongiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calcifibrospongiidae_graphics", "species.porifera.demospongiae.calcifibrospongiidae.graphics.spectrum", sb.toString());
        }
    }
}