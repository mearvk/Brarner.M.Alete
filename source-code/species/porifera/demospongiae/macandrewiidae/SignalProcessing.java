package species.porifera.demospongiae.macandrewiidae;
...
/**
 * Signal Processing for Family: Macandrewiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/macandrewiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11390; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/macandrewiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Macandrewiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("macandrewiidae_audio", "species.porifera.demospongiae.macandrewiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("macandrewiidae_data", "species.porifera.demospongiae.macandrewiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("macandrewiidae_graphics", "species.porifera.demospongiae.macandrewiidae.graphics.spectrum", sb.toString());
        }
    }
}