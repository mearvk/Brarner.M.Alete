package species.porifera.demospongiae.spirasigmidae;
...
/**
 * Signal Processing for Family: Spirasigmidae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Spirophorida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/spirasigmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11430; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/spirasigmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Spirasigmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spirasigmidae_audio", "species.porifera.demospongiae.spirasigmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spirasigmidae_data", "species.porifera.demospongiae.spirasigmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spirasigmidae_graphics", "species.porifera.demospongiae.spirasigmidae.graphics.spectrum", sb.toString());
        }
    }
}