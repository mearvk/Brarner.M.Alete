package species.porifera.demospongiae.nepheliospongiidae;
...
/**
 * Signal Processing for Family: Nepheliospongiidae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Haplosclerida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/nepheliospongiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11372; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/nepheliospongiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Nepheliospongiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nepheliospongiidae_audio", "species.porifera.demospongiae.nepheliospongiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nepheliospongiidae_data", "species.porifera.demospongiae.nepheliospongiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nepheliospongiidae_graphics", "species.porifera.demospongiae.nepheliospongiidae.graphics.spectrum", sb.toString());
        }
    }
}