package species.porifera.demospongiae.dictyodendrillidae;
...
/**
 * Signal Processing for Family: Dictyodendrillidae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Dendroceratida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/dictyodendrillidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11346; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/dictyodendrillidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Dictyodendrillidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dictyodendrillidae_audio", "species.porifera.demospongiae.dictyodendrillidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dictyodendrillidae_data", "species.porifera.demospongiae.dictyodendrillidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dictyodendrillidae_graphics", "species.porifera.demospongiae.dictyodendrillidae.graphics.spectrum", sb.toString());
        }
    }
}