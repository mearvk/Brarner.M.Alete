package species.porifera.demospongiae.sigmaxinellidae;
...
/**
 * Signal Processing for Family: Sigmaxinellidae
 * <p>Phylum: Porifera | Class: Demospongiae | Order: Mycalina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/sigmaxinellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11417; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/sigmaxinellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Sigmaxinellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sigmaxinellidae_audio", "species.porifera.demospongiae.sigmaxinellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sigmaxinellidae_data", "species.porifera.demospongiae.sigmaxinellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sigmaxinellidae_graphics", "species.porifera.demospongiae.sigmaxinellidae.graphics.spectrum", sb.toString());
        }
    }
}