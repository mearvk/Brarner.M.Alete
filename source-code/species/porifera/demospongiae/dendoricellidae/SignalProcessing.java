package species.porifera.demospongiae.dendoricellidae;
...
/**
 * Signal Processing for Family: Dendoricellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/dendoricellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11422; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/dendoricellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Dendoricellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendoricellidae_audio", "species.porifera.demospongiae.dendoricellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendoricellidae_data", "species.porifera.demospongiae.dendoricellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendoricellidae_graphics", "species.porifera.demospongiae.dendoricellidae.graphics.spectrum", sb.toString());
        }
    }
}