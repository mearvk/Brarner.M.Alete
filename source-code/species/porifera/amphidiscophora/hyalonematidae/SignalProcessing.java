package species.porifera.amphidiscophora.hyalonematidae;
...
/**
 * Signal Processing for Family: Hyalonematidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/amphidiscophora/hyalonematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11438; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/amphidiscophora/hyalonematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Amphidiscophora"); ps.setString(3, "Hyalonematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hyalonematidae_audio", "species.porifera.amphidiscophora.hyalonematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hyalonematidae_data", "species.porifera.amphidiscophora.hyalonematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hyalonematidae_graphics", "species.porifera.amphidiscophora.hyalonematidae.graphics.spectrum", sb.toString());
        }
    }
}