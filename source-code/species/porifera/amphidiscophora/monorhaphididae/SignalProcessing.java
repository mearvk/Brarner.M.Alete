package species.porifera.amphidiscophora.monorhaphididae;
...
/**
 * Signal Processing for Family: Monorhaphididae
 * <p>Phylum: Porifera | Class: Amphidiscophora | Order: Amphidiscosida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/amphidiscophora/monorhaphididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11439; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/amphidiscophora/monorhaphididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Amphidiscophora"); ps.setString(3, "Monorhaphididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("monorhaphididae_audio", "species.porifera.amphidiscophora.monorhaphididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("monorhaphididae_data", "species.porifera.amphidiscophora.monorhaphididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("monorhaphididae_graphics", "species.porifera.amphidiscophora.monorhaphididae.graphics.spectrum", sb.toString());
        }
    }
}