package species.porifera.amphidiscophora.pheronematidae;
...
/**
 * Signal Processing for Family: Pheronematidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/amphidiscophora/pheronematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11440; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/amphidiscophora/pheronematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Amphidiscophora"); ps.setString(3, "Pheronematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pheronematidae_audio", "species.porifera.amphidiscophora.pheronematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pheronematidae_data", "species.porifera.amphidiscophora.pheronematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pheronematidae_graphics", "species.porifera.amphidiscophora.pheronematidae.graphics.spectrum", sb.toString());
        }
    }
}