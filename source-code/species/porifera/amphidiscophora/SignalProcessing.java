package species.porifera.amphidiscophora;
...
/**
 * Signal Processing for Phylum: Porifera, Class: Amphidiscophora
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/amphidiscophora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11437; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/amphidiscophora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Amphidiscophora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("porifera_amphidiscophora_audio", "species.porifera.amphidiscophora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("porifera_amphidiscophora_data", "species.porifera.amphidiscophora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("porifera_amphidiscophora_graphics", "species.porifera.amphidiscophora.graphics.spectrum", sb.toString());
        }
    }
}