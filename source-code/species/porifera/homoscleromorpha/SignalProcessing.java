package species.porifera.homoscleromorpha;
...
/**
 * Signal Processing for Phylum: Porifera, Class: Homoscleromorpha
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/homoscleromorpha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11456; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/homoscleromorpha";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Homoscleromorpha"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("porifera_homoscleromorpha_audio", "species.porifera.homoscleromorpha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("porifera_homoscleromorpha_data", "species.porifera.homoscleromorpha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("porifera_homoscleromorpha_graphics", "species.porifera.homoscleromorpha.graphics.spectrum", sb.toString());
        }
    }
}