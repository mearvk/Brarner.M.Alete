package species.porifera.homoscleromorpha.plakinidae;
...
/**
 * Signal Processing for Family: Plakinidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/homoscleromorpha/plakinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11458; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/homoscleromorpha/plakinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Homoscleromorpha"); ps.setString(3, "Plakinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("plakinidae_audio", "species.porifera.homoscleromorpha.plakinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("plakinidae_data", "species.porifera.homoscleromorpha.plakinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("plakinidae_graphics", "species.porifera.homoscleromorpha.plakinidae.graphics.spectrum", sb.toString());
        }
    }
}