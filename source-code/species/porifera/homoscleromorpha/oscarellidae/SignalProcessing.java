package species.porifera.homoscleromorpha.oscarellidae;
...
/**
 * Signal Processing for Family: Oscarellidae
 * <p>Phylum: Porifera | Class: Homoscleromorpha | Order: Homosclerophorida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/homoscleromorpha/oscarellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11457; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/homoscleromorpha/oscarellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Homoscleromorpha"); ps.setString(3, "Oscarellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("oscarellidae_audio", "species.porifera.homoscleromorpha.oscarellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("oscarellidae_data", "species.porifera.homoscleromorpha.oscarellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("oscarellidae_graphics", "species.porifera.homoscleromorpha.oscarellidae.graphics.spectrum", sb.toString());
        }
    }
}