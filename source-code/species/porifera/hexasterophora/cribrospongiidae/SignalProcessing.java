package species.porifera.hexasterophora.cribrospongiidae;
...
/**
 * Signal Processing for Family: Cribrospongiidae
 * <p>Phylum: Porifera | Class: Hexasterophora | Order: Hexactinosida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/cribrospongiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11446; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora/cribrospongiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, "Cribrospongiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cribrospongiidae_audio", "species.porifera.hexasterophora.cribrospongiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cribrospongiidae_data", "species.porifera.hexasterophora.cribrospongiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cribrospongiidae_graphics", "species.porifera.hexasterophora.cribrospongiidae.graphics.spectrum", sb.toString());
        }
    }
}