package species.porifera.hexasterophora.aulocystidae;
...
/**
 * Signal Processing for Family: Aulocystidae
 * <p>Phylum: Porifera | Class: Hexasterophora | Order: Lychniscosida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/aulocystidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11451; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora/aulocystidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, "Aulocystidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aulocystidae_audio", "species.porifera.hexasterophora.aulocystidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aulocystidae_data", "species.porifera.hexasterophora.aulocystidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aulocystidae_graphics", "species.porifera.hexasterophora.aulocystidae.graphics.spectrum", sb.toString());
        }
    }
}