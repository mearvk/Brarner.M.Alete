package species.porifera.hexasterophora.euplectellidae;
...
/**
 * Signal Processing for Family: Euplectellidae
 * <p>Phylum: Porifera | Class: Hexasterophora | Order: Lyssacinosida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/euplectellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11453; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora/euplectellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, "Euplectellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("euplectellidae_audio", "species.porifera.hexasterophora.euplectellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("euplectellidae_data", "species.porifera.hexasterophora.euplectellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("euplectellidae_graphics", "species.porifera.hexasterophora.euplectellidae.graphics.spectrum", sb.toString());
        }
    }
}