package species.porifera.hexasterophora;
...
/**
 * Signal Processing for Phylum: Porifera, Class: Hexasterophora
 * <p>Families: 14</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11441; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("porifera_hexasterophora_audio", "species.porifera.hexasterophora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("porifera_hexasterophora_data", "species.porifera.hexasterophora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("porifera_hexasterophora_graphics", "species.porifera.hexasterophora.graphics.spectrum", sb.toString());
        }
    }
}