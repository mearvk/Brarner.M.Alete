package species.porifera.hexasterophora.aphrocallistidae;
...
/**
 * Signal Processing for Family: Aphrocallistidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/aphrocallistidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11444; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora/aphrocallistidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, "Aphrocallistidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aphrocallistidae_audio", "species.porifera.hexasterophora.aphrocallistidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aphrocallistidae_data", "species.porifera.hexasterophora.aphrocallistidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aphrocallistidae_graphics", "species.porifera.hexasterophora.aphrocallistidae.graphics.spectrum", sb.toString());
        }
    }
}