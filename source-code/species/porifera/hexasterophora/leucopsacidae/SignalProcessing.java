package species.porifera.hexasterophora.leucopsacidae;
...
/**
 * Signal Processing for Family: Leucopsacidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/hexasterophora/leucopsacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11454; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/hexasterophora/leucopsacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Hexasterophora"); ps.setString(3, "Leucopsacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leucopsacidae_audio", "species.porifera.hexasterophora.leucopsacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leucopsacidae_data", "species.porifera.hexasterophora.leucopsacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leucopsacidae_graphics", "species.porifera.hexasterophora.leucopsacidae.graphics.spectrum", sb.toString());
        }
    }
}