...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/duke/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/duke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("duke_audio", "duke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("duke_data", "duke.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("duke_graphics", "duke.graphics.spectrum", sb.toString());
        }
    }
}
