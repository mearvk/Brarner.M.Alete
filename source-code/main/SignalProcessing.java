...
public class SignalProcessing
{
    ...
    static {
        loadConfig("source-code/main/config.xml");
    }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/main";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("main_audio", "main.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("main_data", "main.data.stats", result);
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("main_graphics", "main.graphics.spectrum", sb.toString());
        }
    }
}
